...
public class PaymentOptionsApi {
     ...
     */
    public okhttp3.Call listPaymentOptionsCall(String country, String currency, Integer amount, String metadata, String locale, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call listPaymentOptionsValidateBeforeCall(String country, String currency, Integer amount, String metadata, String locale, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = listPaymentOptionsCall(country, currency, amount, metadata, locale, _callback);
        return localVarCall;
     ...
     */
    public PaymentOptions listPaymentOptions(String country, String currency, Integer amount, String metadata, String locale) throws ApiException {
        ApiResponse<PaymentOptions> localVarResp = listPaymentOptionsWithHttpInfo(country, currency, amount, metadata, locale);
     ...
     */
    public ApiResponse<PaymentOptions> listPaymentOptionsWithHttpInfo(String country, String currency, Integer amount, String metadata, String locale) throws ApiException {
        okhttp3.Call localVarCall = listPaymentOptionsValidateBeforeCall(country, currency, amount, metadata, locale, null);
