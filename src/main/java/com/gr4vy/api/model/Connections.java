...
import com.gr4vy.api.model.Connection;
 ...
 */
@ApiModel(description = "A list of configured connections.")
...
public class Connections {
  ...
  public Connections items(List<Connection> items) {
    
    this.items = items;
    return this;
  }

  public Connections addItemsItem(Connection itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, connections.items);
  }
