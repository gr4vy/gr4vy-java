 ...
 */
@ApiModel(description = "A list of network tokens.")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2023-08-08T13:56:38.178267Z[Etc/UTC]")
public class NetworkTokens {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<NetworkToken> items = null;
  ...
  public NetworkTokens items(List<NetworkToken> items) {
    
    this.items = items;
    return this;
  }

  public NetworkTokens addItemsItem(NetworkToken itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<NetworkToken>();
    }
  ...
  **/
  ...
  @ApiModelProperty(value = "A list of network tokens.")

  public List<NetworkToken> getItems() {
    return items;
  }


  public void setItems(List<NetworkToken> items) {
    this.items = items;
  }


  public NetworkTokens limit(Integer limit) {
  ...
  **/
  ...
  public NetworkTokens nextCursor(String nextCursor) {
  ...
  **/
  ...
  public NetworkTokens previousCursor(String previousCursor) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    NetworkTokens networkTokens = (NetworkTokens) o;
    return Objects.equals(this.items, networkTokens.items) &&
        Objects.equals(this.limit, networkTokens.limit) &&
        Objects.equals(this.nextCursor, networkTokens.nextCursor) &&
        Objects.equals(this.previousCursor, networkTokens.previousCursor);
  }
