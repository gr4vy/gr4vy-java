...
import com.gr4vy.api.model.GiftCard;
 ...
 */
@ApiModel(description = "A list of stored gift cards.")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class GiftCards {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<GiftCard> items = null;
  ...
  public GiftCards items(List<GiftCard> items) {
    
    this.items = items;
    return this;
  }

  public GiftCards addItemsItem(GiftCard itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<GiftCard>();
    }
  ...
  **/
  ...
  public void setItems(List<GiftCard> items) {
    this.items = items;
  }


  public GiftCards limit(Integer limit) {
  ...
  **/
  ...
  public GiftCards nextCursor(String nextCursor) {
  ...
  **/
  ...
  public GiftCards previousCursor(String previousCursor) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, giftCards.items) &&
        Objects.equals(this.limit, giftCards.limit) &&
        Objects.equals(this.nextCursor, giftCards.nextCursor) &&
        Objects.equals(this.previousCursor, giftCards.previousCursor);
  }
