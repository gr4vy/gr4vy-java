...
import com.gr4vy.api.model.PaymentLink;
 ...
 */
@ApiModel(description = "A list of payment links.")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class PaymentLinks {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<PaymentLink> items = null;
  ...
  public PaymentLinks items(List<PaymentLink> items) {
    
    this.items = items;
    return this;
  }

  public PaymentLinks addItemsItem(PaymentLink itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<PaymentLink>();
    }
  ...
  **/
  ...
  @ApiModelProperty(value = "A list of payment links.")

  public List<PaymentLink> getItems() {
    return items;
  }


  public void setItems(List<PaymentLink> items) {
    this.items = items;
  }


  public PaymentLinks limit(Integer limit) {
  ...
  **/
  ...
  public PaymentLinks nextCursor(String nextCursor) {
  ...
  **/
  ...
  public PaymentLinks previousCursor(String previousCursor) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, paymentLinks.items) &&
        Objects.equals(this.limit, paymentLinks.limit) &&
        Objects.equals(this.nextCursor, paymentLinks.nextCursor) &&
        Objects.equals(this.previousCursor, paymentLinks.previousCursor);
  }
