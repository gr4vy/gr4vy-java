...
public class TransactionRedirectRequest extends TransactionPaymentMethodRequest {
  
  public TransactionRedirectRequest() {
	  
  }
  public TransactionRedirectRequest(String method) {
	  if (method != null) {
