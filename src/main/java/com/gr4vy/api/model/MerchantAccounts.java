...
public class MerchantAccounts {
  ...
  private List<MerchantAccount> items = null;
  ...
  public MerchantAccounts items(List<MerchantAccount> items) {
    
    this.items = items;
    return this;
  }

  public MerchantAccounts addItemsItem(MerchantAccount itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<MerchantAccount>();
    }
  ...
  **/
  ...
  @ApiModelProperty(value = "A list of merchant accounts.")

  public List<MerchantAccount> getItems() {
    return items;
  }


  public void setItems(List<MerchantAccount> items) {
    this.items = items;
  }


  public MerchantAccounts limit(Integer limit) {
  ...
  **/
  ...
  public MerchantAccounts nextCursor(String nextCursor) {
  ...
  **/
  ...
  public MerchantAccounts previousCursor(String previousCursor) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MerchantAccounts merchantAccounts = (MerchantAccounts) o;
    return Objects.equals(this.items, merchantAccounts.items) &&
        Objects.equals(this.limit, merchantAccounts.limit) &&
        Objects.equals(this.nextCursor, merchantAccounts.nextCursor) &&
        Objects.equals(this.previousCursor, merchantAccounts.previousCursor);
  }
  ...
  public String toString() {
    ...
    sb.append("class MerchantAccounts {\n");
