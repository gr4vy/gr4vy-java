 ...
 */
@ApiModel(description = "A list of role assignments.")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class RoleAssignments {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<RoleAssignment> items = null;
  ...
  public RoleAssignments items(List<RoleAssignment> items) {
    
    this.items = items;
    return this;
  }

  public RoleAssignments addItemsItem(RoleAssignment itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<RoleAssignment>();
    }
  ...
  **/
  ...
  @ApiModelProperty(value = "A list of role assignments.")
  ...
  public void setItems(List<RoleAssignment> items) {
    this.items = items;
  }


  public RoleAssignments limit(Integer limit) {
  ...
  **/
  ...
  public RoleAssignments nextCursor(String nextCursor) {
  ...
  **/
  ...
  public RoleAssignments previousCursor(String previousCursor) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, roleAssignments.items) &&
        Objects.equals(this.limit, roleAssignments.limit) &&
        Objects.equals(this.nextCursor, roleAssignments.nextCursor) &&
        Objects.equals(this.previousCursor, roleAssignments.previousCursor);
  }
