...
import com.gr4vy.api.model.TransactionsReportSpecParamsFilters;
 ...
 */
@ApiModel(description = "Parameters used to configure the report.")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class TransactionsReportSpecParams {
  /**
   * Gets or Sets fields
   */
  ...
  public enum FieldsEnum {
    ...
    GIFT_CARD_REDEMPTIONS_AMOUNT("gift_card_redemptions_amount"),
    
    GIFT_CARD_REDEMPTION_REFUNDS_AMOUNT("gift_card_redemption_refunds_amount"),
  ...
  private TransactionsReportSpecParamsFilters filters;
  ...
  public TransactionsReportSpecParams fields(List<FieldsEnum> fields) {
    
    this.fields = fields;
    return this;
  }

  public TransactionsReportSpecParams addFieldsItem(FieldsEnum fieldsItem) {
    if (this.fields == null) {
  ...
  **/
  ...
  public TransactionsReportSpecParams filters(TransactionsReportSpecParamsFilters filters) {
  ...
  **/
  ...
  public TransactionsReportSpecParamsFilters getFilters() {
    return filters;
  }


  public void setFilters(TransactionsReportSpecParamsFilters filters) {
    this.filters = filters;
  }


  public TransactionsReportSpecParams sort(List<Object> sort) {
    
    this.sort = sort;
    return this;
  }

  public TransactionsReportSpecParams addSortItem(Object sortItem) {
    if (this.sort == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TransactionsReportSpecParams transactionsReportSpecParams = (TransactionsReportSpecParams) o;
    return Objects.equals(this.fields, transactionsReportSpecParams.fields) &&
        Objects.equals(this.filters, transactionsReportSpecParams.filters) &&
        Objects.equals(this.sort, transactionsReportSpecParams.sort);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransactionsReportSpecParams {\n");
