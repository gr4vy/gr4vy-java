...
public class GiftCardRedemptionFailedContext {
  ...
  public GiftCardRedemptionFailedContext giftCardServiceId(UUID giftCardServiceId) {
  ...
  **/
  ...
  public GiftCardRedemptionFailedContext giftCardServiceName(String giftCardServiceName) {
  ...
  **/
  ...
  public GiftCardRedemptionFailedContext giftCardServiceDefinitionId(String giftCardServiceDefinitionId) {
  ...
  **/
  ...
  public GiftCardRedemptionFailedContext url(String url) {
  ...
  **/
  ...
  public GiftCardRedemptionFailedContext request(String request) {
  ...
  **/
  ...
  public GiftCardRedemptionFailedContext response(String response) {
  ...
  **/
  ...
  public GiftCardRedemptionFailedContext responseStatusCode(BigDecimal responseStatusCode) {
  ...
  **/
  ...
  public GiftCardRedemptionFailedContext reason(String reason) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Network Error", value = "The reason we could not redeem the gift cards.")
  ...
  public boolean equals(Object o) {
    ...
    GiftCardRedemptionFailedContext giftCardRedemptionFailedContext = (GiftCardRedemptionFailedContext) o;
    return Objects.equals(this.giftCardServiceId, giftCardRedemptionFailedContext.giftCardServiceId) &&
        Objects.equals(this.giftCardServiceName, giftCardRedemptionFailedContext.giftCardServiceName) &&
        Objects.equals(this.giftCardServiceDefinitionId, giftCardRedemptionFailedContext.giftCardServiceDefinitionId) &&
        Objects.equals(this.url, giftCardRedemptionFailedContext.url) &&
        Objects.equals(this.request, giftCardRedemptionFailedContext.request) &&
        Objects.equals(this.response, giftCardRedemptionFailedContext.response) &&
        Objects.equals(this.responseStatusCode, giftCardRedemptionFailedContext.responseStatusCode) &&
        Objects.equals(this.reason, giftCardRedemptionFailedContext.reason);
  }
  ...
  public String toString() {
    ...
    sb.append("class GiftCardRedemptionFailedContext {\n");
