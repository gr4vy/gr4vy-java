 ...
 */
@JsonDeserialize(using = OrderBy._Deserializer.class)
@JsonSerialize(using = OrderBy._Serializer.class)
public class OrderBy {
    ...
    public static final class _Serializer extends StdSerializer<OrderBy> {
        ...
        @Override
        public void serialize(OrderBy value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<OrderBy> {
        ...
        @Override
        public OrderBy deserialize(JsonParser p, DeserializationContext ctxt)
