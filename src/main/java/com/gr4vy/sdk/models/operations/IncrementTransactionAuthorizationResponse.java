...
public class IncrementTransactionAuthorizationResponse implements Response {
    ...
    @JsonIgnore
    public Optional<TransactionAuthorizationIncrement> transactionAuthorizationIncrement() {
        return (Optional<TransactionAuthorizationIncrement>) transactionAuthorizationIncrement;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public IncrementTransactionAuthorizationResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
