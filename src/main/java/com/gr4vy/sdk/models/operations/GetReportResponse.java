...
public class GetReportResponse implements Response {
    /**
     ...
     * HTTP response status code for this operation
     */
    public GetReportResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetReportResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Successful Response
     */
    public GetReportResponse withReport(Report report) {
        Utils.checkNotNull(report, "report");
     ...
     * Successful Response
     */
    public GetReportResponse withReport(Optional<? extends Report> report) {
        Utils.checkNotNull(report, "report");
        this.report = report;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(GetReportResponse.class,
