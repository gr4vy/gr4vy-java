...
public class ListReportsRequestBuilder {
    ...
    public ListReportsResponse call() {
    ...
    * <pre><code>
    * for (ListReportsResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<ListReportsResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<ListReportsResponse> callAsStream() {
