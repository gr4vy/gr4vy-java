...
public class ListRolesRequestBuilder {
    ...
    public ListRolesRequestBuilder cursor(JsonNullable<String> cursor) {
        Utils.checkNotNull(cursor, "cursor");
        this.cursor = cursor;
        return this;
    }
    ...
    public ListRolesRequestBuilder limit(Optional<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
    ...
    public ListRolesRequestBuilder retryConfig(Optional<RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
    ...
    public CompletableFuture<ListRolesResponse> call() {
     ...
     */
    public Publisher<ListRolesResponse> callAsPublisher() {
        ...
        Flow.Publisher<ListRolesResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
