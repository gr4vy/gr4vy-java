...
public class ListReportsRequestBuilder {
    ...
    public ListReportsRequestBuilder(SDKConfiguration sdkConfiguration) {
    ...
    public CompletableFuture<ListReportsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;ListReportsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListReportsResponse&gt;() {
     ...
     */
    public Publisher<ListReportsResponse> callAsPublisher() {
        ListReportsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.next_cursor", String.class),
                    ListReportsRequest::withCursor,
            operation::doRequest);

        Flow.Publisher<ListReportsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
