...
public class ListPaymentMethodsRequestBuilder {
    ...
    public CompletableFuture<ListPaymentMethodsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;ListPaymentMethodsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListPaymentMethodsResponse&gt;() {
     ...
     */
    public Publisher<ListPaymentMethodsResponse> callAsPublisher() {
        ListPaymentMethodsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<ListPaymentMethodsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
