...
public class ListBuyerShippingDetailsResponse implements Response {
    /**
     ...
     * HTTP response content type for this operation
     */
    public ListBuyerShippingDetailsResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public ListBuyerShippingDetailsResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListBuyerShippingDetailsResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListBuyerShippingDetailsResponse other = (ListBuyerShippingDetailsResponse) o;
        return 
            Utils.enhancedDeepEquals(this.contentType, other.contentType) &&
            Utils.enhancedDeepEquals(this.statusCode, other.statusCode) &&
            Utils.enhancedDeepEquals(this.rawResponse, other.rawResponse) &&
            Utils.enhancedDeepEquals(this.shippingDetailsList, other.shippingDetailsList);
    }
    ...
    public String toString() {
        return Utils.toString(ListBuyerShippingDetailsResponse.class,
    ...
    public final static class Builder {
        ...
        public ListBuyerShippingDetailsResponse build() {

            return new ListBuyerShippingDetailsResponse(
                contentType, statusCode, rawResponse,
                shippingDetailsList);
        }
