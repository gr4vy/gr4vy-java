...
public class ListAuditLogsRequestBuilder {
    ...
    public CompletableFuture<ListAuditLogsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;ListAuditLogsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListAuditLogsResponse&gt;() {
     ...
     */
    public Publisher<ListAuditLogsResponse> callAsPublisher() {
        ListAuditLogsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<ListAuditLogsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
