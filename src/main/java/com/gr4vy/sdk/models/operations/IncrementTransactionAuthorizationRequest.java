...
public class IncrementTransactionAuthorizationRequest {
     ...
     * The ID of the merchant account to use for this request.
     */
    public IncrementTransactionAuthorizationRequest withMerchantAccountId(JsonNullable<String> merchantAccountId) {
        Utils.checkNotNull(merchantAccountId, "merchantAccountId");
        this.merchantAccountId = merchantAccountId;
        return this;
    }
     ...
     * collisions.
     */
    public IncrementTransactionAuthorizationRequest withIdempotencyKey(JsonNullable<String> idempotencyKey) {
        Utils.checkNotNull(idempotencyKey, "idempotencyKey");
        this.idempotencyKey = idempotencyKey;
        return this;
    }
