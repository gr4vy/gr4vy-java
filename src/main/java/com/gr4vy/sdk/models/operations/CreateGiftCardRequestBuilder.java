...
public class CreateGiftCardRequestBuilder {
    ...
    public CreateGiftCardRequestBuilder applicationName(String applicationName) {
        Utils.checkNotNull(applicationName, "applicationName");
        this.applicationName = Optional.of(applicationName);
        return this;
    }

    public CreateGiftCardRequestBuilder applicationName(Optional<String> applicationName) {
        Utils.checkNotNull(applicationName, "applicationName");
