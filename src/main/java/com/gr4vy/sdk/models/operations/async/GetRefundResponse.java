...
public class GetRefundResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetRefundResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Successful Response
     */
    public GetRefundResponse withRefund(Refund refund) {
        Utils.checkNotNull(refund, "refund");
     ...
     * Successful Response
     */
    public GetRefundResponse withRefund(Optional<? extends Refund> refund) {
        Utils.checkNotNull(refund, "refund");
        this.refund = refund;
        return this;
    }
