...
public class ListTransactionsRequestBuilder {
     ...
     * <pre><code>
     * Publisher&lt;ListTransactionsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListTransactionsResponse&gt;() {
     ...
     */
    public Publisher<ListTransactionsResponse> callAsPublisher() {
        ListTransactionsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<ListTransactionsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
