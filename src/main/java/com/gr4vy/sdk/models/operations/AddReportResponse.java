...
public class AddReportResponse implements Response {
     ...
     * HTTP response content type for this operation
     */
    public AddReportResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public AddReportResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public AddReportResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Successful Response
     */
    public AddReportResponse withReport(Report report) {
        Utils.checkNotNull(report, "report");
     ...
     * Successful Response
     */
    public AddReportResponse withReport(Optional<? extends Report> report) {
        Utils.checkNotNull(report, "report");
        this.report = report;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AddReportResponse other = (AddReportResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AddReportResponse.class,
    ...
    public final static class Builder {
        ...
        public AddReportResponse build() {
