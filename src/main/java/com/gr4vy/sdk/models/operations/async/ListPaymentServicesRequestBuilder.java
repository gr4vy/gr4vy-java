...
public class ListPaymentServicesRequestBuilder {
    ...
    public CompletableFuture<ListPaymentServicesResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;ListPaymentServicesResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListPaymentServicesResponse&gt;() {
     ...
     */
    public Publisher<ListPaymentServicesResponse> callAsPublisher() {
        ListPaymentServicesRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<ListPaymentServicesResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
