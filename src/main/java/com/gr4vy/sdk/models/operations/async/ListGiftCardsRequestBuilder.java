...
public class ListGiftCardsRequestBuilder {
    ...
    public CompletableFuture<ListGiftCardsResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;ListGiftCardsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListGiftCardsResponse&gt;() {
     ...
     */
    public Publisher<ListGiftCardsResponse> callAsPublisher() {
        ListGiftCardsRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<ListGiftCardsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
