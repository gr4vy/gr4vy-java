...
public class SuspendPaymentMethodNetworkTokenRequest {
     ...
     * The ID of the merchant account to use for this request.
     */
    public SuspendPaymentMethodNetworkTokenRequest withMerchantAccountId(String merchantAccountId) {
        Utils.checkNotNull(merchantAccountId, "merchantAccountId");
     ...
     * The ID of the merchant account to use for this request.
     */
    public SuspendPaymentMethodNetworkTokenRequest withMerchantAccountId(JsonNullable<String> merchantAccountId) {
        Utils.checkNotNull(merchantAccountId, "merchantAccountId");
        this.merchantAccountId = merchantAccountId;
        return this;
    }
