...
public class Error429 extends Gr4vyError {
    ...
    /**
    * Parse a response into an instance of Error429. If deserialization of the response body fails,
    * the resulting Error429 instance will have a null data() value and a non-null deserializationException().
    */
    public static Error429 from(HttpResponse<InputStream> response) {
        byte[] bytes;
        try {
            bytes = Utils.extractByteArrayFromBody(response);
        } catch (Exception e) {
            return new Error429(response.statusCode(), null, response, null, e);
        }
        try {
            Data data = Utils.mapper().readValue(bytes, Data.class);
            return new Error429(response.statusCode(), bytes, response, data, null);
        } catch (Exception e) {
            return new Error429(response.statusCode(), bytes, response, null, e);
        }
    }

    /**
    * Parse a response into an instance of Error429 asynchronously. If deserialization of the response body fails,
    * the resulting Error429 instance will have a null data() value and a non-null deserializationException().
    */
    public static CompletableFuture<Error429> fromAsync(HttpResponse<Blob> response) {
