...
public class Error504 extends Gr4vyError {
    ...
    /**
    * Parse a response into an instance of Error504. If deserialization of the response body fails,
    ...
    */
    ...
    /**
    * Parse a response into an instance of Error504 asynchronously. If deserialization of the response body fails,
    * the resulting Error504 instance will have a null data() value and a non-null deserializationException().
    */
    public static CompletableFuture<Error504> fromAsync(HttpResponse<Blob> response) {
