...
public class PayoutSummaries {
     ...
     * A list of items returned for this request.
     */
    public PayoutSummaries withItems(List<PayoutSummary> items) {
        Utils.checkNotNull(items, "items");
        this.items = items;
        return this;
    }
     ...
     * The number of items for this page.
     */
    public PayoutSummaries withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * The number of items for this page.
     */
    public PayoutSummaries withLimit(Optional<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * The cursor pointing at the next page of items.
     */
    public PayoutSummaries withNextCursor(String nextCursor) {
        Utils.checkNotNull(nextCursor, "nextCursor");
     ...
     * The cursor pointing at the next page of items.
     */
    public PayoutSummaries withNextCursor(JsonNullable<String> nextCursor) {
        Utils.checkNotNull(nextCursor, "nextCursor");
        this.nextCursor = nextCursor;
        return this;
    }
     ...
     * The cursor pointing at the previous page of items.
     */
    public PayoutSummaries withPreviousCursor(String previousCursor) {
        Utils.checkNotNull(previousCursor, "previousCursor");
     ...
     * The cursor pointing at the previous page of items.
     */
    public PayoutSummaries withPreviousCursor(JsonNullable<String> previousCursor) {
        Utils.checkNotNull(previousCursor, "previousCursor");
        this.previousCursor = previousCursor;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PayoutSummaries other = (PayoutSummaries) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PayoutSummaries.class,
                "items", items,
                "limit", limit,
    ...
    public final static class Builder {
        ...
        public PayoutSummaries build() {
            if (limit == null) {
                limit = _SINGLETON_VALUE_Limit.value();
            }

            return new PayoutSummaries(
                items, limit, nextCursor,
                previousCursor);
        }
