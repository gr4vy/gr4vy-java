...
public class TransactionPaymentMethodOutput {
    ...
    @JsonCreator
    public TransactionPaymentMethodOutput(
     ...
     * The optional URL that the buyer needs to be redirected to to further authorize their payment.
     */
    public TransactionPaymentMethodOutput withApprovalUrl(String approvalUrl) {
        Utils.checkNotNull(approvalUrl, "approvalUrl");
     ...
     * The optional URL that the buyer needs to be redirected to to further authorize their payment.
     */
    public TransactionPaymentMethodOutput withApprovalUrl(JsonNullable<String> approvalUrl) {
        Utils.checkNotNull(approvalUrl, "approvalUrl");
        this.approvalUrl = approvalUrl;
        return this;
    }
     ...
     * payment method may be used in multiple countries.
     */
    public TransactionPaymentMethodOutput withCountry(String country) {
        Utils.checkNotNull(country, "country");
     ...
     * payment method may be used in multiple countries.
     */
    public TransactionPaymentMethodOutput withCountry(JsonNullable<String> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
     ...
     * payment method may be used for multiple currencies.
     */
    public TransactionPaymentMethodOutput withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
     ...
     * payment method may be used for multiple currencies.
     */
    public TransactionPaymentMethodOutput withCurrency(JsonNullable<String> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * Details for credit or debit card payment method.
     */
    public TransactionPaymentMethodOutput withDetails(PaymentMethodDetailsCard details) {
        Utils.checkNotNull(details, "details");
     ...
     * Details for credit or debit card payment method.
     */
    public TransactionPaymentMethodOutput withDetails(JsonNullable<? extends PaymentMethodDetailsCard> details) {
        Utils.checkNotNull(details, "details");
        this.details = details;
        return this;
    }
     ...
     * The expiration date for the payment method.
     */
    public TransactionPaymentMethodOutput withExpirationDate(String expirationDate) {
        Utils.checkNotNull(expirationDate, "expirationDate");
     ...
     * The expiration date for the payment method.
     */
    public TransactionPaymentMethodOutput withExpirationDate(JsonNullable<String> expirationDate) {
        Utils.checkNotNull(expirationDate, "expirationDate");
        this.expirationDate = expirationDate;
        return this;
    }
     ...
     * The unique hash derived from the payment method identifier (e.g. card number).
     */
    public TransactionPaymentMethodOutput withFingerprint(String fingerprint) {
        Utils.checkNotNull(fingerprint, "fingerprint");
     ...
     * The unique hash derived from the payment method identifier (e.g. card number).
     */
    public TransactionPaymentMethodOutput withFingerprint(JsonNullable<String> fingerprint) {
        Utils.checkNotNull(fingerprint, "fingerprint");
        this.fingerprint = fingerprint;
        return this;
    }
     ...
     * For a card it is the last 4 digits of the card.
     */
    public TransactionPaymentMethodOutput withLabel(String label) {
        Utils.checkNotNull(label, "label");
     ...
     * For a card it is the last 4 digits of the card.
     */
    public TransactionPaymentMethodOutput withLabel(JsonNullable<String> label) {
        Utils.checkNotNull(label, "label");
        this.label = label;
        return this;
    }
     ...
     * The date and time when this card was last replaced by the account updater.
     */
    public TransactionPaymentMethodOutput withLastReplacedAt(OffsetDateTime lastReplacedAt) {
        Utils.checkNotNull(lastReplacedAt, "lastReplacedAt");
     ...
     * The date and time when this card was last replaced by the account updater.
     */
    public TransactionPaymentMethodOutput withLastReplacedAt(JsonNullable<OffsetDateTime> lastReplacedAt) {
        Utils.checkNotNull(lastReplacedAt, "lastReplacedAt");
        this.lastReplacedAt = lastReplacedAt;
        return this;
    }

    public TransactionPaymentMethodOutput withMethod(Method method) {
        Utils.checkNotNull(method, "method");
        this.method = method;
        return this;
    }
     ...
     * The mode to use with this payment method.
     */
    public TransactionPaymentMethodOutput withMode(Mode mode) {
        Utils.checkNotNull(mode, "mode");
     ...
     * The mode to use with this payment method.
     */
    public TransactionPaymentMethodOutput withMode(JsonNullable<? extends Mode> mode) {
        Utils.checkNotNull(mode, "mode");
        this.mode = mode;
        return this;
    }
     ...
     * The scheme of the card. Only applies to card payments.
     */
    public TransactionPaymentMethodOutput withScheme(CardScheme scheme) {
        Utils.checkNotNull(scheme, "scheme");
     ...
     * The scheme of the card. Only applies to card payments.
     */
    public TransactionPaymentMethodOutput withScheme(JsonNullable<? extends CardScheme> scheme) {
        Utils.checkNotNull(scheme, "scheme");
        this.scheme = scheme;
        return this;
    }
     ...
     * The ID of the payment method.
     */
    public TransactionPaymentMethodOutput withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * The ID of the payment method.
     */
    public TransactionPaymentMethodOutput withId(JsonNullable<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * requirement.
     */
    public TransactionPaymentMethodOutput withApprovalTarget(ApprovalTarget approvalTarget) {
        Utils.checkNotNull(approvalTarget, "approvalTarget");
     ...
     * requirement.
     */
    public TransactionPaymentMethodOutput withApprovalTarget(JsonNullable<? extends ApprovalTarget> approvalTarget) {
        Utils.checkNotNull(approvalTarget, "approvalTarget");
        this.approvalTarget = approvalTarget;
        return this;
    }
     ...
     * An external identifier that can be used to match the payment method against your own records.
     */
    public TransactionPaymentMethodOutput withExternalIdentifier(String externalIdentifier) {
        Utils.checkNotNull(externalIdentifier, "externalIdentifier");
     ...
     * An external identifier that can be used to match the payment method against your own records.
     */
    public TransactionPaymentMethodOutput withExternalIdentifier(JsonNullable<String> externalIdentifier) {
        Utils.checkNotNull(externalIdentifier, "externalIdentifier");
        this.externalIdentifier = externalIdentifier;
        return this;
    }
     ...
     * underlying account that has been used to fund this payment method.
     */
    public TransactionPaymentMethodOutput withPaymentAccountReference(String paymentAccountReference) {
        Utils.checkNotNull(paymentAccountReference, "paymentAccountReference");
     ...
     * underlying account that has been used to fund this payment method.
     */
    public TransactionPaymentMethodOutput withPaymentAccountReference(JsonNullable<String> paymentAccountReference) {
        Utils.checkNotNull(paymentAccountReference, "paymentAccountReference");
        this.paymentAccountReference = paymentAccountReference;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TransactionPaymentMethodOutput other = (TransactionPaymentMethodOutput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TransactionPaymentMethodOutput.class,
                "type", type,
    ...
    public final static class Builder {
        ...
        public TransactionPaymentMethodOutput build() {

            return new TransactionPaymentMethodOutput(
