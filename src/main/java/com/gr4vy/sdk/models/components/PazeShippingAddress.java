...
public class PazeShippingAddress {
    ...
    public PazeShippingAddress(
            ...
            String zip,
            String countryCode) {
        this(line1, Optional.empty(), Optional.empty(),
            city, state, zip,
     ...
     * Line 2 of the address.
     */
    public PazeShippingAddress withLine2(Optional<String> line2) {
        Utils.checkNotNull(line2, "line2");
        this.line2 = line2;
        return this;
    }
     ...
     * Line 3 of the address.
     */
    public PazeShippingAddress withLine3(Optional<String> line3) {
        Utils.checkNotNull(line3, "line3");
        this.line3 = line3;
        return this;
    }
