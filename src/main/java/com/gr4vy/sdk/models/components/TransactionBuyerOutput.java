...
public class TransactionBuyerOutput {
     ...
     * The ID for the buyer.
     */
    public TransactionBuyerOutput withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * The ID for the buyer.
     */
    public TransactionBuyerOutput withId(JsonNullable<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * The display name for the buyer.
     */
    public TransactionBuyerOutput withDisplayName(String displayName) {
        Utils.checkNotNull(displayName, "displayName");
     ...
     * The display name for the buyer.
     */
    public TransactionBuyerOutput withDisplayName(JsonNullable<String> displayName) {
        Utils.checkNotNull(displayName, "displayName");
        this.displayName = displayName;
        return this;
    }
     ...
     * The merchant identifier for this buyer.
     */
    public TransactionBuyerOutput withExternalIdentifier(String externalIdentifier) {
        Utils.checkNotNull(externalIdentifier, "externalIdentifier");
     ...
     * The merchant identifier for this buyer.
     */
    public TransactionBuyerOutput withExternalIdentifier(JsonNullable<String> externalIdentifier) {
        Utils.checkNotNull(externalIdentifier, "externalIdentifier");
        this.externalIdentifier = externalIdentifier;
        return this;
    }
     ...
     * The billing name, address, email, and other fields for this buyer.
     */
    public TransactionBuyerOutput withBillingDetails(BillingDetailsOutput billingDetails) {
        Utils.checkNotNull(billingDetails, "billingDetails");
     ...
     * The billing name, address, email, and other fields for this buyer.
     */
    public TransactionBuyerOutput withBillingDetails(JsonNullable<? extends BillingDetailsOutput> billingDetails) {
        Utils.checkNotNull(billingDetails, "billingDetails");
        this.billingDetails = billingDetails;
        return this;
    }
     ...
     * The buyer account number.
     */
    public TransactionBuyerOutput withAccountNumber(String accountNumber) {
        Utils.checkNotNull(accountNumber, "accountNumber");
     ...
     * The buyer account number.
     */
    public TransactionBuyerOutput withAccountNumber(JsonNullable<String> accountNumber) {
        Utils.checkNotNull(accountNumber, "accountNumber");
        this.accountNumber = accountNumber;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TransactionBuyerOutput other = (TransactionBuyerOutput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TransactionBuyerOutput.class,
                "type", type,
                "id", id,
    ...
    public final static class Builder {
        ...
        public TransactionBuyerOutput build() {

            return new TransactionBuyerOutput(
