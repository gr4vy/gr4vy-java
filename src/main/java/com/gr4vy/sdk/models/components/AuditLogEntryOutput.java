...
public class AuditLogEntryOutput {
     ...
     * The ID for the audit log entry.
     */
    public AuditLogEntryOutput withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * The ID for the audit log entry.
     */
    public AuditLogEntryOutput withId(JsonNullable<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * The ID of the merchant account this entry was created for.
     */
    public AuditLogEntryOutput withMerchantAccountId(String merchantAccountId) {
        Utils.checkNotNull(merchantAccountId, "merchantAccountId");
     ...
     * The ID of the merchant account this entry was created for.
     */
    public AuditLogEntryOutput withMerchantAccountId(JsonNullable<String> merchantAccountId) {
        Utils.checkNotNull(merchantAccountId, "merchantAccountId");
        this.merchantAccountId = merchantAccountId;
        return this;
    }

    public AuditLogEntryOutput withResource(AuditLogEntryResource resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }

    public AuditLogEntryOutput withAction(AuditLogAction action) {
        Utils.checkNotNull(action, "action");
        this.action = action;
        return this;
    }

    public AuditLogEntryOutput withUser(AuditLogEntryUser user) {
        Utils.checkNotNull(user, "user");
        this.user = user;
        return this;
    }
     ...
     * The date and time that the action was performed.
     */
    public AuditLogEntryOutput withTimestamp(OffsetDateTime timestamp) {
        Utils.checkNotNull(timestamp, "timestamp");
        this.timestamp = timestamp;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AuditLogEntryOutput other = (AuditLogEntryOutput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AuditLogEntryOutput.class,
                "type", type,
                "id", id,
    ...
    public final static class Builder {
        ...
        public AuditLogEntryOutput build() {

            return new AuditLogEntryOutput(
