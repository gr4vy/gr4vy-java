...
public class CollectionAPIKeyPair {
    ...
    public CollectionAPIKeyPair(
            @JsonProperty("items") List<APIKeyPair> items,
     ...
     * A list of items returned for this request.
     */
    public CollectionAPIKeyPair withItems(List<APIKeyPair> items) {
        Utils.checkNotNull(items, "items");
        this.items = items;
        return this;
    }
     ...
     * The number of items for this page.
     */
    public CollectionAPIKeyPair withLimit(Optional<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * The cursor pointing at the next page of items.
     */
    public CollectionAPIKeyPair withNextCursor(JsonNullable<String> nextCursor) {
        Utils.checkNotNull(nextCursor, "nextCursor");
        this.nextCursor = nextCursor;
        return this;
    }
     ...
     * The cursor pointing at the previous page of items.
     */
    public CollectionAPIKeyPair withPreviousCursor(JsonNullable<String> previousCursor) {
        Utils.checkNotNull(previousCursor, "previousCursor");
        this.previousCursor = previousCursor;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * A list of items returned for this request.
         */
        public Builder items(List<APIKeyPair> items) {
            Utils.checkNotNull(items, "items");
            this.items = items;
            return this;
        }
