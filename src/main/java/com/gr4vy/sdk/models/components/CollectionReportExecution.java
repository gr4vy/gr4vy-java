...
public class CollectionReportExecution {
     ...
     */
    @JsonProperty("items")
    private List<ReportExecution> items;
    ...
    @JsonCreator
    public CollectionReportExecution(
            @JsonProperty("items") List<ReportExecution> items,
     ...
     */
    @JsonIgnore
    public List<ReportExecution> items() {
        return items;
    }
     ...
     * A list of items returned for this request.
     */
    public CollectionReportExecution withItems(List<ReportExecution> items) {
        Utils.checkNotNull(items, "items");
        this.items = items;
        return this;
    }
     ...
     * The number of items for this page.
     */
    public CollectionReportExecution withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * The number of items for this page.
     */
    public CollectionReportExecution withLimit(Optional<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * The cursor pointing at the next page of items.
     */
    public CollectionReportExecution withNextCursor(String nextCursor) {
        Utils.checkNotNull(nextCursor, "nextCursor");
     ...
     * The cursor pointing at the next page of items.
     */
    public CollectionReportExecution withNextCursor(JsonNullable<String> nextCursor) {
        Utils.checkNotNull(nextCursor, "nextCursor");
        this.nextCursor = nextCursor;
        return this;
    }
     ...
     * The cursor pointing at the previous page of items.
     */
    public CollectionReportExecution withPreviousCursor(String previousCursor) {
        Utils.checkNotNull(previousCursor, "previousCursor");
     ...
     * The cursor pointing at the previous page of items.
     */
    public CollectionReportExecution withPreviousCursor(JsonNullable<String> previousCursor) {
        Utils.checkNotNull(previousCursor, "previousCursor");
        this.previousCursor = previousCursor;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CollectionReportExecution other = (CollectionReportExecution) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CollectionReportExecution.class,
                "items", items,
                "limit", limit,
    ...
    public final static class Builder {
         ...
         * A list of items returned for this request.
         */
        public Builder items(List<ReportExecution> items) {
            Utils.checkNotNull(items, "items");
            this.items = items;
            return this;
        }
        ...
        public CollectionReportExecution build() {
            if (limit == null) {
                limit = _SINGLETON_VALUE_Limit.value();
            }
            return new CollectionReportExecution(
                items,
                limit,
                nextCursor,
                previousCursor);
