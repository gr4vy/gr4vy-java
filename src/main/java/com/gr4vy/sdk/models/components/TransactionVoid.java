...
public class TransactionVoid {
    ...
    public TransactionVoid withStatus(VoidStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The standardized error code set by Gr4vy.
     */
    public TransactionVoid withCode(String code) {
        Utils.checkNotNull(code, "code");
     ...
     * The standardized error code set by Gr4vy.
     */
    public TransactionVoid withCode(Optional<String> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
     ...
     * standardized across different payment services.
     */
    public TransactionVoid withRawResponseCode(String rawResponseCode) {
        Utils.checkNotNull(rawResponseCode, "rawResponseCode");
     ...
     * standardized across different payment services.
     */
    public TransactionVoid withRawResponseCode(Optional<String> rawResponseCode) {
        Utils.checkNotNull(rawResponseCode, "rawResponseCode");
        this.rawResponseCode = rawResponseCode;
        return this;
    }
     ...
     * is not standardized across different payment services.
     */
    public TransactionVoid withRawResponseDescription(String rawResponseDescription) {
        Utils.checkNotNull(rawResponseDescription, "rawResponseDescription");
     ...
     * is not standardized across different payment services.
     */
    public TransactionVoid withRawResponseDescription(Optional<String> rawResponseDescription) {
        Utils.checkNotNull(rawResponseDescription, "rawResponseDescription");
        this.rawResponseDescription = rawResponseDescription;
        return this;
    }
     ...
     * A full transaction resource.
     */
    public TransactionVoid withTransaction(Transaction transaction) {
        Utils.checkNotNull(transaction, "transaction");
        this.transaction = transaction;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TransactionVoid other = (TransactionVoid) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TransactionVoid.class,
                "type", type,
                "status", status,
                "code", code,
