...
public class TransactionSummaries {
     ...
     * The number of items for this page.
     */
    public TransactionSummaries withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * The number of items for this page.
     */
    public TransactionSummaries withLimit(Optional<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * The cursor pointing at the next page of items.
     */
    public TransactionSummaries withNextCursor(String nextCursor) {
        Utils.checkNotNull(nextCursor, "nextCursor");
     ...
     * The cursor pointing at the next page of items.
     */
    public TransactionSummaries withNextCursor(JsonNullable<String> nextCursor) {
        Utils.checkNotNull(nextCursor, "nextCursor");
        this.nextCursor = nextCursor;
        return this;
    }
     ...
     * The cursor pointing at the previous page of items.
     */
    public TransactionSummaries withPreviousCursor(String previousCursor) {
        Utils.checkNotNull(previousCursor, "previousCursor");
     ...
     * The cursor pointing at the previous page of items.
     */
    public TransactionSummaries withPreviousCursor(JsonNullable<String> previousCursor) {
        Utils.checkNotNull(previousCursor, "previousCursor");
        this.previousCursor = previousCursor;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TransactionSummaries other = (TransactionSummaries) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TransactionSummaries.class,
                "items", items,
                "limit", limit,
    ...
    public final static class Builder {
        ...
        public TransactionSummaries build() {
            if (limit == null) {
                limit = _SINGLETON_VALUE_Limit.value();
            }
            return new TransactionSummaries(
                items,
                limit,
                nextCursor,
                previousCursor);
