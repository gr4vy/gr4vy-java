...
public class ThreeDSecureScenarios {
     ...
     */
    @JsonProperty("items")
    private List<ThreeDSecureScenario> items;
    ...
    @JsonCreator
    public ThreeDSecureScenarios(
            @JsonProperty("items") List<ThreeDSecureScenario> items,
    ...
    public ThreeDSecureScenarios(
            List<ThreeDSecureScenario> items) {
     ...
     */
    @JsonIgnore
    public List<ThreeDSecureScenario> items() {
        return items;
    }
     ...
     * A list of items returned for this request.
     */
    public ThreeDSecureScenarios withItems(List<ThreeDSecureScenario> items) {
        Utils.checkNotNull(items, "items");
        this.items = items;
        return this;
    }
     ...
     * The number of items for this page.
     */
    public ThreeDSecureScenarios withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * The number of items for this page.
     */
    public ThreeDSecureScenarios withLimit(Optional<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * The cursor pointing at the next page of items.
     */
    public ThreeDSecureScenarios withNextCursor(String nextCursor) {
        Utils.checkNotNull(nextCursor, "nextCursor");
     ...
     * The cursor pointing at the next page of items.
     */
    public ThreeDSecureScenarios withNextCursor(JsonNullable<String> nextCursor) {
        Utils.checkNotNull(nextCursor, "nextCursor");
        this.nextCursor = nextCursor;
        return this;
    }
     ...
     * The cursor pointing at the previous page of items.
     */
    public ThreeDSecureScenarios withPreviousCursor(String previousCursor) {
        Utils.checkNotNull(previousCursor, "previousCursor");
     ...
     * The cursor pointing at the previous page of items.
     */
    public ThreeDSecureScenarios withPreviousCursor(JsonNullable<String> previousCursor) {
        Utils.checkNotNull(previousCursor, "previousCursor");
        this.previousCursor = previousCursor;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ThreeDSecureScenarios other = (ThreeDSecureScenarios) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ThreeDSecureScenarios.class,
                "items", items,
                "limit", limit,
    ...
    public final static class Builder {
         ...
         * A list of items returned for this request.
         */
        public Builder items(List<ThreeDSecureScenario> items) {
            Utils.checkNotNull(items, "items");
            this.items = items;
            return this;
        }
        ...
        public ThreeDSecureScenarios build() {
            if (limit == null) {
                limit = _SINGLETON_VALUE_Limit.value();
            }

            return new ThreeDSecureScenarios(
                items, limit, nextCursor,
                previousCursor);
        }
