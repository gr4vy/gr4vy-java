...
public class TransactionCancel {
    ...
    public TransactionCancel(
            @JsonProperty("status") CancelStatus status,
    ...
    public TransactionCancel withStatus(CancelStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The standardized error code set by Gr4vy.
     */
    public TransactionCancel withCode(String code) {
        Utils.checkNotNull(code, "code");
     ...
     * The standardized error code set by Gr4vy.
     */
    public TransactionCancel withCode(Optional<String> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
     ...
     * standardized across different payment services.
     */
    public TransactionCancel withRawResponseCode(String rawResponseCode) {
        Utils.checkNotNull(rawResponseCode, "rawResponseCode");
     ...
     * standardized across different payment services.
     */
    public TransactionCancel withRawResponseCode(Optional<String> rawResponseCode) {
        Utils.checkNotNull(rawResponseCode, "rawResponseCode");
        this.rawResponseCode = rawResponseCode;
        return this;
    }
     ...
     * is not standardized across different payment services.
     */
    public TransactionCancel withRawResponseDescription(String rawResponseDescription) {
        Utils.checkNotNull(rawResponseDescription, "rawResponseDescription");
     ...
     * is not standardized across different payment services.
     */
    public TransactionCancel withRawResponseDescription(Optional<String> rawResponseDescription) {
        Utils.checkNotNull(rawResponseDescription, "rawResponseDescription");
        this.rawResponseDescription = rawResponseDescription;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TransactionCancel other = (TransactionCancel) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TransactionCancel.class,
                "type", type,
                "status", status,
                "code", code,
    ...
    public final static class Builder {
        ...
        public TransactionCancel build() {
