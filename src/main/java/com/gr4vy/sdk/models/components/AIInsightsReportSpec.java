...
public class AIInsightsReportSpec implements Spec {
    /**
     ...
     * The parameters for the AI insights report model.
     */
    public AIInsightsReportSpec withParams(Map<String, Object> params) {
        Utils.checkNotNull(params, "params");
        this.params = params;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AIInsightsReportSpec other = (AIInsightsReportSpec) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AIInsightsReportSpec.class,
                "model", model,
                "params", params);
    }
    ...
    public final static class Builder {
        ...
        public AIInsightsReportSpec build() {

            return new AIInsightsReportSpec(
                params);
        }
