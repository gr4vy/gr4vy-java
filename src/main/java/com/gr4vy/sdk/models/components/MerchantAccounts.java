...
public class MerchantAccounts {
     ...
     * The number of items for this page.
     */
    public MerchantAccounts withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * The number of items for this page.
     */
    public MerchantAccounts withLimit(Optional<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * The cursor pointing at the next page of items.
     */
    public MerchantAccounts withNextCursor(String nextCursor) {
        Utils.checkNotNull(nextCursor, "nextCursor");
     ...
     * The cursor pointing at the next page of items.
     */
    public MerchantAccounts withNextCursor(JsonNullable<String> nextCursor) {
        Utils.checkNotNull(nextCursor, "nextCursor");
        this.nextCursor = nextCursor;
        return this;
    }
     ...
     * The cursor pointing at the previous page of items.
     */
    public MerchantAccounts withPreviousCursor(String previousCursor) {
        Utils.checkNotNull(previousCursor, "previousCursor");
     ...
     * The cursor pointing at the previous page of items.
     */
    public MerchantAccounts withPreviousCursor(JsonNullable<String> previousCursor) {
        Utils.checkNotNull(previousCursor, "previousCursor");
        this.previousCursor = previousCursor;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(MerchantAccounts.class,
                "items", items,
                "limit", limit,
