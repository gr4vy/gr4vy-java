...
public class CollectionPaymentServiceDefinition {
     ...
     * A list of items returned for this request.
     */
    public CollectionPaymentServiceDefinition withItems(List<PaymentServiceDefinition> items) {
        Utils.checkNotNull(items, "items");
        this.items = items;
        return this;
    }
     ...
     * The number of items for this page.
     */
    public CollectionPaymentServiceDefinition withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * The number of items for this page.
     */
    public CollectionPaymentServiceDefinition withLimit(Optional<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * The cursor pointing at the next page of items.
     */
    public CollectionPaymentServiceDefinition withNextCursor(String nextCursor) {
        Utils.checkNotNull(nextCursor, "nextCursor");
     ...
     * The cursor pointing at the next page of items.
     */
    public CollectionPaymentServiceDefinition withNextCursor(JsonNullable<String> nextCursor) {
        Utils.checkNotNull(nextCursor, "nextCursor");
        this.nextCursor = nextCursor;
        return this;
    }
     ...
     * The cursor pointing at the previous page of items.
     */
    public CollectionPaymentServiceDefinition withPreviousCursor(String previousCursor) {
        Utils.checkNotNull(previousCursor, "previousCursor");
     ...
     * The cursor pointing at the previous page of items.
     */
    public CollectionPaymentServiceDefinition withPreviousCursor(JsonNullable<String> previousCursor) {
        Utils.checkNotNull(previousCursor, "previousCursor");
        this.previousCursor = previousCursor;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CollectionPaymentServiceDefinition other = (CollectionPaymentServiceDefinition) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CollectionPaymentServiceDefinition.class,
                "items", items,
                "limit", limit,
    ...
    public final static class Builder {
        ...
        public CollectionPaymentServiceDefinition build() {
            if (limit == null) {
                limit = _SINGLETON_VALUE_Limit.value();
            }
            return new CollectionPaymentServiceDefinition(
                items,
                limit,
                nextCursor,
                previousCursor);
