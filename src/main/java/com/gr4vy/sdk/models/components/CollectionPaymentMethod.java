...
public class CollectionPaymentMethod {
    ...
    @JsonCreator
    public CollectionPaymentMethod(
            @JsonProperty("items") List<PaymentMethod> items,
     ...
     * A list of items returned for this request.
     */
    public CollectionPaymentMethod withItems(List<PaymentMethod> items) {
        Utils.checkNotNull(items, "items");
        this.items = items;
        return this;
    }
     ...
     * The number of items for this page.
     */
    public CollectionPaymentMethod withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * The number of items for this page.
     */
    public CollectionPaymentMethod withLimit(Optional<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * The cursor pointing at the next page of items.
     */
    public CollectionPaymentMethod withNextCursor(String nextCursor) {
        Utils.checkNotNull(nextCursor, "nextCursor");
     ...
     * The cursor pointing at the next page of items.
     */
    public CollectionPaymentMethod withNextCursor(JsonNullable<String> nextCursor) {
        Utils.checkNotNull(nextCursor, "nextCursor");
        this.nextCursor = nextCursor;
        return this;
    }
     ...
     * The cursor pointing at the previous page of items.
     */
    public CollectionPaymentMethod withPreviousCursor(String previousCursor) {
        Utils.checkNotNull(previousCursor, "previousCursor");
     ...
     * The cursor pointing at the previous page of items.
     */
    public CollectionPaymentMethod withPreviousCursor(JsonNullable<String> previousCursor) {
        Utils.checkNotNull(previousCursor, "previousCursor");
        this.previousCursor = previousCursor;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CollectionPaymentMethod other = (CollectionPaymentMethod) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CollectionPaymentMethod.class,
                "items", items,
                "limit", limit,
    ...
    public final static class Builder {
         ...
         * A list of items returned for this request.
         */
        public Builder items(List<PaymentMethod> items) {
            Utils.checkNotNull(items, "items");
            this.items = items;
            return this;
        }
        ...
        public CollectionPaymentMethod build() {
            if (limit == null) {
                limit = _SINGLETON_VALUE_Limit.value();
            }
            return new CollectionPaymentMethod(
                items,
                limit,
                nextCursor,
                previousCursor);
