...
public class PaymentOptionOutput {
    ...
    public PaymentOptionOutput withMethod(String method) {
        Utils.checkNotNull(method, "method");
        this.method = method;
        return this;
    }

    public PaymentOptionOutput withIconUrl(String iconUrl) {
        Utils.checkNotNull(iconUrl, "iconUrl");
        this.iconUrl = JsonNullable.of(iconUrl);
        return this;
    }

    public PaymentOptionOutput withIconUrl(JsonNullable<String> iconUrl) {
        Utils.checkNotNull(iconUrl, "iconUrl");
        this.iconUrl = iconUrl;
        return this;
    }

    public PaymentOptionOutput withMode(Mode mode) {
        Utils.checkNotNull(mode, "mode");
        this.mode = mode;
        return this;
    }

    public PaymentOptionOutput withLabel(String label) {
        Utils.checkNotNull(label, "label");
        this.label = JsonNullable.of(label);
        return this;
    }

    public PaymentOptionOutput withLabel(JsonNullable<String> label) {
        Utils.checkNotNull(label, "label");
        this.label = label;
        return this;
    }

    public PaymentOptionOutput withCanStorePaymentMethod(boolean canStorePaymentMethod) {
        Utils.checkNotNull(canStorePaymentMethod, "canStorePaymentMethod");
        this.canStorePaymentMethod = canStorePaymentMethod;
        return this;
    }

    public PaymentOptionOutput withCanDelayCapture(boolean canDelayCapture) {
        Utils.checkNotNull(canDelayCapture, "canDelayCapture");
        this.canDelayCapture = canDelayCapture;
        return this;
    }

    public PaymentOptionOutput withContext(Context context) {
        Utils.checkNotNull(context, "context");
        this.context = JsonNullable.of(context);
        return this;
    }

    public PaymentOptionOutput withContext(JsonNullable<? extends Context> context) {
        Utils.checkNotNull(context, "context");
        this.context = context;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PaymentOptionOutput other = (PaymentOptionOutput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PaymentOptionOutput.class,
                "type", type,
                "method", method,
                "iconUrl", iconUrl,
                "mode", mode,
    ...
    public final static class Builder {
        ...
        public PaymentOptionOutput build() {

            return new PaymentOptionOutput(
                method, iconUrl, mode,
