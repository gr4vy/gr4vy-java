 ...
 * RefundSettlement
 * 
 * <p>A settlement record for a refund on a transaction.
 */
public class RefundSettlement {
     ...
     * The unique identifier for the record.
     */
    public RefundSettlement withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * The merchant account this record belongs to.
     */
    public RefundSettlement withMerchantAccountId(String merchantAccountId) {
        Utils.checkNotNull(merchantAccountId, "merchantAccountId");
        this.merchantAccountId = merchantAccountId;
        return this;
    }
     ...
     * The date and time the record was created, in ISO 8601 format.
     */
    public RefundSettlement withCreatedAt(OffsetDateTime createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The date and time the record was last updated, in ISO 8601 format.
     */
    public RefundSettlement withUpdatedAt(OffsetDateTime updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
        this.updatedAt = updatedAt;
        return this;
    }
     ...
     * The date and time the record was posted, in ISO 8601 format.
     */
    public RefundSettlement withPostedAt(OffsetDateTime postedAt) {
        Utils.checkNotNull(postedAt, "postedAt");
        this.postedAt = postedAt;
        return this;
    }
     ...
     * The date and time the record was ingested, in ISO 8601 format.
     */
    public RefundSettlement withIngestedAt(OffsetDateTime ingestedAt) {
        Utils.checkNotNull(ingestedAt, "ingestedAt");
        this.ingestedAt = ingestedAt;
        return this;
    }
     ...
     * ISO 4217 currency code.
     */
    public RefundSettlement withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * The total amount in the smallest currency unit (e.g. cents).
     */
    public RefundSettlement withAmount(long amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * The exchange rate, if applicable.
     */
    public RefundSettlement withExchangeRate(double exchangeRate) {
        Utils.checkNotNull(exchangeRate, "exchangeRate");
     ...
     * The exchange rate, if applicable.
     */
    public RefundSettlement withExchangeRate(JsonNullable<Double> exchangeRate) {
        Utils.checkNotNull(exchangeRate, "exchangeRate");
        this.exchangeRate = exchangeRate;
        return this;
    }
     ...
     * The commission amount deducted in the smallest currency unit.
     */
    public RefundSettlement withCommission(long commission) {
        Utils.checkNotNull(commission, "commission");
        this.commission = commission;
        return this;
    }
     ...
     * The interchange fee, if applicable, in the smallest currency unit.
     */
    public RefundSettlement withInterchange(long interchange) {
        Utils.checkNotNull(interchange, "interchange");
     ...
     * The interchange fee, if applicable, in the smallest currency unit.
     */
    public RefundSettlement withInterchange(JsonNullable<Long> interchange) {
        Utils.checkNotNull(interchange, "interchange");
        this.interchange = interchange;
        return this;
    }
     ...
     * The markup fee, if applicable, in the smallest currency unit.
     */
    public RefundSettlement withMarkup(long markup) {
        Utils.checkNotNull(markup, "markup");
     ...
     * The markup fee, if applicable, in the smallest currency unit.
     */
    public RefundSettlement withMarkup(JsonNullable<Long> markup) {
        Utils.checkNotNull(markup, "markup");
        this.markup = markup;
        return this;
    }
     ...
     * The scheme fee, if applicable, in the smallest currency unit.
     */
    public RefundSettlement withSchemeFee(long schemeFee) {
        Utils.checkNotNull(schemeFee, "schemeFee");
     ...
     * The scheme fee, if applicable, in the smallest currency unit.
     */
    public RefundSettlement withSchemeFee(JsonNullable<Long> schemeFee) {
        Utils.checkNotNull(schemeFee, "schemeFee");
        this.schemeFee = schemeFee;
        return this;
    }
     ...
     * The report ID from the payment service.
     */
    public RefundSettlement withPaymentServiceReportId(String paymentServiceReportId) {
        Utils.checkNotNull(paymentServiceReportId, "paymentServiceReportId");
        this.paymentServiceReportId = paymentServiceReportId;
        return this;
    }
     ...
     * List of file IDs for the payment service report.
     */
    public RefundSettlement withPaymentServiceReportFileIds(List<String> paymentServiceReportFileIds) {
        Utils.checkNotNull(paymentServiceReportFileIds, "paymentServiceReportFileIds");
        this.paymentServiceReportFileIds = paymentServiceReportFileIds;
        return this;
    }
     ...
     * The transaction this record is associated with.
     */
    public RefundSettlement withTransactionId(String transactionId) {
        Utils.checkNotNull(transactionId, "transactionId");
        this.transactionId = transactionId;
        return this;
    }
     ...
     * The refund this settlement is associated with.
     */
    public RefundSettlement withRefundId(String refundId) {
        Utils.checkNotNull(refundId, "refundId");
        this.refundId = refundId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RefundSettlement other = (RefundSettlement) o;
        return 
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            transactionId, type, refundId);
    }
    
    @Override
    public String toString() {
        return Utils.toString(RefundSettlement.class,
                "id", id,
    ...
    public final static class Builder {
        ...
        public RefundSettlement build() {

            return new RefundSettlement(
                id, merchantAccountId, createdAt,
                updatedAt, postedAt, ingestedAt,
                currency, amount, exchangeRate,
                commission, interchange, markup,
