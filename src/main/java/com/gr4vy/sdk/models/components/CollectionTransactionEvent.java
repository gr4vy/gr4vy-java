...
public class CollectionTransactionEvent {
    ...
    @JsonCreator
    public CollectionTransactionEvent(
     ...
     * A list of items returned for this request.
     */
    public CollectionTransactionEvent withItems(List<TransactionEvent> items) {
        Utils.checkNotNull(items, "items");
        this.items = items;
        return this;
    }
     ...
     * The number of items for this page.
     */
    public CollectionTransactionEvent withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * The number of items for this page.
     */
    public CollectionTransactionEvent withLimit(Optional<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * The cursor pointing at the next page of items.
     */
    public CollectionTransactionEvent withNextCursor(String nextCursor) {
        Utils.checkNotNull(nextCursor, "nextCursor");
     ...
     * The cursor pointing at the next page of items.
     */
    public CollectionTransactionEvent withNextCursor(JsonNullable<String> nextCursor) {
        Utils.checkNotNull(nextCursor, "nextCursor");
        this.nextCursor = nextCursor;
        return this;
    }
     ...
     * The cursor pointing at the previous page of items.
     */
    public CollectionTransactionEvent withPreviousCursor(String previousCursor) {
        Utils.checkNotNull(previousCursor, "previousCursor");
     ...
     * The cursor pointing at the previous page of items.
     */
    public CollectionTransactionEvent withPreviousCursor(JsonNullable<String> previousCursor) {
        Utils.checkNotNull(previousCursor, "previousCursor");
        this.previousCursor = previousCursor;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CollectionTransactionEvent other = (CollectionTransactionEvent) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CollectionTransactionEvent.class,
                "items", items,
                "limit", limit,
    ...
    public final static class Builder {
        ...
        public CollectionTransactionEvent build() {
            if (limit == null) {
                limit = _SINGLETON_VALUE_Limit.value();
            }
            return new CollectionTransactionEvent(
                items,
                limit,
                nextCursor,
                previousCursor);
