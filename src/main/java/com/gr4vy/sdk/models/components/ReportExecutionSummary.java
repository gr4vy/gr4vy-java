...
public class ReportExecutionSummary {
     ...
     * The unique ID for the report execution.
     */
    public ReportExecutionSummary withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * The date this report execution was created at.
     */
    public ReportExecutionSummary withCreatedAt(OffsetDateTime createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The date this report execution was last updated.
     */
    public ReportExecutionSummary withUpdatedAt(OffsetDateTime updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
        this.updatedAt = updatedAt;
        return this;
    }

    public ReportExecutionSummary withStatus(ReportExecutionStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }

    public ReportExecutionSummary withContext(ReportExecutionContext context) {
        Utils.checkNotNull(context, "context");
        this.context = context;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ReportExecutionSummary other = (ReportExecutionSummary) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ReportExecutionSummary.class,
                "type", type,
                "id", id,
                "createdAt", createdAt,
                "updatedAt", updatedAt,
    ...
    public final static class Builder {
        ...
        public ReportExecutionSummary build() {

            return new ReportExecutionSummary(
