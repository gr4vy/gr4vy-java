...
public class TransactionSummaryOutput {
     ...
     * The ID for the transaction.
     */
    public TransactionSummaryOutput withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * <p>This ID is sent instead of the transaction ID because not all services support 36 digit identifiers.
     */
    public TransactionSummaryOutput withReconciliationId(String reconciliationId) {
        Utils.checkNotNull(reconciliationId, "reconciliationId");
        this.reconciliationId = reconciliationId;
        return this;
    }
     ...
     * The ID of the merchant account this transaction belongs to.
     */
    public TransactionSummaryOutput withMerchantAccountId(String merchantAccountId) {
        Utils.checkNotNull(merchantAccountId, "merchantAccountId");
        this.merchantAccountId = merchantAccountId;
        return this;
    }
     ...
     * The currency code for this transaction.
     */
    public TransactionSummaryOutput withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * The total amount for this transaction across all funding sources including gift cards.
     */
    public TransactionSummaryOutput withAmount(long amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }

    public TransactionSummaryOutput withStatus(TransactionStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * than the `amount` if gift cards were used.
     */
    public TransactionSummaryOutput withAuthorizedAmount(long authorizedAmount) {
        Utils.checkNotNull(authorizedAmount, "authorizedAmount");
        this.authorizedAmount = authorizedAmount;
        return this;
    }
     ...
     * pence). This can be the full value of the `authorized_amount` or less.
     */
    public TransactionSummaryOutput withCapturedAmount(long capturedAmount) {
        Utils.checkNotNull(capturedAmount, "capturedAmount");
        this.capturedAmount = capturedAmount;
        return this;
    }
     ...
     * pence). This can be the full value of the `captured_amount` or less.
     */
    public TransactionSummaryOutput withRefundedAmount(long refundedAmount) {
        Utils.checkNotNull(refundedAmount, "refundedAmount");
        this.refundedAmount = refundedAmount;
        return this;
    }
     ...
     * The ISO 4217 currency code of this transaction's settlement.
     */
    public TransactionSummaryOutput withSettledCurrency(String settledCurrency) {
        Utils.checkNotNull(settledCurrency, "settledCurrency");
     ...
     * The ISO 4217 currency code of this transaction's settlement.
     */
    public TransactionSummaryOutput withSettledCurrency(JsonNullable<String> settledCurrency) {
        Utils.checkNotNull(settledCurrency, "settledCurrency");
        this.settledCurrency = settledCurrency;
        return this;
    }
     ...
     * pence).
     */
    public TransactionSummaryOutput withSettledAmount(long settledAmount) {
        Utils.checkNotNull(settledAmount, "settledAmount");
        this.settledAmount = settledAmount;
        return this;
    }
     ...
     * Indicates whether this transaction has been settled.
     */
    public TransactionSummaryOutput withSettled(boolean settled) {
        Utils.checkNotNull(settled, "settled");
        this.settled = settled;
        return this;
    }
     ...
     * for processing.
     */
    public TransactionSummaryOutput withCountry(String country) {
        Utils.checkNotNull(country, "country");
     ...
     * for processing.
     */
    public TransactionSummaryOutput withCountry(JsonNullable<String> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
     ...
     * An external identifier that can be used to match the transaction against your own records.
     */
    public TransactionSummaryOutput withExternalIdentifier(String externalIdentifier) {
        Utils.checkNotNull(externalIdentifier, "externalIdentifier");
     ...
     * An external identifier that can be used to match the transaction against your own records.
     */
    public TransactionSummaryOutput withExternalIdentifier(JsonNullable<String> externalIdentifier) {
        Utils.checkNotNull(externalIdentifier, "externalIdentifier");
        this.externalIdentifier = externalIdentifier;
        return this;
    }

    public TransactionSummaryOutput withIntent(TransactionIntent intent) {
        Utils.checkNotNull(intent, "intent");
        this.intent = intent;
        return this;
    }
     ...
     * The payment method used for this transaction.
     */
    public TransactionSummaryOutput withPaymentMethod(TransactionPaymentMethodOutput paymentMethod) {
        Utils.checkNotNull(paymentMethod, "paymentMethod");
     ...
     * The payment method used for this transaction.
     */
    public TransactionSummaryOutput withPaymentMethod(JsonNullable<? extends TransactionPaymentMethodOutput> paymentMethod) {
        Utils.checkNotNull(paymentMethod, "paymentMethod");
        this.paymentMethod = paymentMethod;
        return this;
    }
     ...
     * The method used for the transaction.
     */
    public TransactionSummaryOutput withMethod(Method method) {
        Utils.checkNotNull(method, "method");
     ...
     * The method used for the transaction.
     */
    public TransactionSummaryOutput withMethod(JsonNullable<? extends Method> method) {
        Utils.checkNotNull(method, "method");
        this.method = method;
        return this;
    }
     ...
     * The name of the instrument used to process the transaction.
     */
    public TransactionSummaryOutput withInstrumentType(InstrumentType instrumentType) {
        Utils.checkNotNull(instrumentType, "instrumentType");
     ...
     * The name of the instrument used to process the transaction.
     */
    public TransactionSummaryOutput withInstrumentType(JsonNullable<? extends InstrumentType> instrumentType) {
        Utils.checkNotNull(instrumentType, "instrumentType");
        this.instrumentType = instrumentType;
        return this;
    }
     ...
     * The standardized error code set by Gr4vy.
     */
    public TransactionSummaryOutput withErrorCode(String errorCode) {
        Utils.checkNotNull(errorCode, "errorCode");
     ...
     * The standardized error code set by Gr4vy.
     */
    public TransactionSummaryOutput withErrorCode(JsonNullable<String> errorCode) {
        Utils.checkNotNull(errorCode, "errorCode");
        this.errorCode = errorCode;
        return this;
    }
     ...
     * The payment service used for this transaction.
     */
    public TransactionSummaryOutput withPaymentService(TransactionPaymentService paymentService) {
        Utils.checkNotNull(paymentService, "paymentService");
     ...
     * The payment service used for this transaction.
     */
    public TransactionSummaryOutput withPaymentService(JsonNullable<? extends TransactionPaymentService> paymentService) {
        Utils.checkNotNull(paymentService, "paymentService");
        this.paymentService = paymentService;
        return this;
    }
     ...
     * Whether a manual anti fraud review is pending with an anti fraud service.
     */
    public TransactionSummaryOutput withPendingReview(boolean pendingReview) {
        Utils.checkNotNull(pendingReview, "pendingReview");
     ...
     * Whether a manual anti fraud review is pending with an anti fraud service.
     */
    public TransactionSummaryOutput withPendingReview(Optional<Boolean> pendingReview) {
        Utils.checkNotNull(pendingReview, "pendingReview");
        this.pendingReview = pendingReview;
        return this;
    }
     ...
     * The buyer used for this transaction.
     */
    public TransactionSummaryOutput withBuyer(TransactionBuyerOutput buyer) {
        Utils.checkNotNull(buyer, "buyer");
     ...
     * The buyer used for this transaction.
     */
    public TransactionSummaryOutput withBuyer(JsonNullable<? extends TransactionBuyerOutput> buyer) {
        Utils.checkNotNull(buyer, "buyer");
        this.buyer = buyer;
        return this;
    }
     ...
     * standardized across different payment services.
     */
    public TransactionSummaryOutput withRawResponseCode(String rawResponseCode) {
        Utils.checkNotNull(rawResponseCode, "rawResponseCode");
     ...
     * standardized across different payment services.
     */
    public TransactionSummaryOutput withRawResponseCode(JsonNullable<String> rawResponseCode) {
        Utils.checkNotNull(rawResponseCode, "rawResponseCode");
        this.rawResponseCode = rawResponseCode;
        return this;
    }
     ...
     * is not standardized across different payment services.
     */
    public TransactionSummaryOutput withRawResponseDescription(String rawResponseDescription) {
        Utils.checkNotNull(rawResponseDescription, "rawResponseDescription");
     ...
     * is not standardized across different payment services.
     */
    public TransactionSummaryOutput withRawResponseDescription(JsonNullable<String> rawResponseDescription) {
        Utils.checkNotNull(rawResponseDescription, "rawResponseDescription");
        this.rawResponseDescription = rawResponseDescription;
        return this;
    }
     ...
     * The shipping details associated with the transaction.
     */
    public TransactionSummaryOutput withShippingDetails(ShippingDetails shippingDetails) {
        Utils.checkNotNull(shippingDetails, "shippingDetails");
     ...
     * The shipping details associated with the transaction.
     */
    public TransactionSummaryOutput withShippingDetails(JsonNullable<? extends ShippingDetails> shippingDetails) {
        Utils.checkNotNull(shippingDetails, "shippingDetails");
        this.shippingDetails = shippingDetails;
        return this;
    }
     ...
     * The identifier for the checkout session this transaction is associated with.
     */
    public TransactionSummaryOutput withCheckoutSessionId(String checkoutSessionId) {
        Utils.checkNotNull(checkoutSessionId, "checkoutSessionId");
     ...
     * The identifier for the checkout session this transaction is associated with.
     */
    public TransactionSummaryOutput withCheckoutSessionId(JsonNullable<String> checkoutSessionId) {
        Utils.checkNotNull(checkoutSessionId, "checkoutSessionId");
        this.checkoutSessionId = checkoutSessionId;
        return this;
    }
     ...
     * The gift cards redeemed for this transaction.
     */
    public TransactionSummaryOutput withGiftCardRedemptions(List<GiftCardRedemption> giftCardRedemptions) {
        Utils.checkNotNull(giftCardRedemptions, "giftCardRedemptions");
        this.giftCardRedemptions = giftCardRedemptions;
        return this;
    }
     ...
     * The gift card service used for this transaction.
     */
    public TransactionSummaryOutput withGiftCardService(GiftCardService giftCardService) {
        Utils.checkNotNull(giftCardService, "giftCardService");
     ...
     * The gift card service used for this transaction.
     */
    public TransactionSummaryOutput withGiftCardService(JsonNullable<? extends GiftCardService> giftCardService) {
        Utils.checkNotNull(giftCardService, "giftCardService");
        this.giftCardService = giftCardService;
        return this;
    }
     ...
     * The date and time when the transaction was created, in ISO 8601 format.
     */
    public TransactionSummaryOutput withCreatedAt(OffsetDateTime createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The date and time when the transaction was last updated, in ISO 8601 format.
     */
    public TransactionSummaryOutput withUpdatedAt(OffsetDateTime updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
        this.updatedAt = updatedAt;
        return this;
    }
     ...
     * Indicates whether this transaction has been disputed.
     */
    public TransactionSummaryOutput withDisputed(boolean disputed) {
        Utils.checkNotNull(disputed, "disputed");
        this.disputed = disputed;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TransactionSummaryOutput other = (TransactionSummaryOutput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TransactionSummaryOutput.class,
                "type", type,
                "id", id,
    ...
    public final static class Builder {
        ...
        public TransactionSummaryOutput build() {
