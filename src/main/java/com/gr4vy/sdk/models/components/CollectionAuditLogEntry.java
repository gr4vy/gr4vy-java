...
public class CollectionAuditLogEntry {
    ...
    @JsonCreator
    public CollectionAuditLogEntry(
     ...
     * A list of items returned for this request.
     */
    public CollectionAuditLogEntry withItems(List<AuditLogEntry> items) {
        Utils.checkNotNull(items, "items");
        this.items = items;
        return this;
    }
     ...
     * The number of items for this page.
     */
    public CollectionAuditLogEntry withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * The number of items for this page.
     */
    public CollectionAuditLogEntry withLimit(Optional<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * The cursor pointing at the next page of items.
     */
    public CollectionAuditLogEntry withNextCursor(String nextCursor) {
        Utils.checkNotNull(nextCursor, "nextCursor");
     ...
     * The cursor pointing at the next page of items.
     */
    public CollectionAuditLogEntry withNextCursor(JsonNullable<String> nextCursor) {
        Utils.checkNotNull(nextCursor, "nextCursor");
        this.nextCursor = nextCursor;
        return this;
    }
     ...
     * The cursor pointing at the previous page of items.
     */
    public CollectionAuditLogEntry withPreviousCursor(String previousCursor) {
        Utils.checkNotNull(previousCursor, "previousCursor");
     ...
     * The cursor pointing at the previous page of items.
     */
    public CollectionAuditLogEntry withPreviousCursor(JsonNullable<String> previousCursor) {
        Utils.checkNotNull(previousCursor, "previousCursor");
        this.previousCursor = previousCursor;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CollectionAuditLogEntry other = (CollectionAuditLogEntry) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CollectionAuditLogEntry.class,
                "items", items,
                "limit", limit,
    ...
    public final static class Builder {
        ...
        public CollectionAuditLogEntry build() {
            if (limit == null) {
                limit = _SINGLETON_VALUE_Limit.value();
            }
            return new CollectionAuditLogEntry(
                items,
                limit,
                nextCursor,
                previousCursor);
