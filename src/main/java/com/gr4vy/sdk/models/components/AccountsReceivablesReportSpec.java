...
public class AccountsReceivablesReportSpec implements Spec {
    /**
    ...
    @JsonCreator
    public AccountsReceivablesReportSpec(
     ...
     * The parameters for the accounts receivables report model.
     */
    public AccountsReceivablesReportSpec withParams(Map<String, Object> params) {
        Utils.checkNotNull(params, "params");
        this.params = params;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AccountsReceivablesReportSpec other = (AccountsReceivablesReportSpec) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AccountsReceivablesReportSpec.class,
                "model", model,
                "params", params);
    }
    ...
    public final static class Builder {
        ...
        public AccountsReceivablesReportSpec build() {

            return new AccountsReceivablesReportSpec(
                params);
        }
