...
public class CheckoutSessionPaymentMethodOutput {
    ...
    @JsonCreator
    public CheckoutSessionPaymentMethodOutput(
     ...
     * The ID of the payment method.
     */
    public CheckoutSessionPaymentMethodOutput withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * The ID of the payment method.
     */
    public CheckoutSessionPaymentMethodOutput withId(JsonNullable<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Details for credit or debit card payment method.
     */
    public CheckoutSessionPaymentMethodOutput withDetails(CheckoutSessionPaymentMethodDetails details) {
        Utils.checkNotNull(details, "details");
     ...
     * Details for credit or debit card payment method.
     */
    public CheckoutSessionPaymentMethodOutput withDetails(JsonNullable<? extends CheckoutSessionPaymentMethodDetails> details) {
        Utils.checkNotNull(details, "details");
        this.details = details;
        return this;
    }
     ...
     * The last 4 digits of the the card.
     */
    public CheckoutSessionPaymentMethodOutput withLabel(String label) {
        Utils.checkNotNull(label, "label");
     ...
     * The last 4 digits of the the card.
     */
    public CheckoutSessionPaymentMethodOutput withLabel(JsonNullable<String> label) {
        Utils.checkNotNull(label, "label");
        this.label = label;
        return this;
    }
     ...
     * The scheme of the card.
     */
    public CheckoutSessionPaymentMethodOutput withScheme(CardScheme scheme) {
        Utils.checkNotNull(scheme, "scheme");
     ...
     * The scheme of the card.
     */
    public CheckoutSessionPaymentMethodOutput withScheme(JsonNullable<? extends CardScheme> scheme) {
        Utils.checkNotNull(scheme, "scheme");
        this.scheme = scheme;
        return this;
    }
     ...
     * The unique hash derived from the card number.
     */
    public CheckoutSessionPaymentMethodOutput withFingerprint(String fingerprint) {
        Utils.checkNotNull(fingerprint, "fingerprint");
     ...
     * The unique hash derived from the card number.
     */
    public CheckoutSessionPaymentMethodOutput withFingerprint(JsonNullable<String> fingerprint) {
        Utils.checkNotNull(fingerprint, "fingerprint");
        this.fingerprint = fingerprint;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CheckoutSessionPaymentMethodOutput other = (CheckoutSessionPaymentMethodOutput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CheckoutSessionPaymentMethodOutput.class,
                "type", type,
                "id", id,
                "details", details,
                "label", label,
    ...
    public final static class Builder {
        ...
        public CheckoutSessionPaymentMethodOutput build() {

            return new CheckoutSessionPaymentMethodOutput(
                id, details, label,
                scheme, fingerprint);
        }
