...
public class GooglePayFPANPaymentMethodCreate {
     ...
     * The type of the card used
     */
    public GooglePayFPANPaymentMethodCreate withCardType(CardType cardType) {
        Utils.checkNotNull(cardType, "cardType");
     ...
     * The type of the card used
     */
    public GooglePayFPANPaymentMethodCreate withCardType(JsonNullable<? extends CardType> cardType) {
        Utils.checkNotNull(cardType, "cardType");
        this.cardType = cardType;
        return this;
    }
