...
public class TransactionCaptureOutput {
    ...
    @JsonCreator
    public TransactionCaptureOutput(
    ...
    public TransactionCaptureOutput withStatus(CaptureStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The standardized error code set by Gr4vy.
     */
    public TransactionCaptureOutput withCode(String code) {
        Utils.checkNotNull(code, "code");
     ...
     * The standardized error code set by Gr4vy.
     */
    public TransactionCaptureOutput withCode(Optional<String> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
     ...
     * standardized across different payment services.
     */
    public TransactionCaptureOutput withRawResponseCode(String rawResponseCode) {
        Utils.checkNotNull(rawResponseCode, "rawResponseCode");
     ...
     * standardized across different payment services.
     */
    public TransactionCaptureOutput withRawResponseCode(Optional<String> rawResponseCode) {
        Utils.checkNotNull(rawResponseCode, "rawResponseCode");
        this.rawResponseCode = rawResponseCode;
        return this;
    }
     ...
     * is not standardized across different payment services.
     */
    public TransactionCaptureOutput withRawResponseDescription(String rawResponseDescription) {
        Utils.checkNotNull(rawResponseDescription, "rawResponseDescription");
     ...
     * is not standardized across different payment services.
     */
    public TransactionCaptureOutput withRawResponseDescription(Optional<String> rawResponseDescription) {
        Utils.checkNotNull(rawResponseDescription, "rawResponseDescription");
        this.rawResponseDescription = rawResponseDescription;
        return this;
    }
     ...
     * A full transaction resource.
     */
    public TransactionCaptureOutput withTransaction(TransactionOutput transaction) {
        Utils.checkNotNull(transaction, "transaction");
        this.transaction = transaction;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TransactionCaptureOutput other = (TransactionCaptureOutput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TransactionCaptureOutput.class,
                "type", type,
                "status", status,
                "code", code,
    ...
    public final static class Builder {
        ...
        public TransactionCaptureOutput build() {

            return new TransactionCaptureOutput(
