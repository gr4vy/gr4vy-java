 ...
 *
 */
@JsonDeserialize(using = CardType._Deserializer.class)
@JsonSerialize(using = CardType._Serializer.class)
public class CardType {
    ...
    public static final class _Serializer extends StdSerializer<CardType> {
        ...
        @Override
        public void serialize(CardType value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<CardType> {
        ...
        @Override
        public CardType deserialize(JsonParser p, DeserializationContext ctxt)
                throws IOException, JacksonException {
            String v = p.readValueAs(new TypeReference<String>() {});
            // use the factory method to ensure we get singletons
            return CardType.of(v);
        }
    }
