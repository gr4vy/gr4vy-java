...
public class ListPaymentServicesOperation implements RequestOperation<ListPaymentServicesRequest, ListPaymentServicesResponse> {
    ...
    public ListPaymentServicesOperation(
    ...
    public HttpRequest buildRequest(ListPaymentServicesRequest request) throws Exception {
