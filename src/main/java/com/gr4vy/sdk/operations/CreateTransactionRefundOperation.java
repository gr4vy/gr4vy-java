...
public class CreateTransactionRefundOperation implements RequestOperation<CreateTransactionRefundRequest, CreateTransactionRefundResponse> {
    ...
    public CreateTransactionRefundOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateTransactionRefundRequest request) throws Exception {
