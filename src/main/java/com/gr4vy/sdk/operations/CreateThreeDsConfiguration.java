...
public class CreateThreeDsConfiguration {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateThreeDsConfigurationRequest, CreateThreeDsConfigurationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateThreeDsConfigurationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateThreeDsConfigurationRequest.class, new TypeReference<CreateThreeDsConfigurationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateThreeDsConfigurationRequest request) {
        ...
        @Override
        public CreateThreeDsConfigurationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateThreeDsConfigurationResponse.Builder resBuilder =
            ...
            CreateThreeDsConfigurationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMerchantAccountThreeDSConfiguration(Utils.unmarshal(response, new TypeReference<MerchantAccountThreeDSConfiguration>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateThreeDsConfigurationRequest, com.gr4vy.sdk.models.operations.async.CreateThreeDsConfigurationResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateThreeDsConfigurationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateThreeDsConfigurationRequest.class, new TypeReference<CreateThreeDsConfigurationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateThreeDsConfigurationRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CreateThreeDsConfigurationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.CreateThreeDsConfigurationResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.CreateThreeDsConfigurationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.CreateThreeDsConfigurationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MerchantAccountThreeDSConfiguration>() {})
                            .thenApply(res::withMerchantAccountThreeDSConfiguration);
                } else {
