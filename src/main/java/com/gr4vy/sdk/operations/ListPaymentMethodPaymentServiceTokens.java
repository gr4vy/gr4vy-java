...
public class ListPaymentMethodPaymentServiceTokens {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPaymentMethodPaymentServiceTokensRequest, ListPaymentMethodPaymentServiceTokensResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListPaymentMethodPaymentServiceTokensRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentMethodPaymentServiceTokensRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPaymentMethodPaymentServiceTokensRequest request) throws Exception {
        ...
        @Override
        public ListPaymentMethodPaymentServiceTokensResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPaymentMethodPaymentServiceTokensResponse.Builder resBuilder =
            ...
            ListPaymentMethodPaymentServiceTokensResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PaymentServiceTokens out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPaymentServiceTokens(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPaymentMethodPaymentServiceTokensRequest, com.gr4vy.sdk.models.operations.async.ListPaymentMethodPaymentServiceTokensResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListPaymentMethodPaymentServiceTokensRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentMethodPaymentServiceTokensRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPaymentMethodPaymentServiceTokensRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListPaymentMethodPaymentServiceTokensResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListPaymentMethodPaymentServiceTokensResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListPaymentMethodPaymentServiceTokensResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListPaymentMethodPaymentServiceTokensResponse res = resBuilder.build();
