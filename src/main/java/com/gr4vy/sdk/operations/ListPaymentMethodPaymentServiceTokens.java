...
public class ListPaymentMethodPaymentServiceTokens {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPaymentMethodPaymentServiceTokensRequest request) {
        ...
        @Override
        public ListPaymentMethodPaymentServiceTokensResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaymentServiceTokens(Utils.unmarshal(response, new TypeReference<PaymentServiceTokens>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListPaymentMethodPaymentServiceTokensResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaymentServiceTokens>() {})
                            .thenApply(res::withPaymentServiceTokens);
                } else {
