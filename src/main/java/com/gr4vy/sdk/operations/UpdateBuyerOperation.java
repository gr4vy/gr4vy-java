...
public class UpdateBuyerOperation implements RequestOperation<UpdateBuyerRequest, UpdateBuyerResponse> {
    ...
    public UpdateBuyerOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateBuyerRequest request) throws Exception {
