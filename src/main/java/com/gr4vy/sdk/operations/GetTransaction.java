...
public class GetTransaction {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTransactionRequest, com.gr4vy.sdk.models.operations.async.GetTransactionResponse> {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.GetTransactionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.GetTransactionResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.GetTransactionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.GetTransactionResponse res = resBuilder.build();
