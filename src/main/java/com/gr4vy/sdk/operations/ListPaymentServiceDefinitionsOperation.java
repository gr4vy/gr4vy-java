...
public class ListPaymentServiceDefinitionsOperation implements RequestOperation<ListPaymentServiceDefinitionsRequest, ListPaymentServiceDefinitionsResponse> {
    ...
    public ListPaymentServiceDefinitionsOperation(
    ...
    public HttpRequest buildRequest(ListPaymentServiceDefinitionsRequest request) throws Exception {
