...
public class CreatePaymentService {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreatePaymentServiceRequest, CreatePaymentServiceResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreatePaymentServiceRequest request) throws Exception {
        ...
        @Override
        public CreatePaymentServiceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreatePaymentServiceResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreatePaymentServiceRequest, com.gr4vy.sdk.models.operations.async.CreatePaymentServiceResponse> {
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreatePaymentServiceRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CreatePaymentServiceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.CreatePaymentServiceResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.CreatePaymentServiceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
