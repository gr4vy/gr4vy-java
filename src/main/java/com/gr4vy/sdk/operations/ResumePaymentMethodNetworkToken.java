...
public class ResumePaymentMethodNetworkToken {
    ...
    public static class Sync extends Base
            implements RequestOperation<ResumePaymentMethodNetworkTokenRequest, ResumePaymentMethodNetworkTokenResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ResumePaymentMethodNetworkTokenRequest request) throws Exception {
        ...
        @Override
        public ResumePaymentMethodNetworkTokenResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ResumePaymentMethodNetworkTokenResponse.Builder resBuilder =
            ...
            ResumePaymentMethodNetworkTokenResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ResumePaymentMethodNetworkTokenRequest, com.gr4vy.sdk.models.operations.async.ResumePaymentMethodNetworkTokenResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ResumePaymentMethodNetworkTokenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ResumePaymentMethodNetworkTokenRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ResumePaymentMethodNetworkTokenRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ResumePaymentMethodNetworkTokenResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ResumePaymentMethodNetworkTokenResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ResumePaymentMethodNetworkTokenResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ResumePaymentMethodNetworkTokenResponse res = resBuilder.build();
