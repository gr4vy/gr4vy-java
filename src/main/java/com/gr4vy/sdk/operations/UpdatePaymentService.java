...
public class UpdatePaymentService {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdatePaymentServiceRequest, UpdatePaymentServiceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdatePaymentServiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<UpdatePaymentServiceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdatePaymentServiceRequest request) throws Exception {
        ...
        @Override
        public UpdatePaymentServiceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdatePaymentServiceResponse.Builder resBuilder =
            ...
            UpdatePaymentServiceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PaymentService out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPaymentService(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdatePaymentServiceRequest, com.gr4vy.sdk.models.operations.async.UpdatePaymentServiceResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdatePaymentServiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<UpdatePaymentServiceRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdatePaymentServiceRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.UpdatePaymentServiceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.UpdatePaymentServiceResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.UpdatePaymentServiceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.UpdatePaymentServiceResponse res = resBuilder.build();
