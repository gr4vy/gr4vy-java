...
public class ListReportExecutionsOperation implements RequestOperation<ListReportExecutionsRequest, ListReportExecutionsResponse> {
    ...
    public ListReportExecutionsOperation(
    ...
    public HttpRequest buildRequest(ListReportExecutionsRequest request) throws Exception {
