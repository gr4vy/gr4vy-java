...
public class UpdateCheckoutSession {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCheckoutSessionRequest, UpdateCheckoutSessionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCheckoutSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCheckoutSessionRequest.class, new TypeReference<UpdateCheckoutSessionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCheckoutSessionRequest request) throws Exception {
        ...
        @Override
        public UpdateCheckoutSessionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCheckoutSessionResponse.Builder resBuilder =
            ...
            UpdateCheckoutSessionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CheckoutSession out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCheckoutSession(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCheckoutSessionRequest, com.gr4vy.sdk.models.operations.async.UpdateCheckoutSessionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCheckoutSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCheckoutSessionRequest.class, new TypeReference<UpdateCheckoutSessionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCheckoutSessionRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.UpdateCheckoutSessionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.UpdateCheckoutSessionResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.UpdateCheckoutSessionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.UpdateCheckoutSessionResponse res = resBuilder.build();
