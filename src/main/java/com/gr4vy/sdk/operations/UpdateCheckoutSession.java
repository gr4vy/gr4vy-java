...
public class UpdateCheckoutSession {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCheckoutSessionRequest request) {
        ...
        @Override
        public UpdateCheckoutSessionResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCheckoutSession(Utils.unmarshal(response, new TypeReference<CheckoutSession>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.UpdateCheckoutSessionResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CheckoutSession>() {})
                            .thenApply(res::withCheckoutSession);
                } else {
