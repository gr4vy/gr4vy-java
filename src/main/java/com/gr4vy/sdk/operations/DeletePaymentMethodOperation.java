...
public class DeletePaymentMethodOperation implements RequestOperation<DeletePaymentMethodRequest, DeletePaymentMethodResponse> {
    ...
    public DeletePaymentMethodOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(DeletePaymentMethodRequest request) throws Exception {
