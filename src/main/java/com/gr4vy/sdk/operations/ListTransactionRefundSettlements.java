...
import com.gr4vy.sdk.models.components.RefundSettlements;
...
public class ListTransactionRefundSettlements {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "list_transaction_refund_settlements",
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTransactionRefundSettlementsRequest, ListTransactionRefundSettlementsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListTransactionRefundSettlementsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTransactionRefundSettlementsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTransactionRefundSettlementsRequest request) {
        ...
        @Override
        public ListTransactionRefundSettlementsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListTransactionRefundSettlementsResponse.Builder resBuilder =
                    ListTransactionRefundSettlementsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ListTransactionRefundSettlementsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRefundSettlements(Utils.unmarshal(response, new TypeReference<RefundSettlements>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTransactionRefundSettlementsRequest, com.gr4vy.sdk.models.operations.async.ListTransactionRefundSettlementsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListTransactionRefundSettlementsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTransactionRefundSettlementsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTransactionRefundSettlementsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListTransactionRefundSettlementsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListTransactionRefundSettlementsResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListTransactionRefundSettlementsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListTransactionRefundSettlementsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<RefundSettlements>() {})
                            .thenApply(res::withRefundSettlements);
                } else {
