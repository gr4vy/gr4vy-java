...
public class GetPaymentServiceOperation implements RequestOperation<GetPaymentServiceRequest, GetPaymentServiceResponse> {
    ...
    public GetPaymentServiceOperation(
    ...
    public HttpRequest buildRequest(GetPaymentServiceRequest request) throws Exception {
