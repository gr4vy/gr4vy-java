...
public class GetCheckoutSession {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCheckoutSessionRequest, GetCheckoutSessionResponse> {
        ...
        @Override
        public GetCheckoutSessionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCheckoutSessionResponse.Builder resBuilder =
            ...
            GetCheckoutSessionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCheckoutSessionRequest, com.gr4vy.sdk.models.operations.async.GetCheckoutSessionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetCheckoutSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCheckoutSessionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCheckoutSessionRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.GetCheckoutSessionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.GetCheckoutSessionResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.GetCheckoutSessionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.GetCheckoutSessionResponse res = resBuilder.build();
