...
import com.gr4vy.sdk.models.components.Reports;
...
public class ListReports {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListReportsRequest, ListReportsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListReportsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListReportsRequest.class);
        ...
        @Override
        public ListReportsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListReportsResponse.Builder resBuilder =
                    ListReportsResponse
                            .builder()
            ...
            ListReportsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Reports out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withReports(out);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListReportsRequest, com.gr4vy.sdk.models.operations.async.ListReportsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListReportsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListReportsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListReportsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListReportsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListReportsResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListReportsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListReportsResponse res = resBuilder.build();
