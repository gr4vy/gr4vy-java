...
public class GetTransactionSettlement {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTransactionSettlementRequest, com.gr4vy.sdk.models.operations.async.GetTransactionSettlementResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetTransactionSettlementRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTransactionSettlementRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTransactionSettlementRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.GetTransactionSettlementResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.GetTransactionSettlementResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.GetTransactionSettlementResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.GetTransactionSettlementResponse res = resBuilder.build();
