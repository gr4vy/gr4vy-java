...
public class ListAllReportExecutionsOperation implements RequestOperation<ListAllReportExecutionsRequest, ListAllReportExecutionsResponse> {
    ...
    public ListAllReportExecutionsOperation(
    ...
    public HttpRequest buildRequest(ListAllReportExecutionsRequest request) throws Exception {
