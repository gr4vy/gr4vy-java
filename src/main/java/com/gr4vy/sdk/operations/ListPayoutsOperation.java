...
public class ListPayoutsOperation implements RequestOperation<ListPayoutsRequest, ListPayoutsResponse> {
    ...
    public HttpRequest buildRequest(ListPayoutsRequest request) throws Exception {
