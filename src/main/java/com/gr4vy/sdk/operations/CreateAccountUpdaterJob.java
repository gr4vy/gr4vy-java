...
public class CreateAccountUpdaterJob {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAccountUpdaterJobRequest, CreateAccountUpdaterJobResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAccountUpdaterJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateAccountUpdaterJobRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAccountUpdaterJobRequest request) throws Exception {
        ...
        @Override
        public CreateAccountUpdaterJobResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAccountUpdaterJobResponse.Builder resBuilder =
            ...
            CreateAccountUpdaterJobResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AccountUpdaterJob out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountUpdaterJob(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAccountUpdaterJobRequest, com.gr4vy.sdk.models.operations.async.CreateAccountUpdaterJobResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAccountUpdaterJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateAccountUpdaterJobRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAccountUpdaterJobRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CreateAccountUpdaterJobResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.CreateAccountUpdaterJobResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.CreateAccountUpdaterJobResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.CreateAccountUpdaterJobResponse res = resBuilder.build();
