...
public class CreateAccountUpdaterJob {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAccountUpdaterJobRequest request) {
        ...
        @Override
        public CreateAccountUpdaterJobResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAccountUpdaterJob(Utils.unmarshal(response, new TypeReference<AccountUpdaterJob>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CreateAccountUpdaterJobResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AccountUpdaterJob>() {})
                            .thenApply(res::withAccountUpdaterJob);
                } else {
