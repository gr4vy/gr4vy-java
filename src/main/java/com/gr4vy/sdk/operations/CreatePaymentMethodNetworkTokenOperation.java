...
public class CreatePaymentMethodNetworkTokenOperation implements RequestOperation<CreatePaymentMethodNetworkTokenRequest, CreatePaymentMethodNetworkTokenResponse> {
    ...
    public CreatePaymentMethodNetworkTokenOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreatePaymentMethodNetworkTokenRequest request) throws Exception {
