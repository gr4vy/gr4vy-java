...
public class VoidTransaction {
    ...
    public static class Sync extends Base
            implements RequestOperation<VoidTransactionRequest, VoidTransactionResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VoidTransactionRequest request) throws Exception {
        ...
        @Override
        public VoidTransactionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VoidTransactionResponse.Builder resBuilder =
            ...
            VoidTransactionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<VoidTransactionRequest, com.gr4vy.sdk.models.operations.async.VoidTransactionResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(VoidTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VoidTransactionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(VoidTransactionRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.VoidTransactionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.VoidTransactionResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.VoidTransactionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.VoidTransactionResponse res = resBuilder.build();
