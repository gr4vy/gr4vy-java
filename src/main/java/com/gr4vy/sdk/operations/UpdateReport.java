...
public class UpdateReport {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateReportRequest, UpdateReportResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateReportRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateReportRequest.class, new TypeReference<UpdateReportRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateReportRequest request) throws Exception {
        ...
        @Override
        public UpdateReportResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateReportResponse.Builder resBuilder =
            ...
            UpdateReportResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Report out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withReport(out);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateReportRequest, com.gr4vy.sdk.models.operations.async.UpdateReportResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateReportRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateReportRequest.class, new TypeReference<UpdateReportRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateReportRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.UpdateReportResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.UpdateReportResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.UpdateReportResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.UpdateReportResponse res = resBuilder.build();
