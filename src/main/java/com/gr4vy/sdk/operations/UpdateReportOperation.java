...
public class UpdateReportOperation implements RequestOperation<UpdateReportRequest, UpdateReportResponse> {
    ...
    public UpdateReportOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateReportRequest request) throws Exception {
