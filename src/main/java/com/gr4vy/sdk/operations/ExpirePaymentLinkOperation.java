...
public class ExpirePaymentLinkOperation implements RequestOperation<ExpirePaymentLinkRequest, ExpirePaymentLinkResponse> {
    ...
    public ExpirePaymentLinkOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ExpirePaymentLinkRequest request) throws Exception {
