...
public class GetTransactionSettlementOperation implements RequestOperation<GetTransactionSettlementRequest, GetTransactionSettlementResponse> {
    ...
    public GetTransactionSettlementOperation(
    ...
    public HttpRequest buildRequest(GetTransactionSettlementRequest request) throws Exception {
