...
public class UnregisterDigitalWalletDomainOperation implements RequestOperation<UnregisterDigitalWalletDomainRequest, UnregisterDigitalWalletDomainResponse> {
    ...
    public UnregisterDigitalWalletDomainOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UnregisterDigitalWalletDomainRequest request) throws Exception {
