...
public class GetPaymentServiceDefinitionOperation implements RequestOperation<GetPaymentServiceDefinitionRequest, GetPaymentServiceDefinitionResponse> {
    ...
    public GetPaymentServiceDefinitionOperation(
    ...
    public HttpRequest buildRequest(GetPaymentServiceDefinitionRequest request) throws Exception {
