...
public class AddPaymentLink {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddPaymentLinkRequest, AddPaymentLinkResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(AddPaymentLinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AddPaymentLinkRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddPaymentLinkRequest request) throws Exception {
        ...
        @Override
        public AddPaymentLinkResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddPaymentLinkResponse.Builder resBuilder =
            ...
            AddPaymentLinkResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddPaymentLinkRequest, com.gr4vy.sdk.models.operations.async.AddPaymentLinkResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AddPaymentLinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AddPaymentLinkRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddPaymentLinkRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.AddPaymentLinkResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.AddPaymentLinkResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.AddPaymentLinkResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.AddPaymentLinkResponse res = resBuilder.build();
