...
public class UpdateMerchantAccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateMerchantAccountRequest, UpdateMerchantAccountResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateMerchantAccountRequest request) throws Exception {
        ...
        @Override
        public UpdateMerchantAccountResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateMerchantAccountResponse.Builder resBuilder =
            ...
            UpdateMerchantAccountResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    MerchantAccount out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMerchantAccount(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateMerchantAccountRequest, com.gr4vy.sdk.models.operations.async.UpdateMerchantAccountResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateMerchantAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMerchantAccountRequest.class, new TypeReference<UpdateMerchantAccountRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateMerchantAccountRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.UpdateMerchantAccountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.UpdateMerchantAccountResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.UpdateMerchantAccountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.UpdateMerchantAccountResponse res = resBuilder.build();
