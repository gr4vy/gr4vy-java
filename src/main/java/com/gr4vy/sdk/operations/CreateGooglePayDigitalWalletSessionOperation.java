...
public class CreateGooglePayDigitalWalletSessionOperation implements RequestOperation<CreateGooglePayDigitalWalletSessionRequest, CreateGooglePayDigitalWalletSessionResponse> {
    ...
    public CreateGooglePayDigitalWalletSessionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateGooglePayDigitalWalletSessionRequest request) throws Exception {
