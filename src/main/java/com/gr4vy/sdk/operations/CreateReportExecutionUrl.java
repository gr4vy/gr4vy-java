...
public class CreateReportExecutionUrl {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateReportExecutionUrlRequest, CreateReportExecutionUrlResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateReportExecutionUrlRequest request) throws Exception {
        ...
        @Override
        public CreateReportExecutionUrlResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateReportExecutionUrlResponse.Builder resBuilder =
            ...
            CreateReportExecutionUrlResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ReportExecutionUrl out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withReportExecutionUrl(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateReportExecutionUrlRequest, com.gr4vy.sdk.models.operations.async.CreateReportExecutionUrlResponse> {
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateReportExecutionUrlRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CreateReportExecutionUrlResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.CreateReportExecutionUrlResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.CreateReportExecutionUrlResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.CreateReportExecutionUrlResponse res = resBuilder.build();
