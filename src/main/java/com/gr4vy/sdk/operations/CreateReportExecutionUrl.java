...
public class CreateReportExecutionUrl {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateReportExecutionUrlRequest request) {
        ...
        @Override
        public CreateReportExecutionUrlResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withReportExecutionUrl(Utils.unmarshal(response, new TypeReference<ReportExecutionUrl>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CreateReportExecutionUrlResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ReportExecutionUrl>() {})
                            .thenApply(res::withReportExecutionUrl);
                } else {
