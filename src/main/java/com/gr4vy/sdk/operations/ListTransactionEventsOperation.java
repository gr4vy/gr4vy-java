...
public class ListTransactionEventsOperation implements RequestOperation<ListTransactionEventsRequest, ListTransactionEventsResponse> {
    ...
    public ListTransactionEventsOperation(
    ...
    public HttpRequest buildRequest(ListTransactionEventsRequest request) throws Exception {
