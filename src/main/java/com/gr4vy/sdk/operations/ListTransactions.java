...
public class ListTransactions {
        ...
        public ListTransactionsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TransactionSummaries out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTransactionSummaries(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTransactionsRequest, com.gr4vy.sdk.models.operations.async.ListTransactionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListTransactionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTransactionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTransactionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListTransactionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListTransactionsResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListTransactionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListTransactionsResponse res = resBuilder.build();
