...
public class CreatePaymentServiceSessionOperation implements RequestOperation<CreatePaymentServiceSessionRequest, CreatePaymentServiceSessionResponse> {
    ...
    public CreatePaymentServiceSessionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreatePaymentServiceSessionRequest request) throws Exception {
