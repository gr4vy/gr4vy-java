...
public class CreatePayoutOperation implements RequestOperation<CreatePayoutRequest, CreatePayoutResponse> {
    ...
    public CreatePayoutOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreatePayoutRequest request) throws Exception {
