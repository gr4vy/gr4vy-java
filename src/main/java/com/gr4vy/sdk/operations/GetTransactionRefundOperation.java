...
public class GetTransactionRefundOperation implements RequestOperation<GetTransactionRefundRequest, GetTransactionRefundResponse> {
    ...
    public GetTransactionRefundOperation(
    ...
    public HttpRequest buildRequest(GetTransactionRefundRequest request) throws Exception {
