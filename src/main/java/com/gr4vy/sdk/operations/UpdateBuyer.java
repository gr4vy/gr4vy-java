...
public class UpdateBuyer {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateBuyerRequest, UpdateBuyerResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(UpdateBuyerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateBuyerRequest.class, new TypeReference<UpdateBuyerRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateBuyerRequest request) throws Exception {
        ...
        @Override
        public UpdateBuyerResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateBuyerResponse.Builder resBuilder =
                    UpdateBuyerResponse
                            .builder()
            ...
            UpdateBuyerResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateBuyerRequest, com.gr4vy.sdk.models.operations.async.UpdateBuyerResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateBuyerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateBuyerRequest.class, new TypeReference<UpdateBuyerRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateBuyerRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.UpdateBuyerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.UpdateBuyerResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.UpdateBuyerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.UpdateBuyerResponse res = resBuilder.build();
