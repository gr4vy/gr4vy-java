...
public class UpdateTransaction {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateTransactionRequest, UpdateTransactionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTransactionRequest.class, new TypeReference<UpdateTransactionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateTransactionRequest request) throws Exception {
        ...
        @Override
        public UpdateTransactionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateTransactionResponse.Builder resBuilder =
            ...
            UpdateTransactionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateTransactionRequest, com.gr4vy.sdk.models.operations.async.UpdateTransactionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTransactionRequest.class, new TypeReference<UpdateTransactionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateTransactionRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.UpdateTransactionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.UpdateTransactionResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.UpdateTransactionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.UpdateTransactionResponse res = resBuilder.build();
