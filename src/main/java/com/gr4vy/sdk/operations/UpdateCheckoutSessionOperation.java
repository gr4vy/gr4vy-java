...
public class UpdateCheckoutSessionOperation implements RequestOperation<UpdateCheckoutSessionRequest, UpdateCheckoutSessionResponse> {
    ...
    public UpdateCheckoutSessionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateCheckoutSessionRequest request) throws Exception {
