...
public class CreateClickToPayDigitalWalletSession {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ClickToPaySessionRequest request) {
        ...
        @Override
        public CreateClickToPayDigitalWalletSessionResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withClickToPaySession(Utils.unmarshal(response, new TypeReference<ClickToPaySession>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CreateClickToPayDigitalWalletSessionResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ClickToPaySession>() {})
                            .thenApply(res::withClickToPaySession);
                } else {
