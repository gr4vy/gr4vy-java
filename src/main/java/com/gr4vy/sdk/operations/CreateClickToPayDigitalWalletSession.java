...
public class CreateClickToPayDigitalWalletSession {
    ...
    public static class Sync extends Base
            implements RequestOperation<ClickToPaySessionRequest, CreateClickToPayDigitalWalletSessionResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ClickToPaySessionRequest request) throws Exception {
        ...
        @Override
        public CreateClickToPayDigitalWalletSessionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateClickToPayDigitalWalletSessionResponse.Builder resBuilder =
            ...
            CreateClickToPayDigitalWalletSessionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ClickToPaySession out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withClickToPaySession(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ClickToPaySessionRequest, com.gr4vy.sdk.models.operations.async.CreateClickToPayDigitalWalletSessionResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ClickToPaySessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ClickToPaySessionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ClickToPaySessionRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CreateClickToPayDigitalWalletSessionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.CreateClickToPayDigitalWalletSessionResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.CreateClickToPayDigitalWalletSessionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.CreateClickToPayDigitalWalletSessionResponse res = resBuilder.build();
