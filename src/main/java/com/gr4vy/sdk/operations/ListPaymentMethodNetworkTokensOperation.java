...
public class ListPaymentMethodNetworkTokensOperation implements RequestOperation<ListPaymentMethodNetworkTokensRequest, ListPaymentMethodNetworkTokensResponse> {
    ...
    public ListPaymentMethodNetworkTokensOperation(
    ...
    public HttpRequest buildRequest(ListPaymentMethodNetworkTokensRequest request) throws Exception {
