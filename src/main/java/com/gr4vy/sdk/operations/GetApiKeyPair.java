...
public class GetApiKeyPair {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetApiKeyPairRequest, GetApiKeyPairResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetApiKeyPairRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetApiKeyPairRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetApiKeyPairRequest request) {
        ...
        @Override
        public GetApiKeyPairResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetApiKeyPairResponse.Builder resBuilder =
                    GetApiKeyPairResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetApiKeyPairResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetApiKeyPairRequest, com.gr4vy.sdk.models.operations.async.GetApiKeyPairResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetApiKeyPairRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetApiKeyPairRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetApiKeyPairRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.GetApiKeyPairResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.GetApiKeyPairResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.GetApiKeyPairResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.GetApiKeyPairResponse res = resBuilder.build();
