...
public class UpdateApiKeyPair {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateApiKeyPairRequest, UpdateApiKeyPairResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateApiKeyPairRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateApiKeyPairRequest.class, new TypeReference<UpdateApiKeyPairRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateApiKeyPairRequest request) {
        ...
        @Override
        public UpdateApiKeyPairResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateApiKeyPairResponse.Builder resBuilder =
            ...
            UpdateApiKeyPairResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAPIKeyPair(Utils.unmarshal(response, new TypeReference<APIKeyPair>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateApiKeyPairRequest, com.gr4vy.sdk.models.operations.async.UpdateApiKeyPairResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateApiKeyPairRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateApiKeyPairRequest.class, new TypeReference<UpdateApiKeyPairRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateApiKeyPairRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.UpdateApiKeyPairResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.UpdateApiKeyPairResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.UpdateApiKeyPairResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.UpdateApiKeyPairResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<APIKeyPair>() {})
                            .thenApply(res::withAPIKeyPair);
                } else {
