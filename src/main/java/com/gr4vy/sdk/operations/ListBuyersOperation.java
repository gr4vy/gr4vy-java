...
public class ListBuyersOperation implements RequestOperation<ListBuyersRequest, ListBuyersResponse> {
    ...
    public HttpRequest buildRequest(ListBuyersRequest request) throws Exception {
