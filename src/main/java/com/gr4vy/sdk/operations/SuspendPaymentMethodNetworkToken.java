...
public class SuspendPaymentMethodNetworkToken {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SuspendPaymentMethodNetworkTokenRequest request) {
        ...
        @Override
        public SuspendPaymentMethodNetworkTokenResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withNetworkToken(Utils.unmarshal(response, new TypeReference<NetworkToken>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.SuspendPaymentMethodNetworkTokenResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<NetworkToken>() {})
                            .thenApply(res::withNetworkToken);
                } else {
