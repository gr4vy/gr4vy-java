...
public class SuspendPaymentMethodNetworkToken {
    ...
    public static class Sync extends Base
            implements RequestOperation<SuspendPaymentMethodNetworkTokenRequest, SuspendPaymentMethodNetworkTokenResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(SuspendPaymentMethodNetworkTokenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SuspendPaymentMethodNetworkTokenRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SuspendPaymentMethodNetworkTokenRequest request) throws Exception {
        ...
        @Override
        public SuspendPaymentMethodNetworkTokenResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SuspendPaymentMethodNetworkTokenResponse.Builder resBuilder =
            ...
            SuspendPaymentMethodNetworkTokenResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    NetworkToken out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withNetworkToken(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SuspendPaymentMethodNetworkTokenRequest, com.gr4vy.sdk.models.operations.async.SuspendPaymentMethodNetworkTokenResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(SuspendPaymentMethodNetworkTokenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SuspendPaymentMethodNetworkTokenRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SuspendPaymentMethodNetworkTokenRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.SuspendPaymentMethodNetworkTokenResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.SuspendPaymentMethodNetworkTokenResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.SuspendPaymentMethodNetworkTokenResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.SuspendPaymentMethodNetworkTokenResponse res = resBuilder.build();
