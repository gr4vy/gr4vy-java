...
public class GetBuyer {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetBuyerRequest, GetBuyerResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetBuyerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBuyerRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBuyerRequest request) throws Exception {
        ...
        @Override
        public GetBuyerResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetBuyerResponse.Builder resBuilder =
                    GetBuyerResponse
                            .builder()
            ...
            GetBuyerResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetBuyerRequest, com.gr4vy.sdk.models.operations.async.GetBuyerResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetBuyerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBuyerRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetBuyerRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.GetBuyerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.GetBuyerResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.GetBuyerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.GetBuyerResponse res = resBuilder.build();
