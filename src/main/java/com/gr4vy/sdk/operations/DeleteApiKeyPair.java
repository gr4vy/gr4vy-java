...
public class DeleteApiKeyPair {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteApiKeyPairRequest, DeleteApiKeyPairResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteApiKeyPairRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteApiKeyPairRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteApiKeyPairRequest request) {
        ...
        @Override
        public DeleteApiKeyPairResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteApiKeyPairResponse.Builder resBuilder =
            ...
            DeleteApiKeyPairResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteApiKeyPairRequest, com.gr4vy.sdk.models.operations.async.DeleteApiKeyPairResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteApiKeyPairRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteApiKeyPairRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteApiKeyPairRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.DeleteApiKeyPairResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.DeleteApiKeyPairResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.DeleteApiKeyPairResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.DeleteApiKeyPairResponse res = resBuilder.build();
