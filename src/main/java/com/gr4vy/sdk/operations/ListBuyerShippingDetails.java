...
public class ListBuyerShippingDetails {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListBuyerShippingDetailsRequest, ListBuyerShippingDetailsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListBuyerShippingDetailsRequest request) throws Exception {
        ...
        @Override
        public ListBuyerShippingDetailsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListBuyerShippingDetailsResponse.Builder resBuilder =
            ...
            ListBuyerShippingDetailsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ShippingDetailsList out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withShippingDetailsList(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListBuyerShippingDetailsRequest, com.gr4vy.sdk.models.operations.async.ListBuyerShippingDetailsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListBuyerShippingDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListBuyerShippingDetailsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListBuyerShippingDetailsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListBuyerShippingDetailsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListBuyerShippingDetailsResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListBuyerShippingDetailsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListBuyerShippingDetailsResponse res = resBuilder.build();
