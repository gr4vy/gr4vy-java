...
public class ListBuyerShippingDetails {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListBuyerShippingDetailsRequest request) {
        ...
        @Override
        public ListBuyerShippingDetailsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withShippingDetailsList(Utils.unmarshal(response, new TypeReference<ShippingDetailsList>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListBuyerShippingDetailsResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ShippingDetailsList>() {})
                            .thenApply(res::withShippingDetailsList);
                } else {
