...
public class CreateGooglePayDigitalWalletSession {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateGooglePayDigitalWalletSessionRequest, CreateGooglePayDigitalWalletSessionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateGooglePayDigitalWalletSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateGooglePayDigitalWalletSessionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateGooglePayDigitalWalletSessionRequest request) throws Exception {
        ...
        @Override
        public CreateGooglePayDigitalWalletSessionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateGooglePayDigitalWalletSessionResponse.Builder resBuilder =
            ...
            CreateGooglePayDigitalWalletSessionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GooglePaySession out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGooglePaySession(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateGooglePayDigitalWalletSessionRequest, com.gr4vy.sdk.models.operations.async.CreateGooglePayDigitalWalletSessionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateGooglePayDigitalWalletSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateGooglePayDigitalWalletSessionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateGooglePayDigitalWalletSessionRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CreateGooglePayDigitalWalletSessionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.CreateGooglePayDigitalWalletSessionResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.CreateGooglePayDigitalWalletSessionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.CreateGooglePayDigitalWalletSessionResponse res = resBuilder.build();
