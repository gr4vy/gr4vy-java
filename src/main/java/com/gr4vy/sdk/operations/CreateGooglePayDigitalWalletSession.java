...
public class CreateGooglePayDigitalWalletSession {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateGooglePayDigitalWalletSessionRequest request) {
        ...
        @Override
        public CreateGooglePayDigitalWalletSessionResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGooglePaySession(Utils.unmarshal(response, new TypeReference<GooglePaySession>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CreateGooglePayDigitalWalletSessionResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GooglePaySession>() {})
                            .thenApply(res::withGooglePaySession);
                } else {
