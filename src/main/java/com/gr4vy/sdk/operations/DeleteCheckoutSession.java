...
public class DeleteCheckoutSession {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteCheckoutSessionRequest, DeleteCheckoutSessionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteCheckoutSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteCheckoutSessionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteCheckoutSessionRequest request) throws Exception {
        ...
        @Override
        public DeleteCheckoutSessionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteCheckoutSessionResponse.Builder resBuilder =
            ...
            DeleteCheckoutSessionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteCheckoutSessionRequest, com.gr4vy.sdk.models.operations.async.DeleteCheckoutSessionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteCheckoutSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteCheckoutSessionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteCheckoutSessionRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.DeleteCheckoutSessionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.DeleteCheckoutSessionResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.DeleteCheckoutSessionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.DeleteCheckoutSessionResponse res = resBuilder.build();
