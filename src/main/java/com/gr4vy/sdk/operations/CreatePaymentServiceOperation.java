...
public class CreatePaymentServiceOperation implements RequestOperation<CreatePaymentServiceRequest, CreatePaymentServiceResponse> {
    ...
    public CreatePaymentServiceOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreatePaymentServiceRequest request) throws Exception {
