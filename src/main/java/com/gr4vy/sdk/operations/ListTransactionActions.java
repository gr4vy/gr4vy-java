...
public class ListTransactionActions {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTransactionActionsRequest, ListTransactionActionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTransactionActionsRequest request) {
        ...
        @Override
        public ListTransactionActionsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTransactionActions(Utils.unmarshal(response, new TypeReference<TransactionActions>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTransactionActionsRequest, com.gr4vy.sdk.models.operations.async.ListTransactionActionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListTransactionActionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTransactionActionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTransactionActionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListTransactionActionsResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TransactionActions>() {})
