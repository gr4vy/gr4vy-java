...
public class ListDigitalWallets {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListDigitalWalletsRequest, ListDigitalWalletsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListDigitalWalletsRequest request) throws Exception {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListDigitalWalletsRequest, com.gr4vy.sdk.models.operations.async.ListDigitalWalletsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListDigitalWalletsRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListDigitalWalletsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListDigitalWalletsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListDigitalWalletsResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListDigitalWalletsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListDigitalWalletsResponse res = resBuilder.build();
