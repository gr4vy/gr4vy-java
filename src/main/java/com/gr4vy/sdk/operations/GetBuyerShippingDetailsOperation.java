...
public class GetBuyerShippingDetailsOperation implements RequestOperation<GetBuyerShippingDetailsRequest, GetBuyerShippingDetailsResponse> {
    ...
    public GetBuyerShippingDetailsOperation(
    ...
    public HttpRequest buildRequest(GetBuyerShippingDetailsRequest request) throws Exception {
