...
public class GetPayoutOperation implements RequestOperation<GetPayoutRequest, GetPayoutResponse> {
    ...
    public HttpRequest buildRequest(GetPayoutRequest request) throws Exception {
