...
public class ListTransactionEvents {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTransactionEventsRequest, ListTransactionEventsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTransactionEventsRequest request) throws Exception {
        ...
        @Override
        public ListTransactionEventsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListTransactionEventsResponse.Builder resBuilder =
            ...
            ListTransactionEventsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TransactionEvents out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTransactionEvents(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTransactionEventsRequest, com.gr4vy.sdk.models.operations.async.ListTransactionEventsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListTransactionEventsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTransactionEventsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTransactionEventsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListTransactionEventsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListTransactionEventsResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListTransactionEventsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListTransactionEventsResponse res = resBuilder.build();
