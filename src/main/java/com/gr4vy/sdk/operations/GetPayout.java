...
public class GetPayout {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPayoutRequest, GetPayoutResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetPayoutRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPayoutRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPayoutRequest request) throws Exception {
        ...
        @Override
        public GetPayoutResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPayoutResponse.Builder resBuilder =
                    GetPayoutResponse
                            .builder()
            ...
            GetPayoutResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PayoutSummary out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPayoutSummary(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPayoutRequest, com.gr4vy.sdk.models.operations.async.GetPayoutResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetPayoutRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPayoutRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPayoutRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.GetPayoutResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.GetPayoutResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.GetPayoutResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.GetPayoutResponse res = resBuilder.build();
