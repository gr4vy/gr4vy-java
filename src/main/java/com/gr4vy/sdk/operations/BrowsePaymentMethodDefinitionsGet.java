...
public class BrowsePaymentMethodDefinitionsGet {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(BrowsePaymentMethodDefinitionsGetRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<BrowsePaymentMethodDefinitionsGetRequest, BrowsePaymentMethodDefinitionsGetResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(BrowsePaymentMethodDefinitionsGetRequest request) throws Exception {
        ...
        @Override
        public BrowsePaymentMethodDefinitionsGetResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            BrowsePaymentMethodDefinitionsGetResponse.Builder resBuilder =
                    BrowsePaymentMethodDefinitionsGetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            BrowsePaymentMethodDefinitionsGetResponse res = resBuilder.build();
