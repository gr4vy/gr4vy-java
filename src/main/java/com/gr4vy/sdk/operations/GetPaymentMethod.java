...
public class GetPaymentMethod {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPaymentMethodRequest, com.gr4vy.sdk.models.operations.async.GetPaymentMethodResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetPaymentMethodRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentMethodRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPaymentMethodRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.GetPaymentMethodResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.GetPaymentMethodResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.GetPaymentMethodResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.GetPaymentMethodResponse res = resBuilder.build();
