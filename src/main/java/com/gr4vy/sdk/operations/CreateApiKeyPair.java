...
public class CreateApiKeyPair {
    ...
    public static class Sync extends Base
            implements RequestOperation<APIKeyPairCreate, CreateApiKeyPairResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(APIKeyPairCreate request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<APIKeyPairCreate>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(APIKeyPairCreate request) {
        ...
        @Override
        public CreateApiKeyPairResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateApiKeyPairResponse.Builder resBuilder =
                    CreateApiKeyPairResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            CreateApiKeyPairResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<APIKeyPairCreate, com.gr4vy.sdk.models.operations.async.CreateApiKeyPairResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(APIKeyPairCreate request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<APIKeyPairCreate>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(APIKeyPairCreate request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CreateApiKeyPairResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.CreateApiKeyPairResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.CreateApiKeyPairResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.CreateApiKeyPairResponse res = resBuilder.build();
