...
public class SuspendPaymentMethodNetworkTokenOperation implements RequestOperation<SuspendPaymentMethodNetworkTokenRequest, SuspendPaymentMethodNetworkTokenResponse> {
    ...
    public SuspendPaymentMethodNetworkTokenOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(SuspendPaymentMethodNetworkTokenRequest request) throws Exception {
