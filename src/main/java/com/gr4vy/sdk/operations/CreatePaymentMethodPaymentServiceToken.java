...
public class CreatePaymentMethodPaymentServiceToken {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreatePaymentMethodPaymentServiceTokenRequest request) {
        ...
        @Override
        public CreatePaymentMethodPaymentServiceTokenResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaymentServiceToken(Utils.unmarshal(response, new TypeReference<PaymentServiceToken>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CreatePaymentMethodPaymentServiceTokenResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaymentServiceToken>() {})
                            .thenApply(res::withPaymentServiceToken);
                } else {
