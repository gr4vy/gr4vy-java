...
public class CreatePaymentMethodPaymentServiceToken {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreatePaymentMethodPaymentServiceTokenRequest, CreatePaymentMethodPaymentServiceTokenResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreatePaymentMethodPaymentServiceTokenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePaymentMethodPaymentServiceTokenRequest.class, new TypeReference<CreatePaymentMethodPaymentServiceTokenRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreatePaymentMethodPaymentServiceTokenRequest request) throws Exception {
        ...
        @Override
        public CreatePaymentMethodPaymentServiceTokenResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreatePaymentMethodPaymentServiceTokenResponse.Builder resBuilder =
            ...
            CreatePaymentMethodPaymentServiceTokenResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PaymentServiceToken out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPaymentServiceToken(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreatePaymentMethodPaymentServiceTokenRequest, com.gr4vy.sdk.models.operations.async.CreatePaymentMethodPaymentServiceTokenResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreatePaymentMethodPaymentServiceTokenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePaymentMethodPaymentServiceTokenRequest.class, new TypeReference<CreatePaymentMethodPaymentServiceTokenRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreatePaymentMethodPaymentServiceTokenRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CreatePaymentMethodPaymentServiceTokenResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.CreatePaymentMethodPaymentServiceTokenResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.CreatePaymentMethodPaymentServiceTokenResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.CreatePaymentMethodPaymentServiceTokenResponse res = resBuilder.build();
