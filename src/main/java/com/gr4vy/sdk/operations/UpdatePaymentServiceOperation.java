...
public class UpdatePaymentServiceOperation implements RequestOperation<UpdatePaymentServiceRequest, UpdatePaymentServiceResponse> {
    ...
    public UpdatePaymentServiceOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdatePaymentServiceRequest request) throws Exception {
