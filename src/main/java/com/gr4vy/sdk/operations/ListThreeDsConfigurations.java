...
public class ListThreeDsConfigurations {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListThreeDsConfigurationsRequest, ListThreeDsConfigurationsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListThreeDsConfigurationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListThreeDsConfigurationsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListThreeDsConfigurationsRequest request) {
        ...
        @Override
        public ListThreeDsConfigurationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListThreeDsConfigurationsResponse.Builder resBuilder =
                    ListThreeDsConfigurationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ListThreeDsConfigurationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMerchantAccountThreeDSConfigurations(Utils.unmarshal(response, new TypeReference<MerchantAccountThreeDSConfigurations>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListThreeDsConfigurationsRequest, com.gr4vy.sdk.models.operations.async.ListThreeDsConfigurationsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListThreeDsConfigurationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListThreeDsConfigurationsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListThreeDsConfigurationsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListThreeDsConfigurationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListThreeDsConfigurationsResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListThreeDsConfigurationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListThreeDsConfigurationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MerchantAccountThreeDSConfigurations>() {})
                            .thenApply(res::withMerchantAccountThreeDSConfigurations);
                } else {
