...
public class CreatePaymentMethodOperation implements RequestOperation<CreatePaymentMethodRequest, CreatePaymentMethodResponse> {
    ...
    public CreatePaymentMethodOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreatePaymentMethodRequest request) throws Exception {
