...
public class RegisterDigitalWalletDomainOperation implements RequestOperation<RegisterDigitalWalletDomainRequest, RegisterDigitalWalletDomainResponse> {
    ...
    public RegisterDigitalWalletDomainOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RegisterDigitalWalletDomainRequest request) throws Exception {
