...
public class GetReportOperation implements RequestOperation<GetReportRequest, GetReportResponse> {
    ...
    public HttpRequest buildRequest(GetReportRequest request) throws Exception {
