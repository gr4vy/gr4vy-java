...
public class ListGiftCardsOperation implements RequestOperation<ListGiftCardsRequest, ListGiftCardsResponse> {
    ...
    public HttpRequest buildRequest(ListGiftCardsRequest request) throws Exception {
