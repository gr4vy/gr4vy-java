...
public class CreateMerchantAccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<MerchantAccountCreate, CreateMerchantAccountResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(MerchantAccountCreate request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<MerchantAccountCreate>() {});
        ...
        public CreateMerchantAccountResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            CreateMerchantAccountResponse.Builder resBuilder =
            ...
            CreateMerchantAccountResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MerchantAccountCreate, com.gr4vy.sdk.models.operations.async.CreateMerchantAccountResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(MerchantAccountCreate request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<MerchantAccountCreate>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MerchantAccountCreate request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CreateMerchantAccountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.CreateMerchantAccountResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.CreateMerchantAccountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.CreateMerchantAccountResponse res = resBuilder.build();
