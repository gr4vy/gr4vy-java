...
public class ExpirePaymentLink {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ExpirePaymentLinkRequest request) {
        ...
        @Override
        public ExpirePaymentLinkResponse handleResponse(HttpResponse<InputStream> response) {
