...
public class ExpirePaymentLink {
    ...
    public static class Sync extends Base
            implements RequestOperation<ExpirePaymentLinkRequest, ExpirePaymentLinkResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ExpirePaymentLinkRequest request) throws Exception {
        ...
        @Override
        public ExpirePaymentLinkResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ExpirePaymentLinkResponse.Builder resBuilder =
            ...
            ExpirePaymentLinkResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ExpirePaymentLinkRequest, com.gr4vy.sdk.models.operations.async.ExpirePaymentLinkResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ExpirePaymentLinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ExpirePaymentLinkRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ExpirePaymentLinkRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ExpirePaymentLinkResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ExpirePaymentLinkResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ExpirePaymentLinkResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ExpirePaymentLinkResponse res = resBuilder.build();
