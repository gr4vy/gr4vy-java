...
public class AddBuyerOperation implements RequestOperation<AddBuyerRequest, AddBuyerResponse> {
    ...
    public AddBuyerOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(AddBuyerRequest request) throws Exception {
