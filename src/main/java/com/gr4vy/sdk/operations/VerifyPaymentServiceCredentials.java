...
public class VerifyPaymentServiceCredentials {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(VerifyPaymentServiceCredentialsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<VerifyPaymentServiceCredentialsRequest>() {});
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<VerifyPaymentServiceCredentialsRequest, com.gr4vy.sdk.models.operations.async.VerifyPaymentServiceCredentialsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(VerifyPaymentServiceCredentialsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<VerifyPaymentServiceCredentialsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(VerifyPaymentServiceCredentialsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.VerifyPaymentServiceCredentialsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.VerifyPaymentServiceCredentialsResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.VerifyPaymentServiceCredentialsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.VerifyPaymentServiceCredentialsResponse res = resBuilder.build();
