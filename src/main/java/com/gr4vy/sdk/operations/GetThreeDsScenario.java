...
public class GetThreeDsScenario {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetThreeDsScenarioRequest, GetThreeDsScenarioResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetThreeDsScenarioRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetThreeDsScenarioRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetThreeDsScenarioRequest request) {
        ...
        @Override
        public GetThreeDsScenarioResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetThreeDsScenarioResponse.Builder resBuilder =
            ...
            GetThreeDsScenarioResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withThreeDSecureScenarios(Utils.unmarshal(response, new TypeReference<ThreeDSecureScenarios>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetThreeDsScenarioRequest, com.gr4vy.sdk.models.operations.async.GetThreeDsScenarioResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetThreeDsScenarioRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetThreeDsScenarioRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetThreeDsScenarioRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.GetThreeDsScenarioResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.GetThreeDsScenarioResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.GetThreeDsScenarioResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.GetThreeDsScenarioResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ThreeDSecureScenarios>() {})
                            .thenApply(res::withThreeDSecureScenarios);
                } else {
