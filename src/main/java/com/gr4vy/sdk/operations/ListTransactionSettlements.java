...
import com.gr4vy.sdk.models.components.Settlements;
...
public class ListTransactionSettlements {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ListTransactionSettlementsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTransactionSettlementsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTransactionSettlementsRequest request) throws Exception {
        ...
        @Override
        public ListTransactionSettlementsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListTransactionSettlementsResponse.Builder resBuilder =
            ...
            ListTransactionSettlementsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Settlements out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withSettlements(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTransactionSettlementsRequest, com.gr4vy.sdk.models.operations.async.ListTransactionSettlementsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListTransactionSettlementsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTransactionSettlementsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTransactionSettlementsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListTransactionSettlementsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListTransactionSettlementsResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListTransactionSettlementsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListTransactionSettlementsResponse res = resBuilder.build();
