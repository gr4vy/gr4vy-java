...
public class ListGiftCardBalances {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListGiftCardBalancesRequest, ListGiftCardBalancesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListGiftCardBalancesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ListGiftCardBalancesRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListGiftCardBalancesRequest request) throws Exception {
        ...
        @Override
        public ListGiftCardBalancesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListGiftCardBalancesResponse.Builder resBuilder =
            ...
            ListGiftCardBalancesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GiftCardSummaries out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGiftCardSummaries(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListGiftCardBalancesRequest, com.gr4vy.sdk.models.operations.async.ListGiftCardBalancesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListGiftCardBalancesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ListGiftCardBalancesRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListGiftCardBalancesRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListGiftCardBalancesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListGiftCardBalancesResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListGiftCardBalancesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListGiftCardBalancesResponse res = resBuilder.build();
