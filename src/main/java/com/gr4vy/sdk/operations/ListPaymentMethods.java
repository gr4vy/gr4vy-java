...
public class ListPaymentMethods {
        ...
        public ListPaymentMethodsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PaymentMethods out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPaymentMethodsRequest, com.gr4vy.sdk.models.operations.async.ListPaymentMethodsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListPaymentMethodsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentMethodsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPaymentMethodsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListPaymentMethodsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListPaymentMethodsResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListPaymentMethodsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListPaymentMethodsResponse res = resBuilder.build();
