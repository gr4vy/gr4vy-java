...
public class DeletePaymentMethodPaymentServiceTokenOperation implements RequestOperation<DeletePaymentMethodPaymentServiceTokenRequest, DeletePaymentMethodPaymentServiceTokenResponse> {
    ...
    public DeletePaymentMethodPaymentServiceTokenOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(DeletePaymentMethodPaymentServiceTokenRequest request) throws Exception {
