...
public class CaptureTransactionOperation implements RequestOperation<CaptureTransactionRequest, CaptureTransactionResponse> {
    ...
    public CaptureTransactionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CaptureTransactionRequest request) throws Exception {
