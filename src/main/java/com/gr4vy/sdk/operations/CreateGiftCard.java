...
public class CreateGiftCard {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(CreateGiftCardRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateGiftCardRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateGiftCardRequest request) throws Exception {
        ...
        @Override
        public CreateGiftCardResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateGiftCardResponse.Builder resBuilder =
            ...
            CreateGiftCardResponse res = resBuilder.build();
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateGiftCardRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CreateGiftCardResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.CreateGiftCardResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.CreateGiftCardResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.CreateGiftCardResponse res = resBuilder.build();
