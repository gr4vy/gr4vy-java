...
public class AddBuyerShippingDetailsOperation implements RequestOperation<AddBuyerShippingDetailsRequest, AddBuyerShippingDetailsResponse> {
    ...
    public AddBuyerShippingDetailsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(AddBuyerShippingDetailsRequest request) throws Exception {
