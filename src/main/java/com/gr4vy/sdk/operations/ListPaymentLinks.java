...
public class ListPaymentLinks {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPaymentLinksRequest, com.gr4vy.sdk.models.operations.async.ListPaymentLinksResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListPaymentLinksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentLinksRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPaymentLinksRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListPaymentLinksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListPaymentLinksResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListPaymentLinksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListPaymentLinksResponse res = resBuilder.build();
