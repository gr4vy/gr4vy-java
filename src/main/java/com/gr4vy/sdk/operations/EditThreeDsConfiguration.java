...
public class EditThreeDsConfiguration {
    ...
    public static class Sync extends Base
            implements RequestOperation<EditThreeDsConfigurationRequest, EditThreeDsConfigurationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(EditThreeDsConfigurationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EditThreeDsConfigurationRequest.class, new TypeReference<EditThreeDsConfigurationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EditThreeDsConfigurationRequest request) {
        ...
        @Override
        public EditThreeDsConfigurationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EditThreeDsConfigurationResponse.Builder resBuilder =
                    EditThreeDsConfigurationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            EditThreeDsConfigurationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EditThreeDsConfigurationRequest, com.gr4vy.sdk.models.operations.async.EditThreeDsConfigurationResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(EditThreeDsConfigurationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EditThreeDsConfigurationRequest.class, new TypeReference<EditThreeDsConfigurationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(EditThreeDsConfigurationRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.EditThreeDsConfigurationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.EditThreeDsConfigurationResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.EditThreeDsConfigurationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.EditThreeDsConfigurationResponse res = resBuilder.build();
