...
public class DeletePaymentMethodPaymentServiceToken {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeletePaymentMethodPaymentServiceTokenRequest, DeletePaymentMethodPaymentServiceTokenResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeletePaymentMethodPaymentServiceTokenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletePaymentMethodPaymentServiceTokenRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeletePaymentMethodPaymentServiceTokenRequest request) throws Exception {
        ...
        @Override
        public DeletePaymentMethodPaymentServiceTokenResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeletePaymentMethodPaymentServiceTokenResponse.Builder resBuilder =
            ...
            DeletePaymentMethodPaymentServiceTokenResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeletePaymentMethodPaymentServiceTokenRequest, com.gr4vy.sdk.models.operations.async.DeletePaymentMethodPaymentServiceTokenResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeletePaymentMethodPaymentServiceTokenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletePaymentMethodPaymentServiceTokenRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeletePaymentMethodPaymentServiceTokenRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.DeletePaymentMethodPaymentServiceTokenResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.DeletePaymentMethodPaymentServiceTokenResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.DeletePaymentMethodPaymentServiceTokenResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.DeletePaymentMethodPaymentServiceTokenResponse res = resBuilder.build();
