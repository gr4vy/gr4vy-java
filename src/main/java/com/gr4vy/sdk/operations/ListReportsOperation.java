...
public class ListReportsOperation implements RequestOperation<ListReportsRequest, ListReportsResponse> {
    ...
    public HttpRequest buildRequest(ListReportsRequest request) throws Exception {
