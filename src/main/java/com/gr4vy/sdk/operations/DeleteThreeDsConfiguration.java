...
public class DeleteThreeDsConfiguration {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteThreeDsConfigurationRequest, DeleteThreeDsConfigurationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteThreeDsConfigurationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteThreeDsConfigurationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteThreeDsConfigurationRequest request) {
        ...
        @Override
        public DeleteThreeDsConfigurationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteThreeDsConfigurationResponse.Builder resBuilder =
                    DeleteThreeDsConfigurationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            DeleteThreeDsConfigurationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteThreeDsConfigurationRequest, com.gr4vy.sdk.models.operations.async.DeleteThreeDsConfigurationResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteThreeDsConfigurationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteThreeDsConfigurationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteThreeDsConfigurationRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.DeleteThreeDsConfigurationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.DeleteThreeDsConfigurationResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.DeleteThreeDsConfigurationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.DeleteThreeDsConfigurationResponse res = resBuilder.build();
