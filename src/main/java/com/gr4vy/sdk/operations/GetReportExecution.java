...
public class GetReportExecution {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetReportExecutionRequest, GetReportExecutionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetReportExecutionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetReportExecutionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetReportExecutionRequest request) throws Exception {
        ...
        @Override
        public GetReportExecutionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetReportExecutionResponse.Builder resBuilder =
            ...
            GetReportExecutionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ReportExecution out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withReportExecution(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetReportExecutionRequest, com.gr4vy.sdk.models.operations.async.GetReportExecutionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetReportExecutionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetReportExecutionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetReportExecutionRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.GetReportExecutionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.GetReportExecutionResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.GetReportExecutionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.GetReportExecutionResponse res = resBuilder.build();
