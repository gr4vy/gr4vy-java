...
public class ListBuyerPaymentMethodsOperation implements RequestOperation<ListBuyerPaymentMethodsRequest, ListBuyerPaymentMethodsResponse> {
    ...
    public ListBuyerPaymentMethodsOperation(
    ...
    public HttpRequest buildRequest(ListBuyerPaymentMethodsRequest request) throws Exception {
