...
public class UpdateBuyerShippingDetailsOperation implements RequestOperation<UpdateBuyerShippingDetailsRequest, UpdateBuyerShippingDetailsResponse> {
    ...
    public UpdateBuyerShippingDetailsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateBuyerShippingDetailsRequest request) throws Exception {
