...
public class AddReportOperation implements RequestOperation<AddReportRequest, AddReportResponse> {
    ...
    public AddReportOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(AddReportRequest request) throws Exception {
