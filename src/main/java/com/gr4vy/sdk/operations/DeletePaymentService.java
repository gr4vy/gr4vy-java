...
public class DeletePaymentService {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeletePaymentServiceRequest, DeletePaymentServiceResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(DeletePaymentServiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletePaymentServiceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeletePaymentServiceRequest request) throws Exception {
        ...
        @Override
        public DeletePaymentServiceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeletePaymentServiceResponse.Builder resBuilder =
            ...
            DeletePaymentServiceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeletePaymentServiceRequest, com.gr4vy.sdk.models.operations.async.DeletePaymentServiceResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeletePaymentServiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletePaymentServiceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeletePaymentServiceRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.DeletePaymentServiceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.DeletePaymentServiceResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.DeletePaymentServiceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.DeletePaymentServiceResponse res = resBuilder.build();
