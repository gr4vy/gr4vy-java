...
public class GetCheckoutSessionOperation implements RequestOperation<GetCheckoutSessionRequest, GetCheckoutSessionResponse> {
    ...
    public GetCheckoutSessionOperation(
    ...
    public HttpRequest buildRequest(GetCheckoutSessionRequest request) throws Exception {
