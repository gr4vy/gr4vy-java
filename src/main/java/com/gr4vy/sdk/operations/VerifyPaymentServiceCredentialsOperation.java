...
public class VerifyPaymentServiceCredentialsOperation implements RequestOperation<VerifyPaymentServiceCredentialsRequest, VerifyPaymentServiceCredentialsResponse> {
    ...
    public VerifyPaymentServiceCredentialsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(VerifyPaymentServiceCredentialsRequest request) throws Exception {
