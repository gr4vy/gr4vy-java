...
public class ListPaymentOptions {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPaymentOptionsRequest, ListPaymentOptionsResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPaymentOptionsRequest request) throws Exception {
        ...
        @Override
        public ListPaymentOptionsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPaymentOptionsResponse.Builder resBuilder =
            ...
            ListPaymentOptionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PaymentOptions out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPaymentOptions(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPaymentOptionsRequest, com.gr4vy.sdk.models.operations.async.ListPaymentOptionsResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListPaymentOptionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ListPaymentOptionsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPaymentOptionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListPaymentOptionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListPaymentOptionsResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListPaymentOptionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListPaymentOptionsResponse res = resBuilder.build();
