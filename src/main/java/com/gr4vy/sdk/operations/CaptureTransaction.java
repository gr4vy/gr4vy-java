...
public class CaptureTransaction {
    ...
    public static class Sync extends Base
            implements RequestOperation<CaptureTransactionRequest, CaptureTransactionResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(CaptureTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CaptureTransactionRequest.class, new TypeReference<CaptureTransactionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CaptureTransactionRequest request) throws Exception {
        ...
        @Override
        public CaptureTransactionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CaptureTransactionResponse.Builder resBuilder =
            ...
            CaptureTransactionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CaptureTransactionRequest, com.gr4vy.sdk.models.operations.async.CaptureTransactionResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CaptureTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CaptureTransactionRequest.class, new TypeReference<CaptureTransactionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CaptureTransactionRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CaptureTransactionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.CaptureTransactionResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.CaptureTransactionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.CaptureTransactionResponse res = resBuilder.build();
