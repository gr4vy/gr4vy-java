...
public class ListCardSchemeDefinitions {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCardSchemeDefinitionsRequest, ListCardSchemeDefinitionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListCardSchemeDefinitionsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCardSchemeDefinitionsRequest request) throws Exception {
        ...
        @Override
        public ListCardSchemeDefinitionsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCardSchemeDefinitionsResponse.Builder resBuilder =
            ...
            ListCardSchemeDefinitionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CardSchemeDefinitions out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCardSchemeDefinitions(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCardSchemeDefinitionsRequest, com.gr4vy.sdk.models.operations.async.ListCardSchemeDefinitionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListCardSchemeDefinitionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCardSchemeDefinitionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListCardSchemeDefinitionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListCardSchemeDefinitionsResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListCardSchemeDefinitionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListCardSchemeDefinitionsResponse res = resBuilder.build();
