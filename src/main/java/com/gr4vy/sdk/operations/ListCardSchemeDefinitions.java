...
public class ListCardSchemeDefinitions {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCardSchemeDefinitionsRequest request) {
        ...
        @Override
        public ListCardSchemeDefinitionsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCardSchemeDefinitions(Utils.unmarshal(response, new TypeReference<CardSchemeDefinitions>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListCardSchemeDefinitionsResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CardSchemeDefinitions>() {})
                            .thenApply(res::withCardSchemeDefinitions);
                } else {
