...
public class AddReport {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddReportRequest, AddReportResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(AddReportRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AddReportRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddReportRequest request) throws Exception {
        ...
        @Override
        public AddReportResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddReportResponse.Builder resBuilder =
                    AddReportResponse
                            .builder()
            ...
            AddReportResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddReportRequest, com.gr4vy.sdk.models.operations.async.AddReportResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AddReportRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AddReportRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddReportRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.AddReportResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.AddReportResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.AddReportResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.AddReportResponse res = resBuilder.build();
