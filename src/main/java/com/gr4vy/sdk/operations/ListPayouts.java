...
public class ListPayouts {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ListPayoutsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPayoutsRequest.class);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPayoutsRequest, com.gr4vy.sdk.models.operations.async.ListPayoutsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListPayoutsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPayoutsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPayoutsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListPayoutsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListPayoutsResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListPayoutsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListPayoutsResponse res = resBuilder.build();
