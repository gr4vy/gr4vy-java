...
public class ListBuyerShippingDetailsOperation implements RequestOperation<ListBuyerShippingDetailsRequest, ListBuyerShippingDetailsResponse> {
    ...
    public ListBuyerShippingDetailsOperation(
    ...
    public HttpRequest buildRequest(ListBuyerShippingDetailsRequest request) throws Exception {
