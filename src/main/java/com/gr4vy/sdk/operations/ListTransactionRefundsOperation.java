...
public class ListTransactionRefundsOperation implements RequestOperation<ListTransactionRefundsRequest, ListTransactionRefundsResponse> {
    ...
    public ListTransactionRefundsOperation(
    ...
    public HttpRequest buildRequest(ListTransactionRefundsRequest request) throws Exception {
