...
public class CreatePazeDigitalWalletSession {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "create_paze_digital_wallet_session",
    ...
    public static class Sync extends Base
            implements RequestOperation<CreatePazeDigitalWalletSessionRequest, CreatePazeDigitalWalletSessionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreatePazeDigitalWalletSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreatePazeDigitalWalletSessionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreatePazeDigitalWalletSessionRequest request) {
        ...
        @Override
        public CreatePazeDigitalWalletSessionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreatePazeDigitalWalletSessionResponse.Builder resBuilder =
            ...
            CreatePazeDigitalWalletSessionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withResponseCreatePazeDigitalWalletSession(Utils.unmarshal(response, new TypeReference<ResponseCreatePazeDigitalWalletSession>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreatePazeDigitalWalletSessionRequest, com.gr4vy.sdk.models.operations.async.CreatePazeDigitalWalletSessionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreatePazeDigitalWalletSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreatePazeDigitalWalletSessionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreatePazeDigitalWalletSessionRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CreatePazeDigitalWalletSessionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.CreatePazeDigitalWalletSessionResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.CreatePazeDigitalWalletSessionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.CreatePazeDigitalWalletSessionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ResponseCreatePazeDigitalWalletSession>() {})
                            .thenApply(res::withResponseCreatePazeDigitalWalletSession);
                } else {
