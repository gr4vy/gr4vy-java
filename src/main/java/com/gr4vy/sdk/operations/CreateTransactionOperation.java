...
public class CreateTransactionOperation implements RequestOperation<CreateTransactionRequest, CreateTransactionResponse> {
    ...
    public CreateTransactionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateTransactionRequest request) throws Exception {
