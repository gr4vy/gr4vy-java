...
public class CreateApplePayDigitalWalletSessionOperation implements RequestOperation<CreateApplePayDigitalWalletSessionRequest, CreateApplePayDigitalWalletSessionResponse> {
    ...
    public CreateApplePayDigitalWalletSessionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateApplePayDigitalWalletSessionRequest request) throws Exception {
