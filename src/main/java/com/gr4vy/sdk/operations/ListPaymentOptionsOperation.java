...
public class ListPaymentOptionsOperation implements RequestOperation<ListPaymentOptionsRequest, ListPaymentOptionsResponse> {
    ...
    public ListPaymentOptionsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListPaymentOptionsRequest request) throws Exception {
