...
public class GetTransactionRefund {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTransactionRefundRequest, GetTransactionRefundResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public GetTransactionRefundResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTransactionRefundResponse.Builder resBuilder =
            ...
            GetTransactionRefundResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTransactionRefundRequest, com.gr4vy.sdk.models.operations.async.GetTransactionRefundResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetTransactionRefundRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTransactionRefundRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTransactionRefundRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.GetTransactionRefundResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.GetTransactionRefundResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.GetTransactionRefundResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.GetTransactionRefundResponse res = resBuilder.build();
