...
public class CreatePayout {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreatePayoutRequest, CreatePayoutResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreatePayoutRequest request) throws Exception {
        ...
        @Override
        public CreatePayoutResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreatePayoutResponse.Builder resBuilder =
            ...
            CreatePayoutResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreatePayoutRequest, com.gr4vy.sdk.models.operations.async.CreatePayoutResponse> {
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreatePayoutRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CreatePayoutResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.CreatePayoutResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.CreatePayoutResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.CreatePayoutResponse res = resBuilder.build();
