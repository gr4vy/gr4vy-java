...
public class UpdatePaymentMethod {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdatePaymentMethodRequest, UpdatePaymentMethodResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdatePaymentMethodRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePaymentMethodRequest.class, new TypeReference<UpdatePaymentMethodRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdatePaymentMethodRequest request) {
        ...
        @Override
        public UpdatePaymentMethodResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdatePaymentMethodResponse.Builder resBuilder =
            ...
            UpdatePaymentMethodResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdatePaymentMethodRequest, com.gr4vy.sdk.models.operations.async.UpdatePaymentMethodResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdatePaymentMethodRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePaymentMethodRequest.class, new TypeReference<UpdatePaymentMethodRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdatePaymentMethodRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.UpdatePaymentMethodResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.UpdatePaymentMethodResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.UpdatePaymentMethodResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.UpdatePaymentMethodResponse res = resBuilder.build();
