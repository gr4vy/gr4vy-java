...
public class GetTransactionOperation implements RequestOperation<GetTransactionRequest, GetTransactionResponse> {
    ...
    public GetTransactionOperation(
    ...
    public HttpRequest buildRequest(GetTransactionRequest request) throws Exception {
