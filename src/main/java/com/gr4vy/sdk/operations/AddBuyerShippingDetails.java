...
public class AddBuyerShippingDetails {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddBuyerShippingDetailsRequest, AddBuyerShippingDetailsResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddBuyerShippingDetailsRequest request) throws Exception {
        ...
        @Override
        public AddBuyerShippingDetailsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddBuyerShippingDetailsResponse.Builder resBuilder =
            ...
            AddBuyerShippingDetailsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddBuyerShippingDetailsRequest, com.gr4vy.sdk.models.operations.async.AddBuyerShippingDetailsResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AddBuyerShippingDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddBuyerShippingDetailsRequest.class, new TypeReference<AddBuyerShippingDetailsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddBuyerShippingDetailsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.AddBuyerShippingDetailsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.AddBuyerShippingDetailsResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.AddBuyerShippingDetailsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.AddBuyerShippingDetailsResponse res = resBuilder.build();
