...
public class UpdateThreeDsScenario {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateThreeDsScenarioRequest, UpdateThreeDsScenarioResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateThreeDsScenarioRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateThreeDsScenarioRequest.class, new TypeReference<UpdateThreeDsScenarioRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateThreeDsScenarioRequest request) {
        ...
        @Override
        public UpdateThreeDsScenarioResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateThreeDsScenarioResponse.Builder resBuilder =
            ...
            UpdateThreeDsScenarioResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withThreeDSecureScenario(Utils.unmarshal(response, new TypeReference<ThreeDSecureScenario>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateThreeDsScenarioRequest, com.gr4vy.sdk.models.operations.async.UpdateThreeDsScenarioResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateThreeDsScenarioRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateThreeDsScenarioRequest.class, new TypeReference<UpdateThreeDsScenarioRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateThreeDsScenarioRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.UpdateThreeDsScenarioResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.UpdateThreeDsScenarioResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.UpdateThreeDsScenarioResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.UpdateThreeDsScenarioResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ThreeDSecureScenario>() {})
                            .thenApply(res::withThreeDSecureScenario);
                } else {
