...
public class CreatePaymentMethodNetworkTokenCryptogramOperation implements RequestOperation<CreatePaymentMethodNetworkTokenCryptogramRequest, CreatePaymentMethodNetworkTokenCryptogramResponse> {
    ...
    public CreatePaymentMethodNetworkTokenCryptogramOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreatePaymentMethodNetworkTokenCryptogramRequest request) throws Exception {
