...
public class UpdateDigitalWallet {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateDigitalWalletRequest, UpdateDigitalWalletResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateDigitalWalletRequest request) throws Exception {
        ...
        @Override
        public UpdateDigitalWalletResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateDigitalWalletResponse.Builder resBuilder =
            ...
            UpdateDigitalWalletResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateDigitalWalletRequest, com.gr4vy.sdk.models.operations.async.UpdateDigitalWalletResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateDigitalWalletRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateDigitalWalletRequest.class, new TypeReference<UpdateDigitalWalletRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateDigitalWalletRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.UpdateDigitalWalletResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.UpdateDigitalWalletResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.UpdateDigitalWalletResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.UpdateDigitalWalletResponse res = resBuilder.build();
