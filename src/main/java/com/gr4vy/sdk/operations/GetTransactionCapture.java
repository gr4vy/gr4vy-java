...
public class GetTransactionCapture {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTransactionCaptureRequest, GetTransactionCaptureResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetTransactionCaptureRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTransactionCaptureRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTransactionCaptureRequest request) {
        ...
        @Override
        public GetTransactionCaptureResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTransactionCaptureResponse.Builder resBuilder =
                    GetTransactionCaptureResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetTransactionCaptureResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTransactionCaptureRequest, com.gr4vy.sdk.models.operations.async.GetTransactionCaptureResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetTransactionCaptureRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTransactionCaptureRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTransactionCaptureRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.GetTransactionCaptureResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.GetTransactionCaptureResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.GetTransactionCaptureResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.GetTransactionCaptureResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Capture>() {})
                            .thenApply(res::withCapture);
                } else {
