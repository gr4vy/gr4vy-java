...
public class ReviewPazeMobileSession {
    ...
    public static class Sync extends Base
            implements RequestOperation<ReviewPazeMobileSessionRequest, ReviewPazeMobileSessionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ReviewPazeMobileSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ReviewPazeMobileSessionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ReviewPazeMobileSessionRequest request) {
        ...
        @Override
        public ReviewPazeMobileSessionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ReviewPazeMobileSessionResponse.Builder resBuilder =
            ...
            ReviewPazeMobileSessionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPazeSessionReview(Utils.unmarshal(response, new TypeReference<PazeSessionReview>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ReviewPazeMobileSessionRequest, com.gr4vy.sdk.models.operations.async.ReviewPazeMobileSessionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ReviewPazeMobileSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ReviewPazeMobileSessionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ReviewPazeMobileSessionRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ReviewPazeMobileSessionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ReviewPazeMobileSessionResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ReviewPazeMobileSessionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ReviewPazeMobileSessionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PazeSessionReview>() {})
                            .thenApply(res::withPazeSessionReview);
                } else {
