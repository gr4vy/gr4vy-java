...
public class DeleteBuyerOperation implements RequestOperation<DeleteBuyerRequest, DeleteBuyerResponse> {
    ...
    public DeleteBuyerOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(DeleteBuyerRequest request) throws Exception {
