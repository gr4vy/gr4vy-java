...
public class CancelTransaction {
    ...
    public static class Sync extends Base
            implements RequestOperation<CancelTransactionRequest, CancelTransactionResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CancelTransactionRequest request) throws Exception {
        ...
        @Override
        public CancelTransactionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CancelTransactionResponse.Builder resBuilder =
            ...
            CancelTransactionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TransactionCancel out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTransactionCancel(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CancelTransactionRequest, com.gr4vy.sdk.models.operations.async.CancelTransactionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CancelTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelTransactionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CancelTransactionRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CancelTransactionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.CancelTransactionResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.CancelTransactionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.CancelTransactionResponse res = resBuilder.build();
