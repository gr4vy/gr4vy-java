...
public class VoidTransactionOperation implements RequestOperation<VoidTransactionRequest, VoidTransactionResponse> {
    ...
    public VoidTransactionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(VoidTransactionRequest request) throws Exception {
