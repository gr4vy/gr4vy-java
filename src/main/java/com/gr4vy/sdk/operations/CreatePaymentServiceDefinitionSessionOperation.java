...
public class CreatePaymentServiceDefinitionSessionOperation implements RequestOperation<CreatePaymentServiceDefinitionSessionRequest, CreatePaymentServiceDefinitionSessionResponse> {
    ...
    public CreatePaymentServiceDefinitionSessionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreatePaymentServiceDefinitionSessionRequest request) throws Exception {
