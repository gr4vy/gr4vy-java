...
public class DeleteDigitalWalletOperation implements RequestOperation<DeleteDigitalWalletRequest, DeleteDigitalWalletResponse> {
    ...
    public DeleteDigitalWalletOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(DeleteDigitalWalletRequest request) throws Exception {
