...
public class RegisterDigitalWalletDomain {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RegisterDigitalWalletDomainRequest request) throws Exception {
        ...
        @Override
        public RegisterDigitalWalletDomainResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RegisterDigitalWalletDomainResponse.Builder resBuilder =
            ...
            RegisterDigitalWalletDomainResponse res = resBuilder.build();
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RegisterDigitalWalletDomainRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.RegisterDigitalWalletDomainResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.RegisterDigitalWalletDomainResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.RegisterDigitalWalletDomainResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.RegisterDigitalWalletDomainResponse res = resBuilder.build();
