...
public class CreatePaymentServiceSession {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreatePaymentServiceSessionRequest, CreatePaymentServiceSessionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreatePaymentServiceSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePaymentServiceSessionRequest.class, new TypeReference<CreatePaymentServiceSessionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreatePaymentServiceSessionRequest request) throws Exception {
        ...
        @Override
        public CreatePaymentServiceSessionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreatePaymentServiceSessionResponse.Builder resBuilder =
            ...
            CreatePaymentServiceSessionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CreateSession out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCreateSession(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreatePaymentServiceSessionRequest, com.gr4vy.sdk.models.operations.async.CreatePaymentServiceSessionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreatePaymentServiceSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePaymentServiceSessionRequest.class, new TypeReference<CreatePaymentServiceSessionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreatePaymentServiceSessionRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CreatePaymentServiceSessionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.CreatePaymentServiceSessionResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.CreatePaymentServiceSessionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.CreatePaymentServiceSessionResponse res = resBuilder.build();
