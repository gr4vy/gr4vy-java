...
public class CreateCheckoutSession {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCheckoutSessionRequest, CreateCheckoutSessionResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCheckoutSessionRequest request) throws Exception {
        ...
        @Override
        public CreateCheckoutSessionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCheckoutSessionResponse.Builder resBuilder =
            ...
            CreateCheckoutSessionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCheckoutSessionRequest, com.gr4vy.sdk.models.operations.async.CreateCheckoutSessionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCheckoutSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateCheckoutSessionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCheckoutSessionRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CreateCheckoutSessionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.CreateCheckoutSessionResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.CreateCheckoutSessionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.CreateCheckoutSessionResponse res = resBuilder.build();
