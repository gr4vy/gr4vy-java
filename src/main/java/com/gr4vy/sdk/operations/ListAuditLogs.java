...
public class ListAuditLogs {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAuditLogsRequest, ListAuditLogsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(ListAuditLogsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAuditLogsRequest.class);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAuditLogsRequest, com.gr4vy.sdk.models.operations.async.ListAuditLogsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListAuditLogsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAuditLogsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAuditLogsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListAuditLogsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListAuditLogsResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListAuditLogsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListAuditLogsResponse res = resBuilder.build();
