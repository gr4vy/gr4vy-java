...
public class UpdateDigitalWalletOperation implements RequestOperation<UpdateDigitalWalletRequest, UpdateDigitalWalletResponse> {
    ...
    public UpdateDigitalWalletOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateDigitalWalletRequest request) throws Exception {
