...
public class ListTransactionsOperation implements RequestOperation<ListTransactionsRequest, ListTransactionsResponse> {
    ...
    public ListTransactionsOperation(
    ...
    public HttpRequest buildRequest(ListTransactionsRequest request) throws Exception {
