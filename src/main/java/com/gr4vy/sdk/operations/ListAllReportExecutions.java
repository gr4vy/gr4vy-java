...
public class ListAllReportExecutions {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAllReportExecutionsRequest, ListAllReportExecutionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListAllReportExecutionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAllReportExecutionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAllReportExecutionsRequest request) throws Exception {
        ...
        @Override
        public ListAllReportExecutionsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAllReportExecutionsResponse.Builder resBuilder =
            ...
            ListAllReportExecutionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ReportExecutions out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withReportExecutions(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAllReportExecutionsRequest, com.gr4vy.sdk.models.operations.async.ListAllReportExecutionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListAllReportExecutionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAllReportExecutionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAllReportExecutionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListAllReportExecutionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListAllReportExecutionsResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListAllReportExecutionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListAllReportExecutionsResponse res = resBuilder.build();
