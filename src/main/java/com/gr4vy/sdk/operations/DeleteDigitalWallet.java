...
public class DeleteDigitalWallet {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteDigitalWalletRequest, DeleteDigitalWalletResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(DeleteDigitalWalletRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteDigitalWalletRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteDigitalWalletRequest request) throws Exception {
        ...
        @Override
        public DeleteDigitalWalletResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteDigitalWalletResponse.Builder resBuilder =
            ...
            DeleteDigitalWalletResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteDigitalWalletRequest, com.gr4vy.sdk.models.operations.async.DeleteDigitalWalletResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteDigitalWalletRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteDigitalWalletRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteDigitalWalletRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.DeleteDigitalWalletResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.DeleteDigitalWalletResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.DeleteDigitalWalletResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.DeleteDigitalWalletResponse res = resBuilder.build();
