...
public class GetGiftCard {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetGiftCardRequest, GetGiftCardResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetGiftCardRequest request) throws Exception {
        ...
        @Override
        public GetGiftCardResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetGiftCardResponse.Builder resBuilder =
                    GetGiftCardResponse
                            .builder()
            ...
            GetGiftCardResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GiftCard out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGiftCard(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetGiftCardRequest, com.gr4vy.sdk.models.operations.async.GetGiftCardResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetGiftCardRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetGiftCardRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetGiftCardRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.GetGiftCardResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.GetGiftCardResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.GetGiftCardResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.GetGiftCardResponse res = resBuilder.build();
