...
public class GetGiftCardOperation implements RequestOperation<GetGiftCardRequest, GetGiftCardResponse> {
    ...
    public HttpRequest buildRequest(GetGiftCardRequest request) throws Exception {
