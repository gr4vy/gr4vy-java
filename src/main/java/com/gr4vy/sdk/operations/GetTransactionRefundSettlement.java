...
import com.gr4vy.sdk.models.components.RefundSettlement;
...
public class GetTransactionRefundSettlement {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "get_transaction_refund_settlement",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTransactionRefundSettlementRequest, GetTransactionRefundSettlementResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetTransactionRefundSettlementRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTransactionRefundSettlementRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTransactionRefundSettlementRequest request) {
        ...
        @Override
        public GetTransactionRefundSettlementResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTransactionRefundSettlementResponse.Builder resBuilder =
            ...
            GetTransactionRefundSettlementResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRefundSettlement(Utils.unmarshal(response, new TypeReference<RefundSettlement>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTransactionRefundSettlementRequest, com.gr4vy.sdk.models.operations.async.GetTransactionRefundSettlementResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetTransactionRefundSettlementRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTransactionRefundSettlementRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTransactionRefundSettlementRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.GetTransactionRefundSettlementResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.GetTransactionRefundSettlementResponse.Builder resBuilder =
            ...
            com.gr4vy.sdk.models.operations.async.GetTransactionRefundSettlementResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<RefundSettlement>() {})
                            .thenApply(res::withRefundSettlement);
                } else {
