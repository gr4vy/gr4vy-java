...
public class ActivateGiftCard {
    ...
    public static class Sync extends Base
            implements RequestOperation<ActivateGiftCardRequest, ActivateGiftCardResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ActivateGiftCardRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ActivateGiftCardRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ActivateGiftCardRequest request) {
        ...
        @Override
        public ActivateGiftCardResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ActivateGiftCardRequest, com.gr4vy.sdk.models.operations.async.ActivateGiftCardResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ActivateGiftCardRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ActivateGiftCardRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ActivateGiftCardRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ActivateGiftCardResponse> handleResponse(
