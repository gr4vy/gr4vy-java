...
public class SyncTransactionOperation implements RequestOperation<SyncTransactionRequest, SyncTransactionResponse> {
    ...
    public SyncTransactionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(SyncTransactionRequest request) throws Exception {
