...
public class CreateGiftCardOperation implements RequestOperation<CreateGiftCardRequest, CreateGiftCardResponse> {
    ...
    public CreateGiftCardOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateGiftCardRequest request) throws Exception {
