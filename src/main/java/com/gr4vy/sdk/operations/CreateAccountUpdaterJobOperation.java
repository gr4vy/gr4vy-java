...
public class CreateAccountUpdaterJobOperation implements RequestOperation<CreateAccountUpdaterJobRequest, CreateAccountUpdaterJobResponse> {
    ...
    public CreateAccountUpdaterJobOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateAccountUpdaterJobRequest request) throws Exception {
