...
public class GetMerchantAccountOperation implements RequestOperation<GetMerchantAccountRequest, GetMerchantAccountResponse> {
    ...
    public GetMerchantAccountOperation(
    ...
    public HttpRequest buildRequest(GetMerchantAccountRequest request) throws Exception {
