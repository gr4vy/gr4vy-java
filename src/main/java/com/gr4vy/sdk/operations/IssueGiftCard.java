...
import com.gr4vy.sdk.models.components.GiftCardIssuance;
...
public class IssueGiftCard {
    ...
    public static class Sync extends Base
            implements RequestOperation<IssueGiftCardRequest, IssueGiftCardResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(IssueGiftCardRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<IssueGiftCardRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IssueGiftCardRequest request) {
        ...
        @Override
        public IssueGiftCardResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            IssueGiftCardResponse.Builder resBuilder =
            ...
            IssueGiftCardResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGiftCardIssuance(Utils.unmarshal(response, new TypeReference<GiftCardIssuance>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<IssueGiftCardRequest, com.gr4vy.sdk.models.operations.async.IssueGiftCardResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(IssueGiftCardRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<IssueGiftCardRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(IssueGiftCardRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.IssueGiftCardResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.IssueGiftCardResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.IssueGiftCardResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.IssueGiftCardResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GiftCardIssuance>() {})
                            .thenApply(res::withGiftCardIssuance);
                } else {
