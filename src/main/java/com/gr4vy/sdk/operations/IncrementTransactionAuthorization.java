...
public class IncrementTransactionAuthorization {
    ...
    public static class Sync extends Base
            implements RequestOperation<IncrementTransactionAuthorizationRequest, IncrementTransactionAuthorizationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(IncrementTransactionAuthorizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IncrementTransactionAuthorizationRequest.class, new TypeReference<IncrementTransactionAuthorizationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IncrementTransactionAuthorizationRequest request) {
        ...
        @Override
        public IncrementTransactionAuthorizationResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTransactionAuthorizationIncrement(Utils.unmarshal(response, new TypeReference<TransactionAuthorizationIncrement>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<IncrementTransactionAuthorizationRequest, com.gr4vy.sdk.models.operations.async.IncrementTransactionAuthorizationResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(IncrementTransactionAuthorizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IncrementTransactionAuthorizationRequest.class, new TypeReference<IncrementTransactionAuthorizationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(IncrementTransactionAuthorizationRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.IncrementTransactionAuthorizationResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TransactionAuthorizationIncrement>() {})
