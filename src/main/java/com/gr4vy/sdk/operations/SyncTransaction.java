...
public class SyncTransaction {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SyncTransactionRequest request) {
        ...
        @Override
        public SyncTransactionResponse handleResponse(HttpResponse<InputStream> response) {
