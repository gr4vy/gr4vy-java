...
public class ConfigureDigitalWallet {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ConfigureDigitalWalletRequest request) {
        ...
        @Override
        public ConfigureDigitalWalletResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDigitalWallet(Utils.unmarshal(response, new TypeReference<DigitalWallet>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ConfigureDigitalWalletResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DigitalWallet>() {})
                            .thenApply(res::withDigitalWallet);
                } else {
