...
public class ConfigureDigitalWallet {
    ...
    public static class Sync extends Base
            implements RequestOperation<ConfigureDigitalWalletRequest, ConfigureDigitalWalletResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ConfigureDigitalWalletRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ConfigureDigitalWalletRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ConfigureDigitalWalletRequest request) throws Exception {
        ...
        @Override
        public ConfigureDigitalWalletResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ConfigureDigitalWalletResponse.Builder resBuilder =
            ...
            ConfigureDigitalWalletResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ConfigureDigitalWalletRequest, com.gr4vy.sdk.models.operations.async.ConfigureDigitalWalletResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ConfigureDigitalWalletRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ConfigureDigitalWalletRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ConfigureDigitalWalletRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ConfigureDigitalWalletResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ConfigureDigitalWalletResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ConfigureDigitalWalletResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ConfigureDigitalWalletResponse res = resBuilder.build();
