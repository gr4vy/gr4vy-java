...
public class ListBuyers {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListBuyersRequest, ListBuyersResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListBuyersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListBuyersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListBuyersRequest request) throws Exception {
        ...
        @Override
        public ListBuyersResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListBuyersResponse.Builder resBuilder =
                    ListBuyersResponse
                            .builder()
            ...
            ListBuyersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Buyers out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withBuyers(out);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListBuyersRequest, com.gr4vy.sdk.models.operations.async.ListBuyersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListBuyersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListBuyersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListBuyersRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListBuyersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListBuyersResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListBuyersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListBuyersResponse res = resBuilder.build();
