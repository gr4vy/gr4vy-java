...
public class CompletePazeMobileSession {
    ...
    public static class Sync extends Base
            implements RequestOperation<CompletePazeMobileSessionRequest, CompletePazeMobileSessionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CompletePazeMobileSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CompletePazeMobileSessionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CompletePazeMobileSessionRequest request) {
        ...
        @Override
        public CompletePazeMobileSessionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CompletePazeMobileSessionResponse.Builder resBuilder =
            ...
            CompletePazeMobileSessionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPazeSessionComplete(Utils.unmarshal(response, new TypeReference<PazeSessionComplete>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CompletePazeMobileSessionRequest, com.gr4vy.sdk.models.operations.async.CompletePazeMobileSessionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CompletePazeMobileSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CompletePazeMobileSessionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CompletePazeMobileSessionRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CompletePazeMobileSessionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.CompletePazeMobileSessionResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.CompletePazeMobileSessionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.CompletePazeMobileSessionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PazeSessionComplete>() {})
                            .thenApply(res::withPazeSessionComplete);
                } else {
