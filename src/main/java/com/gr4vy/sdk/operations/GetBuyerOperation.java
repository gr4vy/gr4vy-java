...
public class GetBuyerOperation implements RequestOperation<GetBuyerRequest, GetBuyerResponse> {
    ...
    public HttpRequest buildRequest(GetBuyerRequest request) throws Exception {
