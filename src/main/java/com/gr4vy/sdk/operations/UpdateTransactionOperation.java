...
public class UpdateTransactionOperation implements RequestOperation<UpdateTransactionRequest, UpdateTransactionResponse> {
    ...
    public UpdateTransactionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateTransactionRequest request) throws Exception {
