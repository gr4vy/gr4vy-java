...
public class CreateTransactionRefund {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateTransactionRefundRequest, CreateTransactionRefundResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateTransactionRefundRequest request) throws Exception {
        ...
        @Override
        public CreateTransactionRefundResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateTransactionRefundResponse.Builder resBuilder =
            ...
            CreateTransactionRefundResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Refund out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withRefund(out);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateTransactionRefundRequest, com.gr4vy.sdk.models.operations.async.CreateTransactionRefundResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateTransactionRefundRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTransactionRefundRequest.class, new TypeReference<CreateTransactionRefundRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateTransactionRefundRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CreateTransactionRefundResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.CreateTransactionRefundResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.CreateTransactionRefundResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.CreateTransactionRefundResponse res = resBuilder.build();
