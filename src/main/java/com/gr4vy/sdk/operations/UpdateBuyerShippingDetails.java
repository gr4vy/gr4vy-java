...
public class UpdateBuyerShippingDetails {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateBuyerShippingDetailsRequest request) {
        ...
        @Override
        public UpdateBuyerShippingDetailsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withShippingDetails(Utils.unmarshal(response, new TypeReference<ShippingDetails>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.UpdateBuyerShippingDetailsResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ShippingDetails>() {})
                            .thenApply(res::withShippingDetails);
                } else {
