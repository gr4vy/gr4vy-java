...
public class UpdateBuyerShippingDetails {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateBuyerShippingDetailsRequest, UpdateBuyerShippingDetailsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateBuyerShippingDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateBuyerShippingDetailsRequest.class, new TypeReference<UpdateBuyerShippingDetailsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateBuyerShippingDetailsRequest request) throws Exception {
        ...
        @Override
        public UpdateBuyerShippingDetailsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateBuyerShippingDetailsResponse.Builder resBuilder =
            ...
            UpdateBuyerShippingDetailsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ShippingDetails out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withShippingDetails(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateBuyerShippingDetailsRequest, com.gr4vy.sdk.models.operations.async.UpdateBuyerShippingDetailsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateBuyerShippingDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateBuyerShippingDetailsRequest.class, new TypeReference<UpdateBuyerShippingDetailsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateBuyerShippingDetailsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.UpdateBuyerShippingDetailsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.UpdateBuyerShippingDetailsResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.UpdateBuyerShippingDetailsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.UpdateBuyerShippingDetailsResponse res = resBuilder.build();
