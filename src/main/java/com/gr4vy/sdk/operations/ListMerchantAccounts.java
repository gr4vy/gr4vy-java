...
public class ListMerchantAccounts {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMerchantAccountsRequest, ListMerchantAccountsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListMerchantAccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMerchantAccountsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMerchantAccountsRequest request) throws Exception {
        ...
        @Override
        public ListMerchantAccountsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListMerchantAccountsResponse.Builder resBuilder =
            ...
            ListMerchantAccountsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    MerchantAccounts out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMerchantAccounts(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListMerchantAccountsRequest, com.gr4vy.sdk.models.operations.async.ListMerchantAccountsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListMerchantAccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMerchantAccountsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMerchantAccountsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListMerchantAccountsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListMerchantAccountsResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListMerchantAccountsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListMerchantAccountsResponse res = resBuilder.build();
