...
public class AddPaymentLinkOperation implements RequestOperation<AddPaymentLinkRequest, AddPaymentLinkResponse> {
    ...
    public AddPaymentLinkOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(AddPaymentLinkRequest request) throws Exception {
