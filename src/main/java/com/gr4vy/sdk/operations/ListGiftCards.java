...
public class ListGiftCards {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListGiftCardsRequest, ListGiftCardsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListGiftCardsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListGiftCardsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListGiftCardsRequest request) throws Exception {
        ...
        @Override
        public ListGiftCardsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListGiftCardsResponse.Builder resBuilder =
            ...
            ListGiftCardsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GiftCards out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGiftCards(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListGiftCardsRequest, com.gr4vy.sdk.models.operations.async.ListGiftCardsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListGiftCardsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListGiftCardsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListGiftCardsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListGiftCardsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListGiftCardsResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListGiftCardsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListGiftCardsResponse res = resBuilder.build();
