...
public class ListTransactionCaptures {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTransactionCapturesRequest, ListTransactionCapturesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListTransactionCapturesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTransactionCapturesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTransactionCapturesRequest request) {
        ...
        @Override
        public ListTransactionCapturesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListTransactionCapturesResponse.Builder resBuilder =
                    ListTransactionCapturesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ListTransactionCapturesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCaptureCollection(Utils.unmarshal(response, new TypeReference<CaptureCollection>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTransactionCapturesRequest, com.gr4vy.sdk.models.operations.async.ListTransactionCapturesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListTransactionCapturesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTransactionCapturesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTransactionCapturesRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListTransactionCapturesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListTransactionCapturesResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListTransactionCapturesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListTransactionCapturesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CaptureCollection>() {})
                            .thenApply(res::withCaptureCollection);
                } else {
