...
public class ListMerchantAccountsOperation implements RequestOperation<ListMerchantAccountsRequest, ListMerchantAccountsResponse> {
    ...
    public ListMerchantAccountsOperation(
    ...
    public HttpRequest buildRequest(ListMerchantAccountsRequest request) throws Exception {
