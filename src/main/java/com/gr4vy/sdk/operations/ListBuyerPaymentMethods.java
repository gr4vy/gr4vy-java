...
public class ListBuyerPaymentMethods {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListBuyerPaymentMethodsRequest request) {
        ...
        @Override
        public ListBuyerPaymentMethodsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaymentMethodSummaries(Utils.unmarshal(response, new TypeReference<PaymentMethodSummaries>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListBuyerPaymentMethodsResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaymentMethodSummaries>() {})
                            .thenApply(res::withPaymentMethodSummaries);
                } else {
