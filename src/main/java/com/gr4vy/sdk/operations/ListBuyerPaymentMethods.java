...
public class ListBuyerPaymentMethods {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListBuyerPaymentMethodsRequest, ListBuyerPaymentMethodsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListBuyerPaymentMethodsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListBuyerPaymentMethodsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListBuyerPaymentMethodsRequest request) throws Exception {
        ...
        @Override
        public ListBuyerPaymentMethodsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListBuyerPaymentMethodsResponse.Builder resBuilder =
            ...
            ListBuyerPaymentMethodsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PaymentMethodSummaries out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPaymentMethodSummaries(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListBuyerPaymentMethodsRequest, com.gr4vy.sdk.models.operations.async.ListBuyerPaymentMethodsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListBuyerPaymentMethodsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListBuyerPaymentMethodsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListBuyerPaymentMethodsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListBuyerPaymentMethodsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListBuyerPaymentMethodsResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListBuyerPaymentMethodsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListBuyerPaymentMethodsResponse res = resBuilder.build();
