...
public class UnregisterDigitalWalletDomain {
    ...
    public static class Sync extends Base
            implements RequestOperation<UnregisterDigitalWalletDomainRequest, UnregisterDigitalWalletDomainResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(UnregisterDigitalWalletDomainRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UnregisterDigitalWalletDomainRequest.class, new TypeReference<UnregisterDigitalWalletDomainRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UnregisterDigitalWalletDomainRequest request) throws Exception {
        ...
        @Override
        public UnregisterDigitalWalletDomainResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UnregisterDigitalWalletDomainResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UnregisterDigitalWalletDomainRequest, com.gr4vy.sdk.models.operations.async.UnregisterDigitalWalletDomainResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UnregisterDigitalWalletDomainRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UnregisterDigitalWalletDomainRequest.class, new TypeReference<UnregisterDigitalWalletDomainRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UnregisterDigitalWalletDomainRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.UnregisterDigitalWalletDomainResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.UnregisterDigitalWalletDomainResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.UnregisterDigitalWalletDomainResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
