...
public class ListBuyerGiftCardsOperation implements RequestOperation<ListBuyerGiftCardsRequest, ListBuyerGiftCardsResponse> {
    ...
    public ListBuyerGiftCardsOperation(
    ...
    public HttpRequest buildRequest(ListBuyerGiftCardsRequest request) throws Exception {
