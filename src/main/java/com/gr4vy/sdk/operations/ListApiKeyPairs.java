...
public class ListApiKeyPairs {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListApiKeyPairsRequest, ListApiKeyPairsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListApiKeyPairsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListApiKeyPairsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListApiKeyPairsRequest request) {
        ...
        @Override
        public ListApiKeyPairsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListApiKeyPairsResponse.Builder resBuilder =
            ...
            ListApiKeyPairsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCollectionAPIKeyPair(Utils.unmarshal(response, new TypeReference<CollectionAPIKeyPair>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListApiKeyPairsRequest, com.gr4vy.sdk.models.operations.async.ListApiKeyPairsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListApiKeyPairsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListApiKeyPairsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListApiKeyPairsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListApiKeyPairsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListApiKeyPairsResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListApiKeyPairsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListApiKeyPairsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CollectionAPIKeyPair>() {})
                            .thenApply(res::withCollectionAPIKeyPair);
                } else {
