...
public class GetPaymentLink {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPaymentLinkRequest, com.gr4vy.sdk.models.operations.async.GetPaymentLinkResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetPaymentLinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentLinkRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPaymentLinkRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.GetPaymentLinkResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.GetPaymentLinkResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.GetPaymentLinkResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.GetPaymentLinkResponse res = resBuilder.build();
