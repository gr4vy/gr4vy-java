...
public class GetBuyerShippingDetails {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetBuyerShippingDetailsRequest, GetBuyerShippingDetailsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetBuyerShippingDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBuyerShippingDetailsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBuyerShippingDetailsRequest request) throws Exception {
        ...
        @Override
        public GetBuyerShippingDetailsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetBuyerShippingDetailsResponse.Builder resBuilder =
            ...
            GetBuyerShippingDetailsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetBuyerShippingDetailsRequest, com.gr4vy.sdk.models.operations.async.GetBuyerShippingDetailsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetBuyerShippingDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBuyerShippingDetailsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetBuyerShippingDetailsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.GetBuyerShippingDetailsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.GetBuyerShippingDetailsResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.GetBuyerShippingDetailsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.GetBuyerShippingDetailsResponse res = resBuilder.build();
