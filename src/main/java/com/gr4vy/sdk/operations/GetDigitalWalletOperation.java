...
public class GetDigitalWalletOperation implements RequestOperation<GetDigitalWalletRequest, GetDigitalWalletResponse> {
    ...
    public GetDigitalWalletOperation(
    ...
    public HttpRequest buildRequest(GetDigitalWalletRequest request) throws Exception {
