...
public class ResumePaymentMethodNetworkTokenOperation implements RequestOperation<ResumePaymentMethodNetworkTokenRequest, ResumePaymentMethodNetworkTokenResponse> {
    ...
    public ResumePaymentMethodNetworkTokenOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ResumePaymentMethodNetworkTokenRequest request) throws Exception {
