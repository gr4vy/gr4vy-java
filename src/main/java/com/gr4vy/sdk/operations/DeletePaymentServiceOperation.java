...
public class DeletePaymentServiceOperation implements RequestOperation<DeletePaymentServiceRequest, DeletePaymentServiceResponse> {
    ...
    public DeletePaymentServiceOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(DeletePaymentServiceRequest request) throws Exception {
