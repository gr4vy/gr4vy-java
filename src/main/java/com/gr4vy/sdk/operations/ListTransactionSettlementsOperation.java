...
public class ListTransactionSettlementsOperation implements RequestOperation<ListTransactionSettlementsRequest, ListTransactionSettlementsResponse> {
    ...
    public ListTransactionSettlementsOperation(
    ...
    public HttpRequest buildRequest(ListTransactionSettlementsRequest request) throws Exception {
