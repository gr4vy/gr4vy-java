...
public class GetRefund {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRefundRequest, com.gr4vy.sdk.models.operations.async.GetRefundResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetRefundRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRefundRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRefundRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.GetRefundResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.GetRefundResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.GetRefundResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.GetRefundResponse res = resBuilder.build();
