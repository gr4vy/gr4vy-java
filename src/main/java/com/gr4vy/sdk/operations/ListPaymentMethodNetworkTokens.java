...
public class ListPaymentMethodNetworkTokens {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPaymentMethodNetworkTokensRequest, ListPaymentMethodNetworkTokensResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListPaymentMethodNetworkTokensRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentMethodNetworkTokensRequest.class);
        ...
        @Override
        public ListPaymentMethodNetworkTokensResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPaymentMethodNetworkTokensResponse.Builder resBuilder =
            ...
            ListPaymentMethodNetworkTokensResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    NetworkTokens out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withNetworkTokens(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPaymentMethodNetworkTokensRequest, com.gr4vy.sdk.models.operations.async.ListPaymentMethodNetworkTokensResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListPaymentMethodNetworkTokensRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentMethodNetworkTokensRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPaymentMethodNetworkTokensRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListPaymentMethodNetworkTokensResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListPaymentMethodNetworkTokensResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListPaymentMethodNetworkTokensResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListPaymentMethodNetworkTokensResponse res = resBuilder.build();
