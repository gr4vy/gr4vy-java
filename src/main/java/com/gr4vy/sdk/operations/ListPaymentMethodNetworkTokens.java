...
public class ListPaymentMethodNetworkTokens {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPaymentMethodNetworkTokensRequest request) {
        ...
        @Override
        public ListPaymentMethodNetworkTokensResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withNetworkTokens(Utils.unmarshal(response, new TypeReference<NetworkTokens>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListPaymentMethodNetworkTokensResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<NetworkTokens>() {})
                            .thenApply(res::withNetworkTokens);
                } else {
