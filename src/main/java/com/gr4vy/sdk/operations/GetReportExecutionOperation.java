...
public class GetReportExecutionOperation implements RequestOperation<GetReportExecutionRequest, GetReportExecutionResponse> {
    ...
    public GetReportExecutionOperation(
    ...
    public HttpRequest buildRequest(GetReportExecutionRequest request) throws Exception {
