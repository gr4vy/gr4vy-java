...
public class DeleteGiftCardOperation implements RequestOperation<DeleteGiftCardRequest, DeleteGiftCardResponse> {
    ...
    public DeleteGiftCardOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(DeleteGiftCardRequest request) throws Exception {
