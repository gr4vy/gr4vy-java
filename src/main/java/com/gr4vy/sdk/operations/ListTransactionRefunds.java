...
public class ListTransactionRefunds {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTransactionRefundsRequest, ListTransactionRefundsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(ListTransactionRefundsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTransactionRefundsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTransactionRefundsRequest request) throws Exception {
        ...
        @Override
        public ListTransactionRefundsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListTransactionRefundsResponse.Builder resBuilder =
            ...
            ListTransactionRefundsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTransactionRefundsRequest, com.gr4vy.sdk.models.operations.async.ListTransactionRefundsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListTransactionRefundsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTransactionRefundsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTransactionRefundsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListTransactionRefundsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListTransactionRefundsResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListTransactionRefundsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListTransactionRefundsResponse res = resBuilder.build();
