...
public class ListPaymentServiceDefinitions {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPaymentServiceDefinitionsRequest, ListPaymentServiceDefinitionsResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPaymentServiceDefinitionsRequest request) throws Exception {
        ...
        @Override
        public ListPaymentServiceDefinitionsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPaymentServiceDefinitionsResponse.Builder resBuilder =
            ...
            ListPaymentServiceDefinitionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PaymentServiceDefinitions out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPaymentServiceDefinitions(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPaymentServiceDefinitionsRequest, com.gr4vy.sdk.models.operations.async.ListPaymentServiceDefinitionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListPaymentServiceDefinitionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentServiceDefinitionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPaymentServiceDefinitionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListPaymentServiceDefinitionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListPaymentServiceDefinitionsResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListPaymentServiceDefinitionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListPaymentServiceDefinitionsResponse res = resBuilder.build();
