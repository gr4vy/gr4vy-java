...
public class ListPaymentServiceDefinitions {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPaymentServiceDefinitionsRequest request) {
        ...
        @Override
        public ListPaymentServiceDefinitionsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaymentServiceDefinitions(Utils.unmarshal(response, new TypeReference<PaymentServiceDefinitions>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListPaymentServiceDefinitionsResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaymentServiceDefinitions>() {})
                            .thenApply(res::withPaymentServiceDefinitions);
                } else {
