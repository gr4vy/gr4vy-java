...
public class ListGiftCardBalancesOperation implements RequestOperation<ListGiftCardBalancesRequest, ListGiftCardBalancesResponse> {
    ...
    public ListGiftCardBalancesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListGiftCardBalancesRequest request) throws Exception {
