...
public class DeleteBuyer {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteBuyerRequest, DeleteBuyerResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteBuyerRequest request) throws Exception {
        ...
        @Override
        public DeleteBuyerResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteBuyerResponse.Builder resBuilder =
                    DeleteBuyerResponse
                            .builder()
            ...
            DeleteBuyerResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteBuyerRequest, com.gr4vy.sdk.models.operations.async.DeleteBuyerResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteBuyerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteBuyerRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteBuyerRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.DeleteBuyerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.DeleteBuyerResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.DeleteBuyerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.DeleteBuyerResponse res = resBuilder.build();
