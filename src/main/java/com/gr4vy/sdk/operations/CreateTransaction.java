...
public class CreateTransaction {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(CreateTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateTransactionRequest>() {});
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateTransactionRequest, com.gr4vy.sdk.models.operations.async.CreateTransactionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateTransactionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateTransactionRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CreateTransactionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.CreateTransactionResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.CreateTransactionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.CreateTransactionResponse res = resBuilder.build();
