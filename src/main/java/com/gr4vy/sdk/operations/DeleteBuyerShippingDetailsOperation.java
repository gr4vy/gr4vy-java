...
public class DeleteBuyerShippingDetailsOperation implements RequestOperation<DeleteBuyerShippingDetailsRequest, DeleteBuyerShippingDetailsResponse> {
    ...
    public DeleteBuyerShippingDetailsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(DeleteBuyerShippingDetailsRequest request) throws Exception {
