...
public class CreateCheckoutSessionOperation implements RequestOperation<CreateCheckoutSessionRequest, CreateCheckoutSessionResponse> {
    ...
    public CreateCheckoutSessionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateCheckoutSessionRequest request) throws Exception {
