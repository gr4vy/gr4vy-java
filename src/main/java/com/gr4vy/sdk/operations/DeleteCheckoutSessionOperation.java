...
public class DeleteCheckoutSessionOperation implements RequestOperation<DeleteCheckoutSessionRequest, DeleteCheckoutSessionResponse> {
    ...
    public DeleteCheckoutSessionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(DeleteCheckoutSessionRequest request) throws Exception {
