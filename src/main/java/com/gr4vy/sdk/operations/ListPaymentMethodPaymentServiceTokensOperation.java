...
public class ListPaymentMethodPaymentServiceTokensOperation implements RequestOperation<ListPaymentMethodPaymentServiceTokensRequest, ListPaymentMethodPaymentServiceTokensResponse> {
    ...
    public ListPaymentMethodPaymentServiceTokensOperation(
    ...
    public HttpRequest buildRequest(ListPaymentMethodPaymentServiceTokensRequest request) throws Exception {
