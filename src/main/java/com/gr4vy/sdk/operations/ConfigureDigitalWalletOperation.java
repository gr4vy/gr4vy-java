...
public class ConfigureDigitalWalletOperation implements RequestOperation<ConfigureDigitalWalletRequest, ConfigureDigitalWalletResponse> {
    ...
    public ConfigureDigitalWalletOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ConfigureDigitalWalletRequest request) throws Exception {
