...
public class GetReport {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetReportRequest, GetReportResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetReportRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetReportRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetReportRequest request) throws Exception {
        ...
        @Override
        public GetReportResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetReportResponse.Builder resBuilder =
                    GetReportResponse
                            .builder()
            ...
            GetReportResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetReportRequest, com.gr4vy.sdk.models.operations.async.GetReportResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetReportRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetReportRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetReportRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.GetReportResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.GetReportResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.GetReportResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.GetReportResponse res = resBuilder.build();
