...
public class CreatePaymentMethodNetworkToken {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreatePaymentMethodNetworkTokenRequest, CreatePaymentMethodNetworkTokenResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreatePaymentMethodNetworkTokenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePaymentMethodNetworkTokenRequest.class, new TypeReference<CreatePaymentMethodNetworkTokenRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreatePaymentMethodNetworkTokenRequest request) throws Exception {
        ...
        @Override
        public CreatePaymentMethodNetworkTokenResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreatePaymentMethodNetworkTokenResponse.Builder resBuilder =
            ...
            CreatePaymentMethodNetworkTokenResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreatePaymentMethodNetworkTokenRequest, com.gr4vy.sdk.models.operations.async.CreatePaymentMethodNetworkTokenResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreatePaymentMethodNetworkTokenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePaymentMethodNetworkTokenRequest.class, new TypeReference<CreatePaymentMethodNetworkTokenRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreatePaymentMethodNetworkTokenRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CreatePaymentMethodNetworkTokenResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.CreatePaymentMethodNetworkTokenResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.CreatePaymentMethodNetworkTokenResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.CreatePaymentMethodNetworkTokenResponse res = resBuilder.build();
