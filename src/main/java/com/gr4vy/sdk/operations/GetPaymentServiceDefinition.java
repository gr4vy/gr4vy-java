...
public class GetPaymentServiceDefinition {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPaymentServiceDefinitionRequest request) {
        ...
        @Override
        public GetPaymentServiceDefinitionResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaymentServiceDefinition(Utils.unmarshal(response, new TypeReference<PaymentServiceDefinition>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.GetPaymentServiceDefinitionResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaymentServiceDefinition>() {})
                            .thenApply(res::withPaymentServiceDefinition);
                } else {
