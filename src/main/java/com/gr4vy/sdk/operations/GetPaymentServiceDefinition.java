...
public class GetPaymentServiceDefinition {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPaymentServiceDefinitionRequest, GetPaymentServiceDefinitionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetPaymentServiceDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentServiceDefinitionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPaymentServiceDefinitionRequest request) throws Exception {
        ...
        @Override
        public GetPaymentServiceDefinitionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPaymentServiceDefinitionResponse.Builder resBuilder =
            ...
            GetPaymentServiceDefinitionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PaymentServiceDefinition out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPaymentServiceDefinition(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPaymentServiceDefinitionRequest, com.gr4vy.sdk.models.operations.async.GetPaymentServiceDefinitionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetPaymentServiceDefinitionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentServiceDefinitionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPaymentServiceDefinitionRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.GetPaymentServiceDefinitionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.GetPaymentServiceDefinitionResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.GetPaymentServiceDefinitionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.GetPaymentServiceDefinitionResponse res = resBuilder.build();
