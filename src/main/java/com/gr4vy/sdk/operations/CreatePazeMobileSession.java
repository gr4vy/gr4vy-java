...
public class CreatePazeMobileSession {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreatePazeMobileSessionRequest, CreatePazeMobileSessionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreatePazeMobileSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreatePazeMobileSessionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreatePazeMobileSessionRequest request) {
        ...
        @Override
        public CreatePazeMobileSessionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreatePazeMobileSessionResponse.Builder resBuilder =
            ...
            CreatePazeMobileSessionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPazeMobileSessionCreate(Utils.unmarshal(response, new TypeReference<PazeMobileSessionCreate>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreatePazeMobileSessionRequest, com.gr4vy.sdk.models.operations.async.CreatePazeMobileSessionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreatePazeMobileSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreatePazeMobileSessionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreatePazeMobileSessionRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CreatePazeMobileSessionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.CreatePazeMobileSessionResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.CreatePazeMobileSessionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.CreatePazeMobileSessionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PazeMobileSessionCreate>() {})
                            .thenApply(res::withPazeMobileSessionCreate);
                } else {
