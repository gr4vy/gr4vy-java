...
public class ListPaymentServices {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPaymentServicesRequest, ListPaymentServicesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListPaymentServicesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentServicesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPaymentServicesRequest request) throws Exception {
        ...
        @Override
        public ListPaymentServicesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPaymentServicesResponse.Builder resBuilder =
            ...
            ListPaymentServicesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PaymentServices out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPaymentServices(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPaymentServicesRequest, com.gr4vy.sdk.models.operations.async.ListPaymentServicesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListPaymentServicesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentServicesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPaymentServicesRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListPaymentServicesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.ListPaymentServicesResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.ListPaymentServicesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.ListPaymentServicesResponse res = resBuilder.build();
