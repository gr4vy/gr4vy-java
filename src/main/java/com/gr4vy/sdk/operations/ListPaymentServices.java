...
public class ListPaymentServices {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPaymentServicesRequest request) {
        ...
        @Override
        public ListPaymentServicesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaymentServices(Utils.unmarshal(response, new TypeReference<PaymentServices>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListPaymentServicesResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaymentServices>() {})
                            .thenApply(res::withPaymentServices);
                } else {
