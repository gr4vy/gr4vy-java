...
public class GetPaymentService {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPaymentServiceRequest, GetPaymentServiceResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public GetPaymentServiceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPaymentServiceResponse.Builder resBuilder =
            ...
            GetPaymentServiceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPaymentServiceRequest, com.gr4vy.sdk.models.operations.async.GetPaymentServiceResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetPaymentServiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentServiceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPaymentServiceRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.GetPaymentServiceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.GetPaymentServiceResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.GetPaymentServiceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.GetPaymentServiceResponse res = resBuilder.build();
