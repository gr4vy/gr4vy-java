...
public class DeletePaymentMethodNetworkToken {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeletePaymentMethodNetworkTokenRequest, DeletePaymentMethodNetworkTokenResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeletePaymentMethodNetworkTokenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletePaymentMethodNetworkTokenRequest.class);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeletePaymentMethodNetworkTokenRequest, com.gr4vy.sdk.models.operations.async.DeletePaymentMethodNetworkTokenResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeletePaymentMethodNetworkTokenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletePaymentMethodNetworkTokenRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeletePaymentMethodNetworkTokenRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.DeletePaymentMethodNetworkTokenResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.DeletePaymentMethodNetworkTokenResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.DeletePaymentMethodNetworkTokenResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.DeletePaymentMethodNetworkTokenResponse res = resBuilder.build();
