...
public class ListRoles {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListRolesRequest, ListRolesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRolesRequest request) {
        ...
        @Override
        public ListRolesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCollectionRole(Utils.unmarshal(response, new TypeReference<CollectionRole>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListRolesRequest, com.gr4vy.sdk.models.operations.async.ListRolesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListRolesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRolesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListRolesRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.ListRolesResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CollectionRole>() {})
