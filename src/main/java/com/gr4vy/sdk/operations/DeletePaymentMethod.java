...
public class DeletePaymentMethod {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeletePaymentMethodRequest, DeletePaymentMethodResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeletePaymentMethodRequest request) throws Exception {
        ...
        @Override
        public DeletePaymentMethodResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeletePaymentMethodResponse.Builder resBuilder =
            ...
            DeletePaymentMethodResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeletePaymentMethodRequest, com.gr4vy.sdk.models.operations.async.DeletePaymentMethodResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeletePaymentMethodRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletePaymentMethodRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeletePaymentMethodRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.DeletePaymentMethodResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.DeletePaymentMethodResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.DeletePaymentMethodResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.DeletePaymentMethodResponse res = resBuilder.build();
