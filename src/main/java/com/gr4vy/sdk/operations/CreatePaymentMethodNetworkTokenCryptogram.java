...
public class CreatePaymentMethodNetworkTokenCryptogram {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreatePaymentMethodNetworkTokenCryptogramRequest, CreatePaymentMethodNetworkTokenCryptogramResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreatePaymentMethodNetworkTokenCryptogramRequest request) throws Exception {
        ...
        @Override
        public CreatePaymentMethodNetworkTokenCryptogramResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreatePaymentMethodNetworkTokenCryptogramResponse.Builder resBuilder =
            ...
            CreatePaymentMethodNetworkTokenCryptogramResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Cryptogram out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCryptogram(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreatePaymentMethodNetworkTokenCryptogramRequest, com.gr4vy.sdk.models.operations.async.CreatePaymentMethodNetworkTokenCryptogramResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreatePaymentMethodNetworkTokenCryptogramRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePaymentMethodNetworkTokenCryptogramRequest.class, new TypeReference<CreatePaymentMethodNetworkTokenCryptogramRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreatePaymentMethodNetworkTokenCryptogramRequest request) {
        ...
        @Override
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CreatePaymentMethodNetworkTokenCryptogramResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gr4vy.sdk.models.operations.async.CreatePaymentMethodNetworkTokenCryptogramResponse.Builder resBuilder =
                    com.gr4vy.sdk.models.operations.async.CreatePaymentMethodNetworkTokenCryptogramResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gr4vy.sdk.models.operations.async.CreatePaymentMethodNetworkTokenCryptogramResponse res = resBuilder.build();
