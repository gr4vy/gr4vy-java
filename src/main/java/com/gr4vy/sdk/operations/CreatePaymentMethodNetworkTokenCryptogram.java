...
public class CreatePaymentMethodNetworkTokenCryptogram {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreatePaymentMethodNetworkTokenCryptogramRequest request) {
        ...
        @Override
        public CreatePaymentMethodNetworkTokenCryptogramResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCryptogram(Utils.unmarshal(response, new TypeReference<Cryptogram>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gr4vy.sdk.models.operations.async.CreatePaymentMethodNetworkTokenCryptogramResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Cryptogram>() {})
                            .thenApply(res::withCryptogram);
                } else {
