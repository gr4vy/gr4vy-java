...
public class CollectionBuyer {
    ...
    @JsonCreator
    public CollectionBuyer(
            @JsonProperty("items") List<Buyer> items,
     ...
     * A list of items returned for this request.
     */
    public CollectionBuyer withItems(List<Buyer> items) {
        Utils.checkNotNull(items, "items");
        this.items = items;
        return this;
    }
     ...
     * The number of items for this page.
     */
    public CollectionBuyer withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * The number of items for this page.
     */
    public CollectionBuyer withLimit(Optional<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * The cursor pointing at the next page of items.
     */
    public CollectionBuyer withNextCursor(String nextCursor) {
        Utils.checkNotNull(nextCursor, "nextCursor");
     ...
     * The cursor pointing at the next page of items.
     */
    public CollectionBuyer withNextCursor(JsonNullable<String> nextCursor) {
        Utils.checkNotNull(nextCursor, "nextCursor");
        this.nextCursor = nextCursor;
        return this;
    }
     ...
     * The cursor pointing at the previous page of items.
     */
    public CollectionBuyer withPreviousCursor(String previousCursor) {
        Utils.checkNotNull(previousCursor, "previousCursor");
     ...
     * The cursor pointing at the previous page of items.
     */
    public CollectionBuyer withPreviousCursor(JsonNullable<String> previousCursor) {
        Utils.checkNotNull(previousCursor, "previousCursor");
        this.previousCursor = previousCursor;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CollectionBuyer other = (CollectionBuyer) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CollectionBuyer.class,
                "items", items,
                "limit", limit,
    ...
    public final static class Builder {
         ...
         * A list of items returned for this request.
         */
        public Builder items(List<Buyer> items) {
            Utils.checkNotNull(items, "items");
            this.items = items;
            return this;
        }
        ...
        public CollectionBuyer build() {
            if (limit == null) {
                limit = _SINGLETON_VALUE_Limit.value();
            }
            return new CollectionBuyer(
                items,
                limit,
                nextCursor,
                previousCursor);
