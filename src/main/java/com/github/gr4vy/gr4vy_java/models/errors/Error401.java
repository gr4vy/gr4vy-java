...
public class Error401 extends RuntimeException {
     ...
     * Always `unauthorized`
     */
    public Error401 withCode(String code) {
        Utils.checkNotNull(code, "code");
     ...
     * Always `unauthorized`
     */
    public Error401 withCode(Optional<String> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
     ...
     * Always `401`.
     */
    public Error401 withStatus(long status) {
        Utils.checkNotNull(status, "status");
     ...
     * Always `401`.
     */
    public Error401 withStatus(Optional<Long> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * A human readable message that provides more context to the error.
     */
    public Error401 withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * A list of details that further ellaborate on the error.
     */
    public Error401 withDetails(List<ErrorDetail> details) {
        Utils.checkNotNull(details, "details");
     ...
     * A list of details that further ellaborate on the error.
     */
    public Error401 withDetails(Optional<? extends List<ErrorDetail>> details) {
        Utils.checkNotNull(details, "details");
        this.details = details;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public Error401 withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public Error401 withRawResponse(Optional<? extends HttpResponse<InputStream>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
