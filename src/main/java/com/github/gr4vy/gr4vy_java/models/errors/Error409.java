...
public class Error409 extends RuntimeException {
     ...
     * Always `duplicate_record`
     */
    public Error409 withCode(String code) {
        Utils.checkNotNull(code, "code");
     ...
     * Always `duplicate_record`
     */
    public Error409 withCode(Optional<String> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
     ...
     * Always `409`.
     */
    public Error409 withStatus(long status) {
        Utils.checkNotNull(status, "status");
     ...
     * Always `409`.
     */
    public Error409 withStatus(Optional<Long> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * A human readable message that provides more context to the error.
     */
    public Error409 withMessage(String message) {
        Utils.checkNotNull(message, "message");
     ...
     * A human readable message that provides more context to the error.
     */
    public Error409 withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * A list of details that further ellaborate on the error.
     */
    public Error409 withDetails(List<ErrorDetail> details) {
        Utils.checkNotNull(details, "details");
     ...
     * A list of details that further ellaborate on the error.
     */
    public Error409 withDetails(Optional<? extends List<ErrorDetail>> details) {
        Utils.checkNotNull(details, "details");
        this.details = details;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public Error409 withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public Error409 withRawResponse(Optional<? extends HttpResponse<InputStream>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Error409.class,
                "type", type,
                "code", code,
                "status", status,
                "message", message,
