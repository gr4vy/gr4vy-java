...
public class Error403 extends RuntimeException {
     ...
     * Always `forbidden`
     */
    public Error403 withCode(String code) {
        Utils.checkNotNull(code, "code");
     ...
     * Always `forbidden`
     */
    public Error403 withCode(Optional<String> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
     ...
     * Always `403`.
     */
    public Error403 withStatus(long status) {
        Utils.checkNotNull(status, "status");
     ...
     * Always `403`.
     */
    public Error403 withStatus(Optional<Long> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * A human readable message that provides more context to the error.
     */
    public Error403 withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * A list of details that further ellaborate on the error.
     */
    public Error403 withDetails(List<ErrorDetail> details) {
        Utils.checkNotNull(details, "details");
     ...
     * A list of details that further ellaborate on the error.
     */
    public Error403 withDetails(Optional<? extends List<ErrorDetail>> details) {
        Utils.checkNotNull(details, "details");
        this.details = details;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public Error403 withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public Error403 withRawResponse(Optional<? extends HttpResponse<InputStream>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
