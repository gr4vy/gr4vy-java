...
public class CollectionMerchantAccount {
    ...
    @JsonCreator
    public CollectionMerchantAccount(
     ...
     * A list of items returned for this request.
     */
    public CollectionMerchantAccount withItems(List<MerchantAccount> items) {
        Utils.checkNotNull(items, "items");
        this.items = items;
        return this;
    }
     ...
     * The number of items for this page.
     */
    public CollectionMerchantAccount withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * The number of items for this page.
     */
    public CollectionMerchantAccount withLimit(Optional<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * The cursor pointing at the next page of items.
     */
    public CollectionMerchantAccount withNextCursor(String nextCursor) {
        Utils.checkNotNull(nextCursor, "nextCursor");
     ...
     * The cursor pointing at the next page of items.
     */
    public CollectionMerchantAccount withNextCursor(JsonNullable<String> nextCursor) {
        Utils.checkNotNull(nextCursor, "nextCursor");
        this.nextCursor = nextCursor;
        return this;
    }
     ...
     * The cursor pointing at the previous page of items.
     */
    public CollectionMerchantAccount withPreviousCursor(String previousCursor) {
        Utils.checkNotNull(previousCursor, "previousCursor");
     ...
     * The cursor pointing at the previous page of items.
     */
    public CollectionMerchantAccount withPreviousCursor(JsonNullable<String> previousCursor) {
        Utils.checkNotNull(previousCursor, "previousCursor");
        this.previousCursor = previousCursor;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CollectionMerchantAccount other = (CollectionMerchantAccount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CollectionMerchantAccount.class,
                "items", items,
                "limit", limit,
    ...
    public final static class Builder {
        ...
        public CollectionMerchantAccount build() {
            if (limit == null) {
                limit = _SINGLETON_VALUE_Limit.value();
            }
            return new CollectionMerchantAccount(
                items,
                limit,
                nextCursor,
                previousCursor);
