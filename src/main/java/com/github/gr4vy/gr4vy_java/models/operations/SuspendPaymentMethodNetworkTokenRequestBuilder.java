...
public class SuspendPaymentMethodNetworkTokenRequestBuilder {
    ...
    public SuspendPaymentMethodNetworkTokenRequestBuilder xGr4vyMerchantAccountId(String xGr4vyMerchantAccountId) {
    ...
    public SuspendPaymentMethodNetworkTokenRequestBuilder xGr4vyMerchantAccountId(JsonNullable<String> xGr4vyMerchantAccountId) {
        Utils.checkNotNull(xGr4vyMerchantAccountId, "xGr4vyMerchantAccountId");
