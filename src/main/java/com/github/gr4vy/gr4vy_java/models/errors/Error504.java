...
public class Error504 extends RuntimeException {
     ...
     * Always `gateway_timeout`
     */
    public Error504 withCode(String code) {
        Utils.checkNotNull(code, "code");
     ...
     * Always `gateway_timeout`
     */
    public Error504 withCode(Optional<String> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }

    public Error504 withStatus(long status) {
        Utils.checkNotNull(status, "status");
     ...
     * A human readable message that provides more context to the error.
     */
    public Error504 withMessage(String message) {
        Utils.checkNotNull(message, "message");
     ...
     * A human readable message that provides more context to the error.
     */
    public Error504 withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * A list of details that further ellaborate on the error.
     */
    public Error504 withDetails(List<ErrorDetail> details) {
        Utils.checkNotNull(details, "details");
     ...
     * A list of details that further ellaborate on the error.
     */
    public Error504 withDetails(Optional<? extends List<ErrorDetail>> details) {
        Utils.checkNotNull(details, "details");
        this.details = details;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public Error504 withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public Error504 withRawResponse(Optional<? extends HttpResponse<InputStream>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Error504.class,
                "type", type,
                "code", code,
                "status", status,
                "message", message,
