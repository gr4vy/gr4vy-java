...
public class Error502 extends RuntimeException {
     ...
     * Always `bad_gateway`
     */
    public Error502 withCode(String code) {
        Utils.checkNotNull(code, "code");
     ...
     * Always `bad_gateway`
     */
    public Error502 withCode(Optional<String> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
     ...
     * Always `502`.
     */
    public Error502 withStatus(long status) {
        Utils.checkNotNull(status, "status");
     ...
     * Always `502`.
     */
    public Error502 withStatus(Optional<Long> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * A human readable message that provides more context to the error.
     */
    public Error502 withMessage(String message) {
        Utils.checkNotNull(message, "message");
     ...
     * A human readable message that provides more context to the error.
     */
    public Error502 withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * A list of details that further ellaborate on the error.
     */
    public Error502 withDetails(List<ErrorDetail> details) {
        Utils.checkNotNull(details, "details");
     ...
     * A list of details that further ellaborate on the error.
     */
    public Error502 withDetails(Optional<? extends List<ErrorDetail>> details) {
        Utils.checkNotNull(details, "details");
        this.details = details;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public Error502 withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public Error502 withRawResponse(Optional<? extends HttpResponse<InputStream>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Error502.class,
                "type", type,
                "code", code,
                "status", status,
                "message", message,
