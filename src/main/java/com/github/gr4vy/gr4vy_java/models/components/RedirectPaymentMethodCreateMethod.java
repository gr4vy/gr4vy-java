...
public enum RedirectPaymentMethodCreateMethod {
    ...
    public static Optional<RedirectPaymentMethodCreateMethod> fromValue(String value) {
        for (RedirectPaymentMethodCreateMethod o: RedirectPaymentMethodCreateMethod.values()) {
