...
public class ListTransactionRefundsRequest {
     ...
     * The ID of the merchant account to use for this request.
     */
    public ListTransactionRefundsRequest withXGr4vyMerchantAccountId(String xGr4vyMerchantAccountId) {
        Utils.checkNotNull(xGr4vyMerchantAccountId, "xGr4vyMerchantAccountId");
     ...
     * The ID of the merchant account to use for this request.
     */
    public ListTransactionRefundsRequest withXGr4vyMerchantAccountId(JsonNullable<String> xGr4vyMerchantAccountId) {
        Utils.checkNotNull(xGr4vyMerchantAccountId, "xGr4vyMerchantAccountId");
        this.xGr4vyMerchantAccountId = xGr4vyMerchantAccountId;
        return this;
    }
