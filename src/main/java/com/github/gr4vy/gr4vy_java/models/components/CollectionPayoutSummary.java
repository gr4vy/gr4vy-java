...
public class CollectionPayoutSummary {
     ...
     */
    @JsonProperty("items")
    private List<PayoutSummary> items;
    ...
    @JsonCreator
    public CollectionPayoutSummary(
            @JsonProperty("items") List<PayoutSummary> items,
     ...
     */
    @JsonIgnore
    public List<PayoutSummary> items() {
        return items;
    }
     ...
     * A list of items returned for this request.
     */
    public CollectionPayoutSummary withItems(List<PayoutSummary> items) {
        Utils.checkNotNull(items, "items");
        this.items = items;
        return this;
    }
     ...
     * The number of items for this page.
     */
    public CollectionPayoutSummary withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * The number of items for this page.
     */
    public CollectionPayoutSummary withLimit(Optional<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * The cursor pointing at the next page of items.
     */
    public CollectionPayoutSummary withNextCursor(String nextCursor) {
        Utils.checkNotNull(nextCursor, "nextCursor");
     ...
     * The cursor pointing at the next page of items.
     */
    public CollectionPayoutSummary withNextCursor(JsonNullable<String> nextCursor) {
        Utils.checkNotNull(nextCursor, "nextCursor");
        this.nextCursor = nextCursor;
        return this;
    }
     ...
     * The cursor pointing at the previous page of items.
     */
    public CollectionPayoutSummary withPreviousCursor(String previousCursor) {
        Utils.checkNotNull(previousCursor, "previousCursor");
     ...
     * The cursor pointing at the previous page of items.
     */
    public CollectionPayoutSummary withPreviousCursor(JsonNullable<String> previousCursor) {
        Utils.checkNotNull(previousCursor, "previousCursor");
        this.previousCursor = previousCursor;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CollectionPayoutSummary other = (CollectionPayoutSummary) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CollectionPayoutSummary.class,
                "items", items,
                "limit", limit,
    ...
    public final static class Builder {
         ...
         * A list of items returned for this request.
         */
        public Builder items(List<PayoutSummary> items) {
            Utils.checkNotNull(items, "items");
            this.items = items;
            return this;
        }
        ...
        public CollectionPayoutSummary build() {
            if (limit == null) {
                limit = _SINGLETON_VALUE_Limit.value();
            }
            return new CollectionPayoutSummary(
                items,
                limit,
                nextCursor,
                previousCursor);
