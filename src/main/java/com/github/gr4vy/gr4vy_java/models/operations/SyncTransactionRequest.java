...
public class SyncTransactionRequest {
     ...
     * The ID of the merchant account to use for this request.
     */
    public SyncTransactionRequest withMerchantAccountId(String merchantAccountId) {
        Utils.checkNotNull(merchantAccountId, "merchantAccountId");
     ...
     * The ID of the merchant account to use for this request.
     */
    public SyncTransactionRequest withMerchantAccountId(JsonNullable<String> merchantAccountId) {
        Utils.checkNotNull(merchantAccountId, "merchantAccountId");
        this.merchantAccountId = merchantAccountId;
        return this;
    }
