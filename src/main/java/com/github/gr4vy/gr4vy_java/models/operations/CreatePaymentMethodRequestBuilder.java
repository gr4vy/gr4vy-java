...
public class CreatePaymentMethodRequestBuilder {
    ...
    public CreatePaymentMethodRequestBuilder timeoutInSeconds(double timeoutInSeconds) {
        Utils.checkNotNull(timeoutInSeconds, "timeoutInSeconds");
        this.timeoutInSeconds = Optional.of(timeoutInSeconds);
        return this;
    }

    public CreatePaymentMethodRequestBuilder timeoutInSeconds(Optional<Double> timeoutInSeconds) {
        Utils.checkNotNull(timeoutInSeconds, "timeoutInSeconds");
