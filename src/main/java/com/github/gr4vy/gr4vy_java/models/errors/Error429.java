...
public class Error429 extends RuntimeException {
     ...
     * Always `too_many_requests`
     */
    public Error429 withCode(String code) {
        Utils.checkNotNull(code, "code");
     ...
     * Always `too_many_requests`
     */
    public Error429 withCode(Optional<String> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
     ...
     * Always `429`.
     */
    public Error429 withStatus(long status) {
        Utils.checkNotNull(status, "status");
     ...
     * Always `429`.
     */
    public Error429 withStatus(Optional<Long> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * A human readable message that provides more context to the error.
     */
    public Error429 withMessage(String message) {
        Utils.checkNotNull(message, "message");
     ...
     * A human readable message that provides more context to the error.
     */
    public Error429 withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * A list of details that further ellaborate on the error.
     */
    public Error429 withDetails(List<ErrorDetail> details) {
        Utils.checkNotNull(details, "details");
     ...
     * A list of details that further ellaborate on the error.
     */
    public Error429 withDetails(Optional<? extends List<ErrorDetail>> details) {
        Utils.checkNotNull(details, "details");
        this.details = details;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public Error429 withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public Error429 withRawResponse(Optional<? extends HttpResponse<InputStream>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Error429.class,
                "type", type,
                "code", code,
                "status", status,
                "message", message,
