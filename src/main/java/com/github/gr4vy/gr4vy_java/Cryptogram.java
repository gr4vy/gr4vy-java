...
import com.github.gr4vy.gr4vy_java.models.operations.CreatePaymentMethodNetworkTokenCryptogramRequestBuilder;
    ...
    public CreatePaymentMethodNetworkTokenCryptogramResponse create(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "201")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                com.github.gr4vy.gr4vy_java.models.components.Cryptogram _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<com.github.gr4vy.gr4vy_java.models.components.Cryptogram>() {});
