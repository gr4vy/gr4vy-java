...
import com.github.gr4vy.gr4vy_java.models.operations.ListBuyerPaymentMethodsRequestBuilder;
...
public class BuyersPaymentMethods implements
            MethodCallListBuyerPaymentMethods {
    ...
    public ListBuyerPaymentMethodsRequestBuilder list() {
        return new ListBuyerPaymentMethodsRequestBuilder(this);
    }
    ...
    public ListBuyerPaymentMethodsResponse list(
        ...
        ListBuyerPaymentMethodsResponse.Builder _resBuilder = 
        ...
        ListBuyerPaymentMethodsResponse _res = _resBuilder.build();
