...
//		CheckoutSession checkoutSession = client.newCheckoutSession(null);
//		
//		TransactionCheckoutSessionRequest pm = new TransactionCheckoutSessionRequest()
//				.id(checkoutSession.getId());;
//		
...
//	}
	...
	public void newRedirectTransactionTest() throws Gr4vyException {
		...
		TransactionRedirectRequest pm = new TransactionRedirectRequest("paypal")
